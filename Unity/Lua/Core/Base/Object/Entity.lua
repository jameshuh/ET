...
System.import(function (out)
  ...
  Pool_1HashSetEntity = DCETModel.Pool_1(HashSetEntity)
  Pool_1DictTypeEntity = DCETModel.Pool_1(DictTypeEntity)
  Pool_1DictInt64Entity = DCETModel.Pool_1(DictInt64Entity)
end)
System.namespace("DCET.Hotfix", function (namespace)
  ...
  namespace.class("Entity", function (namespace)
    ...
    getComponents, Dispose, EndInit, AddToComponentsDB, RemoveFromComponentsDB, AddToComponent, RemoveFromComponent, AddComponent, 
    AddComponent1, AddComponent2, AddComponent3, AddComponent4, AddComponent5, AddComponentNoPool, AddComponentNoPool1, AddComponentNoPool2, 
    AddComponentNoPool3, RemoveComponent, RemoveComponent1, RemoveComponent2, GetComponent, GetComponent1, CreateWithComponentParent, CreateWithComponentParent1, 
    ...
    __ctor__ = function (this)
      this.InstanceId = DCETModel.IdGenerater.GenerateId()


      if not this:GetType():IsDefined(System.typeof(DCETModel.HideInHierarchy), true) then
        this.ViewGO = UnityEngine.GameObject()
        this.ViewGO:setname(this:GetType():getName())
        this.ViewGO:setlayer(DCETModel.LayerNames.GetLayerInt("Hidden" --[[LayerNames.HIDDEN]]))
    ...
    getIsFromPool = function (this)
      return (this.status & 1 --[[EntityStatus.IsFromPool]]) == 1 --[[EntityStatus.IsFromPool]]
    end
    setIsFromPool = function (this, value)
      if value then
        this.status = this.status | 1 --[[EntityStatus.IsFromPool]]
      else
        this.status = this.status & System.bnot(1 --[[EntityStatus.IsFromPool]])
      end
    ...
    getIsRegister = function (this)
      return (this.status & 2 --[[EntityStatus.IsRegister]]) == 2 --[[EntityStatus.IsRegister]]
    end
    setIsRegister = function (this, value)
      ...
      if value then
        this.status = this.status | 2 --[[EntityStatus.IsRegister]]
      else
        this.status = this.status & System.bnot(2 --[[EntityStatus.IsRegister]])
      end
      DCETHotfix.Game.getEventSystem():RegisterSystem(this, value)
    end
    getIsComponent = function (this)
      return (this.status & 4 --[[EntityStatus.IsComponent]]) == 4 --[[EntityStatus.IsComponent]]
    end
    setIsComponent = function (this, value)
      if value then
        this.status = this.status | 4 --[[EntityStatus.IsComponent]]
      else
        this.status = this.status & System.bnot(4 --[[EntityStatus.IsComponent]])
      end
    end
    ...
    Dispose = function (this)
      ...
      this.status = 0 --[[EntityStatus.None]]
    end
    ...
    RemoveComponent = function (this, K)
      ...
      local type = System.typeof(K)
      local c = GetComponent1(this, type)
      if c == nil then
        return
      end
    ...
    RemoveComponent1 = function (this, component)
      ...
      local type = component:GetType()
      local c = GetComponent1(this, component:GetType())
      if c == nil then
        return
      end
    ...
    CreateWithComponentParent = function (this, type)
      local component
      if type:IsDefined(System.typeof(DCETModel.NoObjectPool), false) then
    ...
    class = {
      __inherits__ = function (out)
        return {
          ...
          out.DCET.Hotfix.IDisposable
        }
      end,
      InstanceId = 0,
      status = 0 --[[EntityStatus.None]],
