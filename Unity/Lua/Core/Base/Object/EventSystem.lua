...
System.import(function (out)
  ...
  UnOrderMultiMap_2TypeILoadSystem = DCETModel.UnOrderMultiMap_2(System.Type, DCETHotfix.ILoadSystem)
  UnOrderMultiMap_2TypeIAwakeSystem = DCETModel.UnOrderMultiMap_2(System.Type, DCETHotfix.IAwakeSystem)
  UnOrderMultiMap_2TypeIStartSystem = DCETModel.UnOrderMultiMap_2(System.Type, DCETHotfix.IStartSystem)
  UnOrderMultiMap_2TypeIChangeSystem = DCETModel.UnOrderMultiMap_2(System.Type, DCETHotfix.IChangeSystem)
  UnOrderMultiMap_2TypeIUpdateSystem = DCETModel.UnOrderMultiMap_2(System.Type, DCETHotfix.IUpdateSystem)
  UnOrderMultiMap_2TypeIDestroySystem = DCETModel.UnOrderMultiMap_2(System.Type, DCETHotfix.IDestroySystem)
  UnOrderMultiMap_2TypeILateUpdateSystem = DCETModel.UnOrderMultiMap_2(System.Type, DCETHotfix.ILateUpdateSystem)
  UnOrderMultiMap_2TypeIDeserializeSystem = DCETModel.UnOrderMultiMap_2(System.Type, DCETHotfix.IDeserializeSystem)
end)
System.namespace("DCET.Hotfix", function (namespace)
  namespace.class("EventSystem", function (namespace)
    local Handle, RegisterEvent, GetTypes, RegisterSystem, Remove, Get, IsRegister, Deserialize, 
    Awake, Awake1, Awake2, Awake3, Awake4, Change, Load, Start, 
    Destroy, Update, LateUpdate, Run, Run1, Run2, Run3, ToString, 
    __ctor__
    __ctor__ = function (this)
      ...
      local ts = DCETModel.Game.getHotfix():GetHotfixTypes()

      for _, type in System.each(ts) do
        this.types:Add(type)
      end

      for _, type in System.each(this.types) do
        local continue
        repeat
          local attrs = type:GetCustomAttributes(System.typeof(DCETModel.ObjectSystemAttribute), false)
      ...
      for _, type in System.each(this.types) do
        local attrs = type:GetCustomAttributes(System.typeof(DCETModel.EventAttribute), false)

        for _, attr in System.each(attrs) do
          local aEventAttribute = System.cast(DCETModel.EventAttribute, attr)
          local obj = System.Activator.CreateInstance(type)
          local iEvent = System.as(obj, DCETModel.IEvent)
          if iEvent == nil then
            DCETHotfix.Log.Error1(obj:GetType():getName() .. " 没有继承IEvent")
          end
          RegisterEvent(this, aEventAttribute:getType(), iEvent)

          -- hotfix的事件也要注册到mono层，hotfix可以订阅mono层的事件
          local action = function (list)
            Handle(iEvent, list)
          end
          DCETModel.Game.getEventSystem():RegisterEvent(aEventAttribute:getType(), DCETModel.EventProxy(action))
        end
      end

      Load(this)
    end
    Handle = function (iEvent, param)
      repeat
        local default = #param
        if default == 0 then
          iEvent:Handle()
        ...
        elseif default == 1 then
          iEvent:Handle(param:get(0))
          break
        elseif default == 2 then
          iEvent:Handle(param:get(0), param:get(1))
          break
        elseif default == 3 then
          iEvent:Handle(param:get(0), param:get(1), param:get(2))
          break
        end
      until 1
    end
    ...
    Awake4 = function (this, component, p1, p2, p3, p4, P1, P2, P3, P4)
      ...
      for _, aAwakeSystem in System.each(iAwakeSystems) do
        ...
        repeat
          ...
          local iAwake = System.as(aAwakeSystem, DCETModel.IAwake_4(P1, P2, P3, P4))
          if iAwake == nil then
            continue = true
            break
          end
    ...
    Run1 = function (this, type, a, A)
      ...
      for _, aEvent in System.each(iEvents) do
        aEvent = System.cast(DCETHotfix.AEvent_1(A), aEvent)
        System.try(function ()
          local default = aEvent
          if default ~= nil then
            default:Run(a)
          end
        end, function (default)
    ...
    Run2 = function (this, type, a, b, A, B)
      ...
      for _, aEvent in System.each(iEvents) do
        aEvent = System.cast(DCETHotfix.AEvent_2(A, B), aEvent)
        System.try(function ()
          aEvent:Run(a, b)
        end, function (default)
          local e = default
    ...
    Run3 = function (this, type, a, b, c, A, B, C)
      ...
      for _, aEvent in System.each(iEvents) do
        aEvent = System.cast(DCETHotfix.AEvent_3(A, B, C), aEvent)
        System.try(function ()
          aEvent:Run(a, b, c)
        end, function (default)
          local e = default
