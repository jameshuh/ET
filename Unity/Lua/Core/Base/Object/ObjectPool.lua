...
local MultiMapSet_2StringString = DCETModel.MultiMapSet_2(System.String, System.String)
local DCETHotfix
local QueueEntity
...
System.namespace("DCET.Hotfix", function (namespace)
  namespace.class("ComponentQueue", function (namespace)
    local Global, Enqueue, Dequeue, Peek, getQueue, getCount, Dispose, static, 
    __ctor__
    ...
    __ctor__ = function (this, typeName)
      ...
      this.Id = DCETModel.IdGenerater.GenerateId()
  ...
  namespace.class("ObjectPool", function (namespace)
    local Global, Fetch, Fetch1, Recycle, Dispose, ToString, LogErrorCheckResult, Check, 
    static, __ctor__
    static = function (this)
      Global = UnityEngine.GameObject.Find("/Global")
      this.Global = Global
            ...
            repeat
              ...
              for _, fieldInfo in System.each(fieldInfos) do
                ...
                repeat
                  ...
                  if Linq.Count(SystemReflection.CustomAttributeExtensions.GetCustomAttributes(fieldInfo, System.typeof(DCETModel.NoMemoryCheck))) > 0 then
                    continue = true
                    break
                  end
