...
local System = System
local DCETModel = CS.DCET.Model
local GoogleProtobuf = CS.Google.Protobuf
  ...
  namespace.class("Dumper", function (namespace)
    ...
    DoDump = function (obj)
      ...
      elseif System.is(obj, System.String) then
        ...
        _text:Append(",")
        AppendIndent(1)
      elseif System.is(obj, GoogleProtobuf.ByteString) then
        _text:Append("\"")
        _text:Append(DCETModel.ByteHelper.Utf8ToStr((System.cast(GoogleProtobuf.ByteString, obj)).bytes))
        _text:Append("\"")
        _text:Append(",")
        AppendIndent(1)
      ...
      elseif t:getIsClass() then
        ...
        UnityEngine.Debug.LogWarning("unsupport type: " .. t:getFullName())
        _text:Append(obj)
        _text:Append(",")
        AppendIndent(1)
      end
