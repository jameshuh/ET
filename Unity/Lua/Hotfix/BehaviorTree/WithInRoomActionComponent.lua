...
System.namespace("DCET.Hotfix", function (namespace)
  namespace.class("WithInRoomActionComponentAwakeSystem", function (namespace)
    ...
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.AwakeSystem_4(out.DCET.Hotfix.WithInRoomActionComponent, out.DCET.Hotfix.Entity, out.BehaviorDesigner.Runtime.Tasks.HotfixAction, out.DCET.Hotfix.BehaviorTreeConfig)
        }
      end,
      Awake = Awake
    }
