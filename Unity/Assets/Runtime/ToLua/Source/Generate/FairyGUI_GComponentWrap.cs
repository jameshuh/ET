...
public class FairyGUI_GComponentWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getrootContainer", get_rootContainer);
		L.RegVar("container", get_container, null);
		L.RegFunction("getcontainer", get_container);
		L.RegVar("scrollPane", get_scrollPane, null);
		L.RegFunction("getscrollPane", get_scrollPane);
		L.RegVar("onDrop", get_onDrop, null);
		L.RegFunction("getonDrop", get_onDrop);
		L.RegVar("fairyBatching", get_fairyBatching, set_fairyBatching);
		L.RegFunction("getfairyBatching", get_fairyBatching);
		L.RegFunction("setfairyBatching", set_fairyBatching);
		L.RegVar("opaque", get_opaque, set_opaque);
		L.RegFunction("getopaque", get_opaque);
		L.RegFunction("setopaque", set_opaque);
		L.RegVar("margin", get_margin, set_margin);
		L.RegFunction("getmargin", get_margin);
		L.RegFunction("setmargin", set_margin);
		L.RegVar("childrenRenderOrder", get_childrenRenderOrder, set_childrenRenderOrder);
		L.RegFunction("getchildrenRenderOrder", get_childrenRenderOrder);
		L.RegFunction("setchildrenRenderOrder", set_childrenRenderOrder);
		L.RegVar("apexIndex", get_apexIndex, set_apexIndex);
		L.RegFunction("getapexIndex", get_apexIndex);
		L.RegFunction("setapexIndex", set_apexIndex);
		L.RegVar("numChildren", get_numChildren, null);
		L.RegFunction("getnumChildren", get_numChildren);
		L.RegVar("Controllers", get_Controllers, null);
		L.RegFunction("getControllers", get_Controllers);
		L.RegVar("clipSoftness", get_clipSoftness, set_clipSoftness);
		L.RegFunction("getclipSoftness", get_clipSoftness);
		L.RegFunction("setclipSoftness", set_clipSoftness);
		L.RegVar("mask", get_mask, set_mask);
		L.RegFunction("getmask", get_mask);
		L.RegFunction("setmask", set_mask);
		L.RegVar("reversedMask", get_reversedMask, set_reversedMask);
		L.RegFunction("getreversedMask", get_reversedMask);
		L.RegFunction("setreversedMask", set_reversedMask);
		L.RegVar("baseUserData", get_baseUserData, null);
		L.RegFunction("getbaseUserData", get_baseUserData);
	...
	static int set_childrenRenderOrder(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GComponent obj = (FairyGUI.GComponent)o;
			FairyGUI.ChildrenRenderOrder arg0 = (FairyGUI.ChildrenRenderOrder)LuaDLL.luaL_checknumber(L, 2);
