...
public class DCET_MonoBehaviourBridgeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCET.MonoBehaviourBridge), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_onAwake(IntPtr L)
	{
		...
		try
		{
			...
			DCET.MonoBehaviourBridge obj = (DCET.MonoBehaviourBridge)o;
