...
public class MongoDB_Bson_Serialization_Serializers_BsonValueSerializerBase_MongoDB_Bson_BsonInt32Wrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonInt32>), typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonInt32>), "BsonValueSerializerBase_MongoDB_Bson_BsonInt32");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonInt32> obj = (MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonInt32>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonInt32>>(L, 1);
