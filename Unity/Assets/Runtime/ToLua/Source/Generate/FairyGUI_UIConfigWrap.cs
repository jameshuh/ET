...
public class FairyGUI_UIConfigWrap
{
	...
	static int get_defaultScrollBarDisplay(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, (int)FairyGUI.UIConfig.defaultScrollBarDisplay);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_defaultScrollBarDisplay(IntPtr L)
	{
		try
		{
			FairyGUI.ScrollBarDisplayType arg0 = (FairyGUI.ScrollBarDisplayType)LuaDLL.luaL_checknumber(L, 2);
