...
public class MongoDB_Bson_Serialization_Serializers_BsonValueSerializerBase_MongoDB_Bson_BsonMinKeyWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonMinKey>), typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonMinKey>), "BsonValueSerializerBase_MongoDB_Bson_BsonMinKey");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonMinKey> obj = (MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonMinKey>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonMinKey>>(L, 1);
