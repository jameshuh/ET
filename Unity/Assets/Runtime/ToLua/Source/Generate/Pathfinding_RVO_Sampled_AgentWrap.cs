...
public class Pathfinding_RVO_Sampled_AgentWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Pathfinding.RVO.Sampled.Agent), typeof(System.Object));
		...
		L.RegFunction("BufferSwitch", BufferSwitch);
		L.RegFunction("PreCalculation", PreCalculation);
		L.RegFunction("PostCalculation", PostCalculation);
		L.RegFunction("CalculateNeighbours", CalculateNeighbours);
		L.RegFunction("New", _CreatePathfinding_RVO_Sampled_Agent);
		...
		L.RegVar("PreCalculationCallback", get_PreCalculationCallback, set_PreCalculationCallback);
		L.RegFunction("getPreCalculationCallback", get_PreCalculationCallback);
		L.RegFunction("setPreCalculationCallback", set_PreCalculationCallback);
		L.RegVar("NeighbourObstacles", get_NeighbourObstacles, null);
		L.RegFunction("getNeighbourObstacles", get_NeighbourObstacles);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreatePathfinding_RVO_Sampled_Agent(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				Pathfinding.RVO.Sampled.Agent obj = new Pathfinding.RVO.Sampled.Agent(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Pathfinding.RVO.Sampled.Agent.New");
			}
		}
		catch (Exception e)
		{
	...
	static int SetTarget(IntPtr L)
	{
		try
		{
			...
			Pathfinding.RVO.Sampled.Agent obj = (Pathfinding.RVO.Sampled.Agent)ToLua.CheckObject<Pathfinding.RVO.Sampled.Agent>(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int BufferSwitch(IntPtr L)
	{
		try
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PreCalculation(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int PostCalculation(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int CalculateNeighbours(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			Pathfinding.RVO.Sampled.Agent obj = (Pathfinding.RVO.Sampled.Agent)ToLua.CheckObject<Pathfinding.RVO.Sampled.Agent>(L, 1);
			obj.CalculateNeighbours();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int get_Position(IntPtr L)
	{
		...
		try
		{
			...
			Pathfinding.RVO.Sampled.Agent obj = (Pathfinding.RVO.Sampled.Agent)o;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_PreCalculationCallback(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Pathfinding.RVO.Sampled.Agent obj = (Pathfinding.RVO.Sampled.Agent)o;
			System.Action ret = obj.PreCalculationCallback;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_NeighbourObstacles(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Pathfinding.RVO.Sampled.Agent obj = (Pathfinding.RVO.Sampled.Agent)o;
			System.Collections.Generic.List<Pathfinding.RVO.ObstacleVertex> ret = obj.NeighbourObstacles;
			ToLua.PushSealed(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index NeighbourObstacles on a nil value");
		}
	}
