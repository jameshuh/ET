...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_RawBsonDocumentWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonDocument>), typeof(System.Object), "SerializerBase_MongoDB_Bson_RawBsonDocument");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonDocument> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonDocument>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonDocument>>(L, 1);
			...
			MongoDB.Bson.RawBsonDocument o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.RawBsonDocument arg2 = (MongoDB.Bson.RawBsonDocument)ToLua.CheckObject<MongoDB.Bson.RawBsonDocument>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonDocument> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonDocument>)o;
