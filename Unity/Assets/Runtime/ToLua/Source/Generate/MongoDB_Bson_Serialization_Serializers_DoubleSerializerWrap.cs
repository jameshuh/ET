...
public class MongoDB_Bson_Serialization_Serializers_DoubleSerializerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.DoubleSerializer), typeof(MongoDB.Bson.Serialization.Serializers.StructSerializerBase<double>));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_Serialization_Serializers_DoubleSerializer);
	...
	static int _CreateMongoDB_Bson_Serialization_Serializers_DoubleSerializer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				MongoDB.Bson.Serialization.Serializers.DoubleSerializer obj = new MongoDB.Bson.Serialization.Serializers.DoubleSerializer();
			...
			else if (count == 1)
			{
				...
				MongoDB.Bson.Serialization.Serializers.DoubleSerializer obj = new MongoDB.Bson.Serialization.Serializers.DoubleSerializer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 2)
			{
				...
				MongoDB.Bson.Serialization.Serializers.DoubleSerializer obj = new MongoDB.Bson.Serialization.Serializers.DoubleSerializer(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.Serialization.Serializers.DoubleSerializer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.DoubleSerializer obj = (MongoDB.Bson.Serialization.Serializers.DoubleSerializer)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.DoubleSerializer>(L, 1);
			...
			double o = obj.Deserialize(arg0, arg1);
	...
	static int WithConverter(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.DoubleSerializer o = obj.WithConverter(arg0);
	...
	static int WithRepresentation(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.DoubleSerializer o = obj.WithRepresentation(arg0);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_Converter(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.DoubleSerializer obj = (MongoDB.Bson.Serialization.Serializers.DoubleSerializer)o;
