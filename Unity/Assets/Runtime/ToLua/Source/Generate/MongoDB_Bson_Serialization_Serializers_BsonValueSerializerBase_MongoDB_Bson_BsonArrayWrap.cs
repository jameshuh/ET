...
public class MongoDB_Bson_Serialization_Serializers_BsonValueSerializerBase_MongoDB_Bson_BsonArrayWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonArray>), typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonArray>), "BsonValueSerializerBase_MongoDB_Bson_BsonArray");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonArray> obj = (MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonArray>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonArray>>(L, 1);
