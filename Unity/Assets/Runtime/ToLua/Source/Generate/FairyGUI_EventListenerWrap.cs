...
public class FairyGUI_EventListenerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("Add1", Add1);
		L.RegFunction("Remove1", Remove1);
		L.RegFunction("Add", Add);
		L.RegFunction("Remove", Remove);
		L.RegFunction("Set1", Set1);
		...
		L.RegFunction("getisDispatching", get_isDispatching);
		L.EndClass();
	}
