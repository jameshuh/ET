...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_ulongWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<ulong>), typeof(System.Object), "SerializerBase_ulong");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<ulong> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<ulong>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<ulong>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<ulong> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<ulong>)o;
