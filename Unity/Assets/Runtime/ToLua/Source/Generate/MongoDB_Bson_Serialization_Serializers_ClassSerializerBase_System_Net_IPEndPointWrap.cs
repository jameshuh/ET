...
public class MongoDB_Bson_Serialization_Serializers_ClassSerializerBase_System_Net_IPEndPointWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.ClassSerializerBase<System.Net.IPEndPoint>), typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Net.IPEndPoint>), "ClassSerializerBase_System_Net_IPEndPoint");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.ClassSerializerBase<System.Net.IPEndPoint> obj = (MongoDB.Bson.Serialization.Serializers.ClassSerializerBase<System.Net.IPEndPoint>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.ClassSerializerBase<System.Net.IPEndPoint>>(L, 1);
