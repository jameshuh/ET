...
public class FairyGUI_GListWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getonClickItem", get_onClickItem);
		L.RegVar("onRightClickItem", get_onRightClickItem, null);
		L.RegFunction("getonRightClickItem", get_onRightClickItem);
		L.RegVar("layout", get_layout, set_layout);
		L.RegFunction("getlayout", get_layout);
		L.RegFunction("setlayout", set_layout);
		L.RegVar("lineCount", get_lineCount, set_lineCount);
		L.RegFunction("getlineCount", get_lineCount);
		L.RegFunction("setlineCount", set_lineCount);
		L.RegVar("columnCount", get_columnCount, set_columnCount);
		L.RegFunction("getcolumnCount", get_columnCount);
		L.RegFunction("setcolumnCount", set_columnCount);
		L.RegVar("lineGap", get_lineGap, set_lineGap);
		L.RegFunction("getlineGap", get_lineGap);
		L.RegFunction("setlineGap", set_lineGap);
		L.RegVar("columnGap", get_columnGap, set_columnGap);
		L.RegFunction("getcolumnGap", get_columnGap);
		L.RegFunction("setcolumnGap", set_columnGap);
		...
		L.RegFunction("getautoResizeItem", get_autoResizeItem);
		L.RegFunction("setautoResizeItem", set_autoResizeItem);
		L.RegVar("itemPool", get_itemPool, null);
		L.RegFunction("getitemPool", get_itemPool);
		L.RegVar("selectedIndex", get_selectedIndex, set_selectedIndex);
		L.RegFunction("getselectedIndex", get_selectedIndex);
		L.RegFunction("setselectedIndex", set_selectedIndex);
		L.RegVar("selectionController", get_selectionController, set_selectionController);
		L.RegFunction("getselectionController", get_selectionController);
		L.RegFunction("setselectionController", set_selectionController);
		L.RegVar("touchItem", get_touchItem, null);
		L.RegFunction("gettouchItem", get_touchItem);
		L.RegVar("isVirtual", get_isVirtual, null);
		L.RegFunction("getisVirtual", get_isVirtual);
		L.RegVar("numItems", get_numItems, set_numItems);
		L.RegFunction("getnumItems", get_numItems);
		L.RegFunction("setnumItems", set_numItems);
		L.EndClass();
	}
	...
	static int set_selectionMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GList obj = (FairyGUI.GList)o;
			FairyGUI.ListSelectionMode arg0 = (FairyGUI.ListSelectionMode)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_layout(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GList obj = (FairyGUI.GList)o;
			FairyGUI.ListLayoutType arg0 = (FairyGUI.ListLayoutType)LuaDLL.luaL_checknumber(L, 2);
			obj.layout = arg0;
			return 0;
		}
		catch(Exception e)
