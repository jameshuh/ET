...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_longWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<long>), typeof(System.Object), "SerializerBase_long");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<long> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<long>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<long>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<long> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<long>)o;
