...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_shortWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<short>), typeof(System.Object), "SerializerBase_short");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<short> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<short>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<short>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<short> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<short>)o;
