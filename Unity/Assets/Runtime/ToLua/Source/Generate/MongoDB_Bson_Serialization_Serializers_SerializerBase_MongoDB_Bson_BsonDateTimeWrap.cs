...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_BsonDateTimeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDateTime>), typeof(System.Object), "SerializerBase_MongoDB_Bson_BsonDateTime");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDateTime> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDateTime>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDateTime>>(L, 1);
			...
			MongoDB.Bson.BsonDateTime o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.BsonDateTime arg2 = (MongoDB.Bson.BsonDateTime)ToLua.CheckObject<MongoDB.Bson.BsonDateTime>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDateTime> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDateTime>)o;
