...
public class MongoDB_Bson_IO_Int32JsonTokenWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.IO.Int32JsonToken), typeof(MongoDB.Bson.IO.JsonToken));
		L.RegFunction("New", _CreateMongoDB_Bson_IO_Int32JsonToken);
	...
	static int _CreateMongoDB_Bson_IO_Int32JsonToken(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				MongoDB.Bson.IO.Int32JsonToken obj = new MongoDB.Bson.IO.Int32JsonToken(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.IO.Int32JsonToken.New");
			}
		}
		catch (Exception e)
		{
	...
	static int get_DoubleValue(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.IO.Int32JsonToken obj = (MongoDB.Bson.IO.Int32JsonToken)o;
