...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_floatWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<float>), typeof(System.Object), "SerializerBase_float");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<float> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<float>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<float>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<float> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<float>)o;
