...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_stringWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<string>), typeof(System.Object), "SerializerBase_string");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<string> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<string>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<string>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<string> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<string>)o;
