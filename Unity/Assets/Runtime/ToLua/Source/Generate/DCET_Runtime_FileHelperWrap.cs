...
public class DCET_Runtime_FileHelperWrap
{
	...
	static int GetAllFiles(IntPtr L)
	{
		try
		{
			...
			DCET.Runtime.FileHelper.GetAllFiles(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int CleanDirectory(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				DCET.Runtime.FileHelper.CleanDirectory(arg0);
				return 0;
			}
			else if (count == 2)
			{
				string arg0 = ToLua.CheckString(L, 1);
				string arg1 = ToLua.CheckString(L, 2);
				DCET.Runtime.FileHelper.CleanDirectory(arg0, arg1);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DCET.Runtime.FileHelper.CleanDirectory");
			}
		}
		catch (Exception e)
		{
	...
	static int CopyFile(IntPtr L)
	{
		try
		{
			...
			bool o = DCET.Runtime.FileHelper.CopyFile(arg0, arg1, arg2);
	...
	static int CopyDirectory(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			DCET.Runtime.FileHelper.CopyDirectory(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int ReplaceExtensionName(IntPtr L)
	{
		try
		{
			...
			DCET.Runtime.FileHelper.ReplaceExtensionName(arg0, arg1, arg2);
			return 0;
		}
		catch (Exception e)
		{
