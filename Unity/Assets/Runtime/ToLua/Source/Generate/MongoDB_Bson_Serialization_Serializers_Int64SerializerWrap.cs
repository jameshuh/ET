...
public class MongoDB_Bson_Serialization_Serializers_Int64SerializerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.Int64Serializer), typeof(MongoDB.Bson.Serialization.Serializers.StructSerializerBase<long>));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_Serialization_Serializers_Int64Serializer);
	...
	static int _CreateMongoDB_Bson_Serialization_Serializers_Int64Serializer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				MongoDB.Bson.Serialization.Serializers.Int64Serializer obj = new MongoDB.Bson.Serialization.Serializers.Int64Serializer();
			...
			else if (count == 1)
			{
				...
				MongoDB.Bson.Serialization.Serializers.Int64Serializer obj = new MongoDB.Bson.Serialization.Serializers.Int64Serializer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 2)
			{
				...
				MongoDB.Bson.Serialization.Serializers.Int64Serializer obj = new MongoDB.Bson.Serialization.Serializers.Int64Serializer(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.Serialization.Serializers.Int64Serializer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Int64Serializer obj = (MongoDB.Bson.Serialization.Serializers.Int64Serializer)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.Int64Serializer>(L, 1);
			...
			long o = obj.Deserialize(arg0, arg1);
	...
	static int WithConverter(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Int64Serializer o = obj.WithConverter(arg0);
	...
	static int WithRepresentation(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Int64Serializer o = obj.WithRepresentation(arg0);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_Converter(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Int64Serializer obj = (MongoDB.Bson.Serialization.Serializers.Int64Serializer)o;
