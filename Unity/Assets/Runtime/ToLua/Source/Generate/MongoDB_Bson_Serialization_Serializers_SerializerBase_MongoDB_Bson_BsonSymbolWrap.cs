...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_BsonSymbolWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonSymbol>), typeof(System.Object), "SerializerBase_MongoDB_Bson_BsonSymbol");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonSymbol> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonSymbol>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonSymbol>>(L, 1);
			...
			MongoDB.Bson.BsonSymbol o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.BsonSymbol arg2 = (MongoDB.Bson.BsonSymbol)ToLua.CheckObject<MongoDB.Bson.BsonSymbol>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonSymbol> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonSymbol>)o;
