...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_decimalWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<decimal>), typeof(System.Object), "SerializerBase_decimal");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<decimal> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<decimal>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<decimal>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<decimal> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<decimal>)o;
