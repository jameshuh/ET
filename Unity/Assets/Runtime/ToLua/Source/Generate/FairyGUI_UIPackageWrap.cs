...
public class FairyGUI_UIPackageWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getassetPath", get_assetPath);
		L.RegVar("customId", get_customId, set_customId);
		L.RegFunction("getcustomId", get_customId);
		L.RegFunction("setcustomId", set_customId);
		L.RegVar("resBundle", get_resBundle, null);
		L.RegFunction("getresBundle", get_resBundle);
		L.RegVar("dependencies", get_dependencies, null);
		L.RegFunction("getdependencies", get_dependencies);
