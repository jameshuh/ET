...
public class MongoDB_Bson_IO_BsonDocumentReaderWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.IO.BsonDocumentReader), typeof(MongoDB.Bson.IO.BsonReader));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_IO_BsonDocumentReader);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateMongoDB_Bson_IO_BsonDocumentReader(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				MongoDB.Bson.IO.BsonDocumentReader obj = new MongoDB.Bson.IO.BsonDocumentReader(arg0);
			...
			{
				MongoDB.Bson.BsonDocument arg0 = (MongoDB.Bson.BsonDocument)ToLua.CheckObject<MongoDB.Bson.BsonDocument>(L, 1);
				MongoDB.Bson.IO.BsonDocumentReaderSettings arg1 = (MongoDB.Bson.IO.BsonDocumentReaderSettings)ToLua.CheckObject<MongoDB.Bson.IO.BsonDocumentReaderSettings>(L, 2);
				MongoDB.Bson.IO.BsonDocumentReader obj = new MongoDB.Bson.IO.BsonDocumentReader(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.IO.BsonDocumentReader.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.IO.BsonDocumentReader obj = (MongoDB.Bson.IO.BsonDocumentReader)ToLua.CheckObject<MongoDB.Bson.IO.BsonDocumentReader>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
	...
	static int ReadName(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: MongoDB.Bson.IO.BsonDocumentReader.ReadName");
			}
		}
		catch (Exception e)
		{
