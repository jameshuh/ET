...
public class MongoDB_Bson_Serialization_Serializers_UInt64SerializerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.UInt64Serializer), typeof(MongoDB.Bson.Serialization.Serializers.StructSerializerBase<ulong>));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_Serialization_Serializers_UInt64Serializer);
	...
	static int _CreateMongoDB_Bson_Serialization_Serializers_UInt64Serializer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				MongoDB.Bson.Serialization.Serializers.UInt64Serializer obj = new MongoDB.Bson.Serialization.Serializers.UInt64Serializer();
			...
			else if (count == 1)
			{
				...
				MongoDB.Bson.Serialization.Serializers.UInt64Serializer obj = new MongoDB.Bson.Serialization.Serializers.UInt64Serializer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 2)
			{
				...
				MongoDB.Bson.Serialization.Serializers.UInt64Serializer obj = new MongoDB.Bson.Serialization.Serializers.UInt64Serializer(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.Serialization.Serializers.UInt64Serializer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.UInt64Serializer obj = (MongoDB.Bson.Serialization.Serializers.UInt64Serializer)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.UInt64Serializer>(L, 1);
			...
			ulong o = obj.Deserialize(arg0, arg1);
	...
	static int WithConverter(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.UInt64Serializer o = obj.WithConverter(arg0);
	...
	static int WithRepresentation(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.UInt64Serializer o = obj.WithRepresentation(arg0);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_Converter(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.UInt64Serializer obj = (MongoDB.Bson.Serialization.Serializers.UInt64Serializer)o;
