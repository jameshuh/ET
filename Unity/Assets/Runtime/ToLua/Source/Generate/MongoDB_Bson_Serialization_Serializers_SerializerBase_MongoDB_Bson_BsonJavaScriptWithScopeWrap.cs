...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_BsonJavaScriptWithScopeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonJavaScriptWithScope>), typeof(System.Object), "SerializerBase_MongoDB_Bson_BsonJavaScriptWithScope");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonJavaScriptWithScope> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonJavaScriptWithScope>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonJavaScriptWithScope>>(L, 1);
			...
			MongoDB.Bson.BsonJavaScriptWithScope o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.BsonJavaScriptWithScope arg2 = (MongoDB.Bson.BsonJavaScriptWithScope)ToLua.CheckObject<MongoDB.Bson.BsonJavaScriptWithScope>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonJavaScriptWithScope> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonJavaScriptWithScope>)o;
