...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_System_Net_IPEndPointWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Net.IPEndPoint>), typeof(System.Object), "SerializerBase_System_Net_IPEndPoint");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Net.IPEndPoint> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Net.IPEndPoint>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Net.IPEndPoint>>(L, 1);
			...
			System.Net.IPEndPoint o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			System.Net.IPEndPoint arg2 = (System.Net.IPEndPoint)ToLua.CheckObject<System.Net.IPEndPoint>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Net.IPEndPoint> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Net.IPEndPoint>)o;
