...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_boolWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<bool>), typeof(System.Object), "SerializerBase_bool");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<bool> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<bool>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<bool>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<bool> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<bool>)o;
