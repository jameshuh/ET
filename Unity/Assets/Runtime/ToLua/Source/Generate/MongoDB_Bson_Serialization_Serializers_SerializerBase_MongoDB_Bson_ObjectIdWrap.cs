...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_ObjectIdWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.ObjectId>), typeof(System.Object), "SerializerBase_MongoDB_Bson_ObjectId");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.ObjectId> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.ObjectId>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.ObjectId>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.ObjectId> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.ObjectId>)o;
