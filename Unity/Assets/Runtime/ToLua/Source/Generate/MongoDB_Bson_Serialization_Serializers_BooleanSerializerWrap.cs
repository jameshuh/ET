...
public class MongoDB_Bson_Serialization_Serializers_BooleanSerializerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.BooleanSerializer), typeof(MongoDB.Bson.Serialization.Serializers.StructSerializerBase<bool>));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_Serialization_Serializers_BooleanSerializer);
	...
	static int _CreateMongoDB_Bson_Serialization_Serializers_BooleanSerializer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				MongoDB.Bson.Serialization.Serializers.BooleanSerializer obj = new MongoDB.Bson.Serialization.Serializers.BooleanSerializer();
			...
			else if (count == 1)
			{
				...
				MongoDB.Bson.Serialization.Serializers.BooleanSerializer obj = new MongoDB.Bson.Serialization.Serializers.BooleanSerializer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.Serialization.Serializers.BooleanSerializer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.BooleanSerializer obj = (MongoDB.Bson.Serialization.Serializers.BooleanSerializer)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.BooleanSerializer>(L, 1);
			...
			bool o = obj.Deserialize(arg0, arg1);
	...
	static int WithRepresentation(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.BooleanSerializer o = obj.WithRepresentation(arg0);
	...
	static int get_Representation(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.BooleanSerializer obj = (MongoDB.Bson.Serialization.Serializers.BooleanSerializer)o;
