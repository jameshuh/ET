...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_objectWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<object>), typeof(System.Object), "SerializerBase_object");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<object> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<object>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<object>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<object> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<object>)o;
