...
public class MongoDB_Bson_Serialization_Serializers_EnumerableSerializerBase_System_Collections_QueueWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.EnumerableSerializerBase<System.Collections.Queue>), typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Queue>), "EnumerableSerializerBase_System_Collections_Queue");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.EnumerableSerializerBase<System.Collections.Queue> obj = (MongoDB.Bson.Serialization.Serializers.EnumerableSerializerBase<System.Collections.Queue>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.EnumerableSerializerBase<System.Collections.Queue>>(L, 1);
			...
			System.Collections.Queue o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			System.Collections.Queue arg2 = (System.Collections.Queue)ToLua.CheckObject<System.Collections.Queue>(L, 4);
	...
	static int get_ItemSerializer(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.EnumerableSerializerBase<System.Collections.Queue> obj = (MongoDB.Bson.Serialization.Serializers.EnumerableSerializerBase<System.Collections.Queue>)o;
