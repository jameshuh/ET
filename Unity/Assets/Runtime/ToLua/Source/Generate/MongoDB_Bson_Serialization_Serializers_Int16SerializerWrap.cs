...
public class MongoDB_Bson_Serialization_Serializers_Int16SerializerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.Int16Serializer), typeof(MongoDB.Bson.Serialization.Serializers.StructSerializerBase<short>));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_Serialization_Serializers_Int16Serializer);
	...
	static int _CreateMongoDB_Bson_Serialization_Serializers_Int16Serializer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				MongoDB.Bson.Serialization.Serializers.Int16Serializer obj = new MongoDB.Bson.Serialization.Serializers.Int16Serializer();
			...
			else if (count == 1)
			{
				...
				MongoDB.Bson.Serialization.Serializers.Int16Serializer obj = new MongoDB.Bson.Serialization.Serializers.Int16Serializer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 2)
			{
				...
				MongoDB.Bson.Serialization.Serializers.Int16Serializer obj = new MongoDB.Bson.Serialization.Serializers.Int16Serializer(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.Serialization.Serializers.Int16Serializer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Int16Serializer obj = (MongoDB.Bson.Serialization.Serializers.Int16Serializer)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.Int16Serializer>(L, 1);
			...
			short o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			short arg2 = (short)LuaDLL.luaL_checknumber(L, 4);
	...
	static int WithConverter(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Int16Serializer o = obj.WithConverter(arg0);
	...
	static int WithRepresentation(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Int16Serializer o = obj.WithRepresentation(arg0);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_Converter(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Int16Serializer obj = (MongoDB.Bson.Serialization.Serializers.Int16Serializer)o;
