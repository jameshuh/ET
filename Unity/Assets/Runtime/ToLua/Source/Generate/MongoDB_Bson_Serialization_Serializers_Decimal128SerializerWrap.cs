...
public class MongoDB_Bson_Serialization_Serializers_Decimal128SerializerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.Decimal128Serializer), typeof(MongoDB.Bson.Serialization.Serializers.StructSerializerBase<MongoDB.Bson.Decimal128>));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_Serialization_Serializers_Decimal128Serializer);
	...
	static int _CreateMongoDB_Bson_Serialization_Serializers_Decimal128Serializer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				MongoDB.Bson.Serialization.Serializers.Decimal128Serializer obj = new MongoDB.Bson.Serialization.Serializers.Decimal128Serializer();
			...
			else if (count == 1)
			{
				...
				MongoDB.Bson.Serialization.Serializers.Decimal128Serializer obj = new MongoDB.Bson.Serialization.Serializers.Decimal128Serializer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 2)
			{
				...
				MongoDB.Bson.Serialization.Serializers.Decimal128Serializer obj = new MongoDB.Bson.Serialization.Serializers.Decimal128Serializer(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.Serialization.Serializers.Decimal128Serializer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Decimal128Serializer obj = (MongoDB.Bson.Serialization.Serializers.Decimal128Serializer)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.Decimal128Serializer>(L, 1);
			...
			MongoDB.Bson.Decimal128 o = obj.Deserialize(arg0, arg1);
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Decimal128 arg2 = StackTraits<MongoDB.Bson.Decimal128>.Check(L, 4);
	...
	static int WithConverter(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Decimal128Serializer o = obj.WithConverter(arg0);
	...
	static int WithRepresentation(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Decimal128Serializer o = obj.WithRepresentation(arg0);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int get_Converter(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.Decimal128Serializer obj = (MongoDB.Bson.Serialization.Serializers.Decimal128Serializer)o;
