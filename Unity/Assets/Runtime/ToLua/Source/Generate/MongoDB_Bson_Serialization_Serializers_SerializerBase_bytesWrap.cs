...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_bytesWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<byte[]>), typeof(System.Object), "SerializerBase_bytes");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<byte[]> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<byte[]>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<byte[]>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<byte[]> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<byte[]>)o;
