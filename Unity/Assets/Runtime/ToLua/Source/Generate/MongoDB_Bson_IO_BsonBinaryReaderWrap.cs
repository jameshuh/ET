...
public class MongoDB_Bson_IO_BsonBinaryReaderWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.IO.BsonBinaryReader), typeof(MongoDB.Bson.IO.BsonReader));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_IO_BsonBinaryReader);
	...
	static int _CreateMongoDB_Bson_IO_BsonBinaryReader(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				MongoDB.Bson.IO.BsonBinaryReader obj = new MongoDB.Bson.IO.BsonBinaryReader(arg0);
			...
			{
				System.IO.Stream arg0 = (System.IO.Stream)ToLua.CheckObject<System.IO.Stream>(L, 1);
				MongoDB.Bson.IO.BsonBinaryReaderSettings arg1 = (MongoDB.Bson.IO.BsonBinaryReaderSettings)ToLua.CheckObject<MongoDB.Bson.IO.BsonBinaryReaderSettings>(L, 2);
				MongoDB.Bson.IO.BsonBinaryReader obj = new MongoDB.Bson.IO.BsonBinaryReader(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.IO.BsonBinaryReader.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.IO.BsonBinaryReader obj = (MongoDB.Bson.IO.BsonBinaryReader)ToLua.CheckObject<MongoDB.Bson.IO.BsonBinaryReader>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
	...
	static int ReadName(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: MongoDB.Bson.IO.BsonBinaryReader.ReadName");
			}
		}
		catch (Exception e)
		{
	...
	static int get_BaseStream(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.IO.BsonBinaryReader obj = (MongoDB.Bson.IO.BsonBinaryReader)o;
