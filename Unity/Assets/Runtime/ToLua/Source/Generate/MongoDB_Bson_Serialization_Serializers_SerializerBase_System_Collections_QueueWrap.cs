...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_System_Collections_QueueWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Queue>), typeof(System.Object), "SerializerBase_System_Collections_Queue");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Queue> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Queue>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Queue>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Queue> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Queue>)o;
