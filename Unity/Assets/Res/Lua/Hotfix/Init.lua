...
System.namespace("DCET", function (namespace)
  namespace.class("Init", function (namespace)
    local Start, Encode, Decode, TestBehaviorTree, Update, LateUpdate, OnApplicationQuit
    Start = function ()
      System.async(function (async)
        System.try(function ()
          ...
          local t = Decode(bytes, DCET.R2C_Login)

          DCET.Log.Error(DCET.JsonHelper.ToJson(t))
