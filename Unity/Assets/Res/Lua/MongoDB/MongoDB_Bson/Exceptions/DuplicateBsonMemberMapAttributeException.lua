...
System.namespace("MongoDB.Bson", function (namespace)
  ...
  -- </summary>
  namespace.class("DuplicateBsonMemberMapAttributeException", function (namespace)
    ...
    __ctor2__ = function (this, message, inner)
      MongoDBBson.BsonException.__ctor__[3](this, message, inner)
    end
    -- <summary>
    -- Initializes a new instance of the <see cref="DuplicateBsonMemberMapAttributeException" /> class.
    -- </summary>
    -- <param name="context">The context.</param>
    __ctor3__ = function (this, info, context)
