...
local MongoDBBson
local MongoDBBsonIO
local ArrayBsonInt32
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBBsonIO = MongoDB.Bson.IO
  ArrayBsonInt32 = System.Array(MongoDBBson.BsonInt32)
end)
System.namespace("MongoDB.Bson", function (namespace)
  -- <summary>
  -- Represents a BSON int value.
  -- </summary>
  namespace.class("BsonInt32", function (namespace)
    local __precreatedInstances, getMinusOne, getZero, getOne, getTwo, getThree, getBsonType, getRawValue, 
    getValue, op_Implicit22, op_Inequality1, op_Equality1, Create1, CompareTo, CompareTo1, Equals, 
    EqualsObj, GetHashCode, ToBoolean1, ToDecimal1, ToDecimal128, ToDouble1, ToInt321, ToInt641, 
    ToString, IConvertibleGetTypeCodeImplementation, IConvertibleToBooleanImplementation, IConvertibleToByteImplementation, IConvertibleToCharImplementation, IConvertibleToDecimalImplementation, IConvertibleToDoubleImplementation, IConvertibleToInt16Implementation, 
    ...
    OperatorEqualsImplementation, class, static, __ctor__
    static = function (this)
      __precreatedInstances = ArrayBsonInt32:new(201 --[[__maxPrecreatedValue - __minPrecreatedValue + 1]])
      for i = -100 --[[BsonInt32.__minPrecreatedValue]], 100 do
        local precreatedInstance = class(i)
        local index = i - -100 --[[BsonInt32.__minPrecreatedValue]]
    ...
    getMinusOne = function ()
      return op_Implicit22((- 1))
    end
    getZero = function ()
      return op_Implicit22(0)
    end
    getOne = function ()
      return op_Implicit22(1)
    end
    getTwo = function ()
      return op_Implicit22(2)
    end
    getThree = function ()
      return op_Implicit22(3)
    end
    ...
    op_Implicit22 = function (value)
      if value >= -100 --[[BsonInt32.__minPrecreatedValue]] and value <= 100 --[[BsonInt32.__maxPrecreatedValue]] then
        local index = value - -100 --[[BsonInt32.__minPrecreatedValue]]
    ...
    Create1 = function (value)
      ...
      return System.cast(class, MongoDBBson.BsonTypeMapper.MapToBsonValue1(value, 16 --[[BsonType.Int32]]))
    end
    -- <summary>
    ...
    CompareTo1 = function (this, other)
      ...
      local otherInt32 = System.as(other, class)
      if op_Inequality1(otherInt32, nil) then
        return this._value:CompareTo(otherInt32._value)
      end
      ...
      if MongoDBBson.BsonDecimal128.op_Inequality1(otherDecimal128, nil) then
        return (MongoDBBson.Decimal128.op_Implicit2(this._value)):CompareTo(otherDecimal128:getValue())
      end
    ...
    ToDecimal128 = function (this)
      return MongoDBBson.Decimal128.op_Implicit2(this._value)
    end
    -- <summary>
    ...
    ToString = function (this)
      return MongoDBBsonIO.JsonConvert.ToString7(this._value)
    end
    ...
    OperatorEqualsImplementation = function (this, rhs)
      local rhsInt32 = System.as(rhs, class)
      if op_Inequality1(rhsInt32, nil) then
        return this._value == rhsInt32._value
      end
      ...
      if MongoDBBson.BsonDecimal128.op_Inequality1(rhsDecimal128, nil) then
        return this._value == MongoDBBson.Decimal128.op_Explicit7(rhsDecimal128:getValue())
        -- use == instead of Equals so NaN is handled correctly
      end
    ...
    class = {
      base = function (out)
        return {
          ...
          System.IComparable_1(out.MongoDB.Bson.BsonInt32),
          System.IEquatable_1(out.MongoDB.Bson.BsonInt32)
        }
      end,
      _value = 0,
      getMinusOne = getMinusOne,
      getZero = getZero,
      getOne = getOne,
      getTwo = getTwo,
      getThree = getThree,
      ...
      __metadata__ = function (out)
        return {
          fields = {
            { "__precreatedInstances", 0x9, System.Array(out.MongoDB.Bson.BsonInt32) },
            { "_value", 0x1, System.Int32 }
          },
          properties = {
            { "BsonType", 0x206, System.Int32, getBsonType },
            { "MinusOne", 0x20E, class, getMinusOne, System.ObsoleteAttribute("Use (BsonInt32)(-1) instead.") },
            { "One", 0x20E, class, getOne, System.ObsoleteAttribute("Use (BsonInt32)1 instead.") },
            { "RawValue", 0x206, System.Object, getRawValue, System.ObsoleteAttribute("Use Value instead.") },
            { "Three", 0x20E, class, getThree, System.ObsoleteAttribute("Use (BsonInt32)3 instead.") },
            { "Two", 0x20E, class, getTwo, System.ObsoleteAttribute("Use (BsonInt32)2 instead.") },
            { "Value", 0x206, System.Int32, getValue },
            { "Zero", 0x20E, class, getZero, System.ObsoleteAttribute("Use (BsonInt32)0 instead.") }
          },
