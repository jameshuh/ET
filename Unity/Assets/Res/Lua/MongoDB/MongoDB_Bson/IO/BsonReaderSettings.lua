...
System.namespace("MongoDB.Bson.IO", function (namespace)
  ...
  -- </summary>
  namespace.class("BsonReaderSettings", function (namespace)
    local getGuidRepresentation, setGuidRepresentation, getIsFrozen, Clone, Freeze, FrozenCopy, ThrowFrozenException, internal, 
    __ctor1__, __ctor2__
