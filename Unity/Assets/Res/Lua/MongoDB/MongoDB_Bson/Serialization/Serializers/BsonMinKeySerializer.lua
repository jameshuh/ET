...
local BsonValueSerializerBase_1BsonMinKey
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonMinKey = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonMinKey)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonMinKeys.
  -- </summary>
  namespace.class("BsonMinKeySerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonMinKey.__ctor__(this, 255 --[[BsonType.MinKey]])
    end
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonMinKey)
        }
      end,
