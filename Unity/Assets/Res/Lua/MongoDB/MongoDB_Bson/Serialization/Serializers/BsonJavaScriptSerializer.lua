...
local BsonValueSerializerBase_1BsonJavaScript
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonJavaScript = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonJavaScript)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonJavaScripts.
  -- </summary>
  namespace.class("BsonJavaScriptSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonJavaScript.__ctor__(this, 13 --[[BsonType.JavaScript]])
    end
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.BsonJavaScript(bsonReader:ReadJavaScript())
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonJavaScript)
        }
      end,
