...
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  ...
  -- </summary>
  namespace.class("UInt64Serializer", function (namespace)
    ...
    __ctor1__ = function (this)
      __ctor2__(this, 18 --[[BsonType.Int64]])
    end
    -- <summary>
    -- Initializes a new instance of the <see cref="UInt64Serializer"/> class.
    -- </summary>
    ...
    __ctor3__ = function (this, representation, converter)
      repeat
        ...
        if default == 19 --[[BsonType.Decimal128]] or default == 1 --[[BsonType.Double]] or default == 16 --[[BsonType.Int32]] or default == 18 --[[BsonType.Int64]] or default == 2 --[[BsonType.String]] then
          ...
          local message = System.String.Format("{0} is not a valid representation for a UInt64Serializer.", representation)
    ...
    Deserialize = function (this, context, args)
      ...
      repeat
        ...
        if default == 19 --[[BsonType.Decimal128]] then
          return this._converter:ToUInt64(bsonReader:ReadDecimal128())
        elseif default == 1 --[[BsonType.Double]] then
          return this._converter:ToUInt641(bsonReader:ReadDouble())
        elseif default == 16 --[[BsonType.Int32]] then
          return this._converter:ToUInt642(bsonReader:ReadInt32())
        elseif default == 18 --[[BsonType.Int64]] then
          return this._converter:ToUInt643(bsonReader:ReadInt64())
        elseif default == 2 --[[BsonType.String]] then
          return MongoDBBsonIO.JsonConvert.ToUInt64(bsonReader:ReadString())
        else
    ...
    Serialize = function (this, context, args, value)
      ...
      repeat
        ...
        if default == 19 --[[BsonType.Decimal128]] then
          bsonWriter:WriteDecimal128(this._converter:ToDecimal1284(value))
          break
        elseif default == 1 --[[BsonType.Double]] then
          bsonWriter:WriteDouble(this._converter:ToDouble8(value))
          break
        elseif default == 16 --[[BsonType.Int32]] then
          bsonWriter:WriteInt32(this._converter:ToInt328(value))
          break
        elseif default == 18 --[[BsonType.Int64]] then
          bsonWriter:WriteInt64(this._converter:ToInt648(value))
          break
        elseif default == 2 --[[BsonType.String]] then
          bsonWriter:WriteString(MongoDBBsonIO.JsonConvert.ToString11(value))
          break
        else
          local message = System.String.Format("'{0}' is not a valid UInt64 representation.", this._representation)
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.StructSerializerBase_1(System.UInt64),
          out.MongoDB.Bson.Serialization.IRepresentationConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.UInt64Serializer),
          out.MongoDB.Bson.Serialization.IRepresentationConverterConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.UInt64Serializer)
        }
      end,
      _representation = 0,
