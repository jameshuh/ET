...
local BsonValueSerializerBase_1BsonBoolean
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonBoolean = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonBoolean)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonBooleans.
  -- </summary>
  namespace.class("BsonBooleanSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonBoolean.__ctor__(this, 8 --[[BsonType.Boolean]])
    end
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.BsonBoolean.op_Implicit22(bsonReader:ReadBoolean())
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonBoolean)
        }
      end,
