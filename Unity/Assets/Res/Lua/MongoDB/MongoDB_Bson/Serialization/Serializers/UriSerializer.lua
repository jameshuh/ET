...
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  ...
  -- </summary>
  namespace.class("UriSerializer", function (namespace)
    ...
    DeserializeValue = function (this, context, args)
      ...
      return System.Uri(bsonReader:ReadString(), 0 --[[UriKind.RelativeOrAbsolute]])
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    SerializeValue = function (this, context, args, value)
      ...
      bsonWriter:WriteString(value:getOriginalString())
    end
    return {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.ClassSerializerBase_1(System.Uri)
        }
      end,
