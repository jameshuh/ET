...
local BsonValueSerializerBase_1BsonRegularExpression
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonRegularExpression = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonRegularExpression)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  ...
  -- </summary>
  namespace.class("BsonRegularExpressionSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonRegularExpression.__ctor__(this, 11 --[[BsonType.RegularExpression]])
    end
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonRegularExpression)
        }
      end,
