...
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  ...
  -- </summary>
  namespace.class("Int16Serializer", function (namespace)
    ...
    __ctor3__ = function (this, representation, converter)
      repeat
        ...
        if default == 19 --[[BsonType.Decimal128]] or default == 1 --[[BsonType.Double]] or default == 16 --[[BsonType.Int32]] or default == 18 --[[BsonType.Int64]] or default == 2 --[[BsonType.String]] then
          ...
          local message = System.String.Format("{0} is not a valid representation for an Int16Serializer.", representation)
    ...
    Deserialize = function (this, context, args)
      ...
      repeat
        ...
        if default == 19 --[[BsonType.Decimal128]] then
          return this._converter:ToInt16(bsonReader:ReadDecimal128())
        elseif default == 1 --[[BsonType.Double]] then
          return this._converter:ToInt161(bsonReader:ReadDouble())
        elseif default == 16 --[[BsonType.Int32]] then
          return this._converter:ToInt162(bsonReader:ReadInt32())
        elseif default == 18 --[[BsonType.Int64]] then
          return this._converter:ToInt163(bsonReader:ReadInt64())
        elseif default == 2 --[[BsonType.String]] then
          return MongoDBBsonIO.JsonConvert.ToInt16(bsonReader:ReadString())
        else
    ...
    Serialize = function (this, context, args, value)
      ...
      repeat
        ...
        if default == 19 --[[BsonType.Decimal128]] then
          ...
          break
        elseif default == 1 --[[BsonType.Double]] then
          bsonWriter:WriteDouble(this._converter:ToDouble6(value))
          break
        elseif default == 16 --[[BsonType.Int32]] then
          bsonWriter:WriteInt32(this._converter:ToInt326(value))
          break
        elseif default == 18 --[[BsonType.Int64]] then
          bsonWriter:WriteInt64(this._converter:ToInt646(value))
          break
        elseif default == 2 --[[BsonType.String]] then
          bsonWriter:WriteString(MongoDBBsonIO.JsonConvert.ToString9(value))
          break
        else
          local message = System.String.Format("'{0}' is not a valid Int16 representation.", this._representation)
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.StructSerializerBase_1(System.Int16),
          out.MongoDB.Bson.Serialization.IRepresentationConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.Int16Serializer),
          out.MongoDB.Bson.Serialization.IRepresentationConverterConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.Int16Serializer)
        }
      end,
      _representation = 0,
