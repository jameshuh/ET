...
local BsonValueSerializerBase_1BsonTimestamp
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonTimestamp = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonTimestamp)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonTimestamps.
  -- </summary>
  namespace.class("BsonTimestampSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonTimestamp.__ctor__(this, 17 --[[BsonType.Timestamp]])
    end
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.BsonTimestamp(bsonReader:ReadTimestamp())
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonTimestamp)
        }
      end,
