...
local BsonValueSerializerBase_1BsonObjectId
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonObjectId = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonObjectId)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonObjectIds.
  -- </summary>
  namespace.class("BsonObjectIdSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonObjectId.__ctor__(this, 7 --[[BsonType.ObjectId]])
    end
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.BsonObjectId(bsonReader:ReadObjectId())
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    SerializeValue = function (this, context, args, value)
      ...
      bsonWriter:WriteObjectId(value:getValue())
    end
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonObjectId)
        }
      end,
