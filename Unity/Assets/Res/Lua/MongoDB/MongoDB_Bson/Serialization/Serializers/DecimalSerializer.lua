...
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  ...
  -- </summary>
  namespace.class("DecimalSerializer", function (namespace)
    ...
    __ctor3__ = function (this, representation, converter)
      repeat
        ...
        if default == 4 --[[BsonType.Array]] or default == 19 --[[BsonType.Decimal128]] or default == 1 --[[BsonType.Double]] or default == 16 --[[BsonType.Int32]] or default == 18 --[[BsonType.Int64]] or default == 2 --[[BsonType.String]] then
          break
        else
          local message = System.String.Format("{0} is not a valid representation for a DecimalSerializer.", representation)
    ...
    Deserialize = function (this, context, args)
      ...
      repeat
        ...
        if default == 4 --[[BsonType.Array]] then
          local array = MongoDBBsonSerialization.IBsonSerializerExtensions.Deserialize1(MongoDBSerializers.BsonArraySerializer.getInstance(), context, MongoDBBson.BsonArray)
          local bits = ArrayInt32:new(4)
          bits:set(0, array:get(0):getAsInt32())
          bits:set(1, array:get(1):getAsInt32())
          bits:set(2, array:get(2):getAsInt32())
          bits:set(3, array:get(3):getAsInt32())
          return System.Double(bits)
        elseif default == 19 --[[BsonType.Decimal128]] then
          return this._converter:ToDecimal(bsonReader:ReadDecimal128())
        elseif default == 1 --[[BsonType.Double]] then
          return this._converter:ToDecimal1(bsonReader:ReadDouble())
        elseif default == 16 --[[BsonType.Int32]] then
          return this._converter:ToDecimal2(bsonReader:ReadInt32())
        elseif default == 18 --[[BsonType.Int64]] then
          return this._converter:ToDecimal3(bsonReader:ReadInt64())
        elseif default == 2 --[[BsonType.String]] then
          return MongoDBBsonIO.JsonConvert.ToDecimal(bsonReader:ReadString())
        else
    ...
    Serialize = function (this, context, args, value)
      ...
      repeat
        ...
        if default == 4 --[[BsonType.Array]] then
          ...
          bsonWriter:WriteInt32(bits:get(0))
          bsonWriter:WriteInt32(bits:get(1))
          bsonWriter:WriteInt32(bits:get(2))
          bsonWriter:WriteInt32(bits:get(3))
          bsonWriter:WriteEndArray()
          break
        elseif default == 19 --[[BsonType.Decimal128]] then
          bsonWriter:WriteDecimal128(this._converter:ToDecimal128(value))
          break
        elseif default == 1 --[[BsonType.Double]] then
          bsonWriter:WriteDouble(this._converter:ToDouble(value))
          break
        elseif default == 16 --[[BsonType.Int32]] then
          bsonWriter:WriteInt32(this._converter:ToInt32(value))
          break
        elseif default == 18 --[[BsonType.Int64]] then
          bsonWriter:WriteInt64(this._converter:ToInt64(value))
          break
        elseif default == 2 --[[BsonType.String]] then
          bsonWriter:WriteString(MongoDBBsonIO.JsonConvert.ToString3(value))
          break
        else
          local message = System.String.Format("'{0}' is not a valid Decimal representation.", this._representation)
    ...
    class = {
      base = function (out)
        return {
          ...
          out.MongoDB.Bson.Serialization.IRepresentationConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.DecimalSerializer),
          out.MongoDB.Bson.Serialization.IRepresentationConverterConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.DecimalSerializer)
        }
      end,
      _representation = 0,
