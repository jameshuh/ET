...
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  ...
  -- </summary>
  namespace.class("Decimal128Serializer", function (namespace)
    ...
    __ctor3__ = function (this, representation, converter)
      repeat
        ...
        if default == 19 --[[BsonType.Decimal128]] or default == 1 --[[BsonType.Double]] or default == 16 --[[BsonType.Int32]] or default == 18 --[[BsonType.Int64]] or default == 2 --[[BsonType.String]] then
          ...
          local message = System.String.Format("{0} is not a valid representation for a Decimal128Serializer.", representation)
    ...
    Deserialize = function (this, context, args)
      ...
      repeat
        ...
        elseif default == 1 --[[BsonType.Double]] then
          return this._converter:ToDecimal1281(bsonReader:ReadDouble())
        elseif default == 16 --[[BsonType.Int32]] then
          return this._converter:ToDecimal1282(bsonReader:ReadInt32())
        elseif default == 18 --[[BsonType.Int64]] then
          return this._converter:ToDecimal1283(bsonReader:ReadInt64())
        elseif default == 2 --[[BsonType.String]] then
          return MongoDBBsonIO.JsonConvert.ToDecimal128(bsonReader:ReadString())
        else
    ...
    Serialize = function (this, context, args, value)
      ...
      repeat
        ...
        if default == 19 --[[BsonType.Decimal128]] then
          bsonWriter:WriteDecimal128(value:__clone__())
          break
        elseif default == 1 --[[BsonType.Double]] then
          bsonWriter:WriteDouble(this._converter:ToDouble1(value:__clone__()))
          break
        elseif default == 16 --[[BsonType.Int32]] then
          bsonWriter:WriteInt32(this._converter:ToInt321(value:__clone__()))
          break
        elseif default == 18 --[[BsonType.Int64]] then
          bsonWriter:WriteInt64(this._converter:ToInt641(value:__clone__()))
          break
        elseif default == 2 --[[BsonType.String]] then
          bsonWriter:WriteString(MongoDBBsonIO.JsonConvert.ToString4(value:__clone__()))
          break
        else
          local message = System.String.Format("'{0}' is not a valid Decimal128 representation.", this._representation)
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.StructSerializerBase_1(out.MongoDB.Bson.Decimal128),
          out.MongoDB.Bson.Serialization.IRepresentationConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.Decimal128Serializer),
          out.MongoDB.Bson.Serialization.IRepresentationConverterConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.Decimal128Serializer)
        }
      end,
      _representation = 0,
