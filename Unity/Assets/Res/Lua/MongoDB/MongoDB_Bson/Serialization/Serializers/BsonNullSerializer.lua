...
local BsonValueSerializerBase_1BsonNull
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonNull = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonNull)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonNulls.
  -- </summary>
  namespace.class("BsonNullSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonNull.__ctor__(this, 10 --[[BsonType.Null]])
    end
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonNull)
        }
      end,
