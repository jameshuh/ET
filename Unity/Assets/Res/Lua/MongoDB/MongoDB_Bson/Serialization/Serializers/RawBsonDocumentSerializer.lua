...
local BsonValueSerializerBase_1RawBsonDocument
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1RawBsonDocument = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.RawBsonDocument)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for RawBsonDocuments.
  -- </summary>
  namespace.class("RawBsonDocumentSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1RawBsonDocument.__ctor__(this, 3 --[[BsonType.Document]])
    end
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.RawBsonDocument(slice)
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    SerializeValue = function (this, context, args, value)
      ...
      bsonWriter:WriteRawBsonDocument(value:getSlice())
    end
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.RawBsonDocument)
        }
      end,
