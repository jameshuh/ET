...
local BsonValueSerializerBase_1RawBsonArray
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1RawBsonArray = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.RawBsonArray)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for RawBsonArrays.
  -- </summary>
  namespace.class("RawBsonArraySerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1RawBsonArray.__ctor__(this, 4 --[[BsonType.Array]])
    end
    -- <summary>
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.RawBsonArray(slice)
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    SerializeValue = function (this, context, args, value)
      ...
      bsonWriter:WriteRawBsonArray(value:getSlice())
    end
    return {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.RawBsonArray)
        }
      end,
