...
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  ...
  -- </summary>
  namespace.class("ByteSerializer", function (namespace)
    ...
    __ctor2__ = function (this, representation)
      repeat
        ...
        if default == 5 --[[BsonType.Binary]] or default == 16 --[[BsonType.Int32]] or default == 18 --[[BsonType.Int64]] or default == 2 --[[BsonType.String]] then
          ...
          local message = System.String.Format("{0} is not a valid representation for a ByteSerializer.", representation)
    ...
    Deserialize = function (this, context, args)
      ...
      repeat
        ...
        elseif default == 2 --[[BsonType.String]] then
          ...
          value = System.Byte.Parse(s, 515 --[[NumberStyles.HexNumber]])
          break
        else
      ...
      if lostData then
        local message = System.String.Format("Data loss occurred when trying to convert from {0} to Byte.", bsonType)
    ...
    Serialize = function (this, context, args, value)
      ...
      repeat
        ...
        if default == 5 --[[BsonType.Binary]] then
          bsonWriter:WriteBytes(ArrayByte(value))
          break
        elseif default == 16 --[[BsonType.Int32]] then
        ...
        elseif default == 18 --[[BsonType.Int64]] then
          ...
          break
        elseif default == 2 --[[BsonType.String]] then
          bsonWriter:WriteString(System.String.Format("{0:x2}", value))
          break
        else
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.StructSerializerBase_1(System.Byte),
          out.MongoDB.Bson.Serialization.IRepresentationConfigurable_1(out.MongoDB.Bson.Serialization.Serializers.ByteSerializer)
        }
      end,
      _representation = 0,
