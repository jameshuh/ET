...
local BsonValueSerializerBase_1BsonInt64
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonInt64 = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonInt64)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonInt64s.
  -- </summary>
  namespace.class("BsonInt64Serializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonInt64.__ctor__(this, 18 --[[BsonType.Int64]])
    end
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.BsonInt64.op_Implicit22(bsonReader:ReadInt64())
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    SerializeValue = function (this, context, args, value)
      ...
      bsonWriter:WriteInt64(value:getValue())
    end
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonInt64)
        }
      end,
