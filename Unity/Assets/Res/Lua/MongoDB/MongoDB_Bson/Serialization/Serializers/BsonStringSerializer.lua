...
local BsonValueSerializerBase_1BsonString
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonString = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonString)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonStrings.
  -- </summary>
  namespace.class("BsonStringSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonString.__ctor__(this, 2 --[[BsonType.String]])
    end
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.BsonString.op_Implicit22(bsonReader:ReadString())
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonString)
        }
      end,
