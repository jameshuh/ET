...
local BsonValueSerializerBase_1BsonUndefined
System.import(function (out)
  MongoDBBson = MongoDB.Bson
  MongoDBSerializers = MongoDB.Bson.Serialization.Serializers
  BsonValueSerializerBase_1BsonUndefined = MongoDBSerializers.BsonValueSerializerBase_1(MongoDBBson.BsonUndefined)
end)
System.namespace("MongoDB.Bson.Serialization.Serializers", function (namespace)
  -- <summary>
  -- Represents a serializer for BsonUndefineds.
  -- </summary>
  namespace.class("BsonUndefinedSerializer", function (namespace)
    ...
    __ctor__ = function (this)
      BsonValueSerializerBase_1BsonUndefined.__ctor__(this, 6 --[[BsonType.Undefined]])
    end
    ...
    DeserializeValue = function (this, context, args)
      ...
      return MongoDBBson.BsonUndefined.getValue()
    end
    -- <summary>
    -- Serializes a value.
    -- </summary>
    ...
    class = {
      base = function (out)
        return {
          out.MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase_1(out.MongoDB.Bson.BsonUndefined)
        }
      end,
