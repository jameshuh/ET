...
System.namespace("MongoDB.Bson.Serialization.IdGenerators", function (namespace)
  ...
  -- </summary>
  namespace.class("ObjectIdGenerator", function (namespace)
    ...
    GenerateId = function (this, container, document)
      return MongoDBBson.ObjectId.GenerateNewId()
    end
    -- <summary>
    ...
    IsEmpty = function (this, id)
      return id == nil or MongoDBBson.ObjectId.op_Equality(System.cast(MongoDBBson.ObjectId, id), MongoDBBson.ObjectId.getEmpty())
    end
    class = {
      base = function (out)
        return {
