...
System.namespace("MongoDB.Bson.Serialization.IdGenerators", function (namespace)
  ...
  -- </summary>
  namespace.class("StringObjectIdGenerator", function (namespace)
    ...
    GenerateId = function (this, container, document)
      return MongoDBBson.ObjectId.GenerateNewId():ToString()
    end
    -- <summary>
    ...
    IsEmpty = function (this, id)
      return System.String.IsNullOrEmpty(System.cast(System.String, id))
    end
    class = {
      base = function (out)
        return {
