...
System.import(function (out)
  ...
  HashSetEntity = System.HashSet(DCETHotfix.Entity)
  DictTypeEntity = System.Dictionary(System.Type, DCETHotfix.Entity)
  DictInt64Entity = System.Dictionary(System.Int64, DCETHotfix.Entity)
  Pool_1HashSetEntity = DCETHotfix.Pool_1(HashSetEntity)
  Pool_1DictTypeEntity = DCETHotfix.Pool_1(DictTypeEntity)
  Pool_1DictInt64Entity = DCETHotfix.Pool_1(DictInt64Entity)
end)
System.namespace("DCET.Hotfix", function (namespace)
  ...
  namespace.class("Entity", function (namespace)
    ...
    __ctor__ = function (this)
      this.status = DCETHotfix.EntityStatus.None
      this.InstanceId = DCETHotfix.IdGenerater.GenerateId()


      if not this:GetType():IsDefined(System.typeof(DCETHotfix.HideInHierarchy), true) then
    ...
    getIsFromPool = function (this)
      return (System.band(this.status, DCETHotfix.EntityStatus.IsFromPool)) == DCETHotfix.EntityStatus.IsFromPool
    end
    setIsFromPool = function (this, value)
      if value then
        this.status = System.bor(this.status, DCETHotfix.EntityStatus.IsFromPool)
      else
        this.status = System.band(this.status, System.bnot(DCETHotfix.EntityStatus.IsFromPool))
      end
    ...
    getIsRegister = function (this)
      return (System.band(this.status, DCETHotfix.EntityStatus.IsRegister)) == DCETHotfix.EntityStatus.IsRegister
    end
    setIsRegister = function (this, value)
      ...
      if value then
        this.status = System.bor(this.status, DCETHotfix.EntityStatus.IsRegister)
      else
        this.status = System.band(this.status, System.bnot(DCETHotfix.EntityStatus.IsRegister))
      end
      DCETHotfix.Game.getEventSystem():RegisterSystem(this, value)
    end
    getIsComponent = function (this)
      return (System.band(this.status, DCETHotfix.EntityStatus.IsComponent)) == DCETHotfix.EntityStatus.IsComponent
    end
    setIsComponent = function (this, value)
      if value then
        this.status = System.bor(this.status, DCETHotfix.EntityStatus.IsComponent)
      else
        this.status = System.band(this.status, System.bnot(DCETHotfix.EntityStatus.IsComponent))
      end
    end
    ...
    setParent = function (this, value)
      ...
      if this.parent ~= nil then
        ...
        if this.parent.InstanceId == value.InstanceId then
          DCETHotfix.Log.Error1("重复设置了Parent: " .. this:GetType():getName() .. " parent: " .. this.parent:GetType():getName())
          return
        end
    ...
    AfterSetParent = function (this)
      ...
      -- 检测自己的domain是不是跟父亲一样
      if getDomain(this) ~= nil and getDomain(this.parent) ~= nil and getDomain(this).InstanceId ~= getDomain(this.parent).InstanceId and not (System.is(this, DCETHotfix.Scene)) then
        DCETHotfix.Log.Error1("自己的domain跟parent不一样: " .. this:GetType():getName())
      end
    ...
    ToString = function (this)
      return DCETModel.MongoHelper.ToJson(this)
    end
    ...
    setDomain = function (this, value)
      ...
      if not (System.is(this.domain, DCETHotfix.Scene)) then
      ...
      if preDomain == nil and not getIsFromPool(this) then
        DCETHotfix.Game.getEventSystem():Deserialize(this)
      end
    end
    ...
    AddChildDB = function (this, entity)
      if not (System.is(entity, DCETHotfix.ISerializeToEntity)) then
        return
      end
    ...
    Dispose = function (this)
      ...
      DCETHotfix.Game.getEventSystem():Remove(instanceId)

      -- 触发Destroy事件
      DCETHotfix.Game.getEventSystem():Destroy(this)
      ...
      if getIsFromPool(this) then
        DCETHotfix.Game.getObjectPool():Recycle(this)
      else
    ...
    AddToComponent = function (this, type, component)
      ...
      if System.is(component, DCETHotfix.ISerializeToEntity) then
    ...
    CreateWithComponentParent = function (this, type)
      local component
      if type:IsDefined(System.typeof(DCETHotfix.NoObjectPool), false) then
        component = System.cast(class, System.Activator.CreateInstance(type))
      else
        component = DCETHotfix.Game.getObjectPool():Fetch(type)
      end

      setDomain(this, getDomain(this.parent))
      component.Id = this.parent.Id
      setComponentParent(component, this.parent)
    ...
    class = {
      ...
      __metadata__ = function (out)
        return {
          properties = {
            { "Children", 0x206, System.Dictionary(System.Int64, out.DCET.Hotfix.Entity), getChildren, out.MongoDB.Bson.Serialization.Attributes.BsonIgnoreAttribute() },
            { "ComponentParent", 0x301, class, setComponentParent, out.MongoDB.Bson.Serialization.Attributes.BsonIgnoreAttribute() },
            { "Components", 0x206, System.Dictionary(System.Type, out.DCET.Hotfix.Entity), getComponents, out.MongoDB.Bson.Serialization.Attributes.BsonIgnoreAttribute() },
          ...
          fields = {
            { "children", 0x1, System.Dictionary(System.Int64, out.DCET.Hotfix.Entity), out.MongoDB.Bson.Serialization.Attributes.BsonIgnoreAttribute() },
            { "childrenDB", 0x1, System.HashSet(out.DCET.Hotfix.Entity), out.MongoDB.Bson.Serialization.Attributes.BsonElementAttribute("Children"), out.MongoDB.Bson.Serialization.Attributes.BsonIgnoreIfNullAttribute() },
            { "components", 0x1, System.Dictionary(System.Type, out.DCET.Hotfix.Entity), out.MongoDB.Bson.Serialization.Attributes.BsonIgnoreAttribute() },
            { "componentsDB", 0x1, System.HashSet(out.DCET.Hotfix.Entity), out.MongoDB.Bson.Serialization.Attributes.BsonElementAttribute("C"), out.MongoDB.Bson.Serialization.Attributes.BsonIgnoreIfNullAttribute() },
