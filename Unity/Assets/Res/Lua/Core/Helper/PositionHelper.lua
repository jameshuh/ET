...
System.namespace("DCET", function (namespace)
  namespace.class("PositionHelper", function (namespace)
    local RayCastV2ToV3, RayCastXYToV3, RayCastV3ToV3, AngleToQuaternion, GetVector3ToQuaternion, Distance2D, GetAngleToQuaternion, Vector3ToAngle360, 
    DistanceOfPointToVector, RayCastSphere, GGTheorem, IgnoreYAxis, PointOnLeftSideOfVector
    ...
    AngleToQuaternion = function (angle)
      return UnityEngine.Quaternion.AngleAxis(- angle, UnityEngine.Vector3.getup()) * UnityEngine.Quaternion.AngleAxis(90, UnityEngine.Vector3.getup())
    end
    GetVector3ToQuaternion = function (source, dire)
      ...
      local direction = (dire - nowPos):getnormalized()
    ...
    RayCastSphere = function (ray, center, redius, dist)
      dist = 0
      local ma = center - ray.origin:__clone__()
      local distance = UnityEngine.Vector3.Cross(ma, ray.direction:__clone__()):getmagnitude() / ray.direction:__clone__():getmagnitude()
      if distance < redius then
        local op = GGTheorem(UnityEngine.Vector3.Distance(center, ray.origin:__clone__()), distance)
    ...
    PointOnLeftSideOfVector = function (vector3, originPoint, point)
      ...
      local pointVec2 = (IgnoreYAxis(point) - originVec2):getnormalized()
