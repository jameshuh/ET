...
System.namespace("DCET", function (namespace)
  namespace.class("StringHelper", function (namespace)
    ...
    HexToBytes = function (hexString)
      ...
      local hexAsBytes = ArrayByte:new(System.div(#hexString, 2))
      for index = 0, #hexAsBytes - 1 do
        ...
        hexAsBytes:set(index, System.Byte.Parse(byteValue, 515 --[[NumberStyles.HexNumber]], SystemGlobalization.CultureInfo.getInvariantCulture()))
      end
      return hexAsBytes
    end
