...
System.namespace("DCET", function (namespace)
  namespace.class("MultiMap_2", function (namespace)
    return function (T, K)
      local GetDictionary, Add, First, FirstKey, getCount, FetchList, RecycleList, Remove, 
      Remove1, GetAll, get, GetOne, Contains, ContainsKey, Clear, __ctor__
