...
System.import(function (out)
  ...
  DictInt64ITimer = System.Dictionary(System.Int64, DCETHotfix.ITimer)
  MultiMap_2Int64Int64 = DCETHotfix.MultiMap_2(System.Int64, System.Int64)
end)
System.namespace("DCET.Hotfix", function (namespace)
  ...
  namespace.class("OnceWaitTimerAwakeSystem", function (namespace)
    ...
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.AwakeSystem_2(out.DCET.Hotfix.OnceWaitTimer, System.TaskCompletionSource)
        }
      end,
      Awake = Awake,
  ...
  namespace.class("OnceWaitTimer", function (namespace)
    ...
    Run = function (this)
      ...
      this:GetParent(DCETHotfix.TimerComponent):Remove(this.Id)
      tcs:SetResult(true)
    end
    return {
      base = function (out)
  ...
  namespace.class("OnceTimerAwakeSystem", function (namespace)
    ...
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.AwakeSystem_2(out.DCET.Hotfix.OnceTimer, System.Delegate)
        }
      end,
      Awake = Awake,
      __metadata__ = function (out)
  ...
  namespace.class("RepeatedTimerAwakeSystem", function (namespace)
    ...
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.AwakeSystem_3(out.DCET.Hotfix.RepeatedTimer, System.Int64, System.Delegate)
        }
      end,
      Awake = Awake,
      __metadata__ = function (out)
  ...
  namespace.class("RepeatedTimer", function (namespace)
    ...
    Run = function (this)
      ...
      local timerComponent = this:GetParent(DCETHotfix.TimerComponent)
    ...
    Dispose = function (this)
      ...
      if id == 0 then
        DCETHotfix.Log.Error1("RepeatedTimer可能多次释放了" .. "")
        return
      end
  ...
  namespace.class("TimerComponentAwakeSystem", function (namespace)
    ...
    Awake = function (this, self)
      DCETHotfix.TimerComponent.Instance = self
    end
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.AwakeSystem_1(out.DCET.Hotfix.TimerComponent)
        }
      end,
      Awake = Awake,
      __metadata__ = function (out)
  ...
  namespace.class("TimerComponentUpdateSystem", function (namespace)
    ...
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.UpdateSystem_1(out.DCET.Hotfix.TimerComponent)
        }
      end,
      Update = Update,
      __metadata__ = function (out)
  ...
  namespace.class("TimerComponent", function (namespace)
    ...
    WaitTillAsync = function (this, tillTime, cancellationToken)
      if DCETHotfix.TimeHelper.Now() > tillTime then
        return System.Task.getCompletedTask()
      end

      local tcs = System.TaskCompletionSource()

      local timer = DCETHotfix.EntityFactory.CreateWithParent2(this, tcs, DCETHotfix.OnceWaitTimer, System.TaskCompletionSource)
    ...
    WaitAsync = function (this, time, cancellationToken)
      local tillTime = DCETHotfix.TimeHelper.Now() + time
    ...
    NewRepeatedTimer = function (this, time, action)
      ...
      local tillTime = DCETHotfix.TimeHelper.Now() + time
      local timer = DCETHotfix.EntityFactory.CreateWithParent3(this, time, action, DCETHotfix.RepeatedTimer, System.Int64, System.Delegate)
      this.timers:set(timer.Id, timer)
      AddToTimeId(this, tillTime, timer.Id)
      return timer.Id
    end
    GetRepeatedTimer = function (this, id)
      ...
      return System.as(timer, DCETHotfix.RepeatedTimer)
    end
    ...
    NewOnceTimer = function (this, tillTime, action)
      local timer = DCETHotfix.EntityFactory.CreateWithParent2(this, action, DCETHotfix.OnceTimer, System.Delegate)
      this.timers:set(timer.Id, timer)
      AddToTimeId(this, tillTime, timer.Id)
      return timer.Id
    end
    GetOnceTimer = function (this, id)
      ...
      return System.as(timer, DCETHotfix.OnceTimer)
    end
