...
System.namespace("DCET.Hotfix", function (namespace)
  namespace.class("SessionIdleCheckerComponentAwakeSystem", function (namespace)
    ...
    Awake = function (this, self, checkInteral, recvMaxIdleTime, sendMaxIdleTime)
      ...
      self.RepeatedTimer = DCETHotfix.TimerComponent.Instance:NewRepeatedTimer(checkInteral, System.fn(self, self.Check))
    end
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.AwakeSystem_4(out.DCET.Hotfix.SessionIdleCheckerComponent, System.Int32, System.Int32, System.Int32)
        }
      end,
      Awake = Awake,
  ...
  namespace.class("SessionIdleCheckerComponentLoadSystem", function (namespace)
    ...
    Load = function (this, self)
      local repeatedTimer = DCETHotfix.TimerComponent.Instance:GetRepeatedTimer(self.RepeatedTimer)
    ...
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.LoadSystem_1(out.DCET.Hotfix.SessionIdleCheckerComponent)
        }
      end,
      Load = Load,
      __metadata__ = function (out)
  ...
  namespace.class("SessionIdleCheckerComponentDestroySystem", function (namespace)
    ...
    Destroy = function (this, self)
      ...
      DCETHotfix.TimerComponent.Instance:Remove(self.RepeatedTimer)
      self.RepeatedTimer = 0
    end
    return {
      base = function (out)
        return {
          out.DCET.Hotfix.DestroySystem_1(out.DCET.Hotfix.SessionIdleCheckerComponent)
        }
      end,
      Destroy = Destroy,
      __metadata__ = function (out)
  ...
  namespace.class("SessionIdleCheckerComponentSystem", function (namespace)
    local Check
    Check = function (self)
      local session = self:GetParent(DCETHotfix.Session)
