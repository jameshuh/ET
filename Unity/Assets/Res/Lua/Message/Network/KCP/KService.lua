...
local MultiMap_2Int64Int64 = DCETHotfix.MultiMap_2(System.Int64, System.Int64)
local DCETHotfix
local DictInt64KChannel
local DictUInt32KChannel
System.import(function (out)
  DCETHotfix = DCET.Hotfix
  DictInt64KChannel = System.Dictionary(System.Int64, DCETHotfix.KChannel)
  DictUInt32KChannel = System.Dictionary(System.UInt32, DCETHotfix.KChannel)
end)
System.namespace("DCET.Hotfix", function (namespace)
  ...
  namespace.class("KService", function (namespace)
    ...
    __ctor1__ = function (this)
      ...
      this.StartTime = DCETHotfix.TimeHelper.ClientNow()
      this.TimeNow = System.toUInt32(DCETHotfix.TimeHelper.ClientNow() - this.StartTime)
        ...
        repeat
          ...
          repeat
            ...
            if default == 1 --[[KcpProtocalType.SYN]] then
              ...
              localConn = ref
              kChannel = DCETHotfix.KChannel(localConn, remoteConn, this.socket, acceptIpEndPoint, this)
    ...
    GetKChannel = function (this, id)
      ...
      return System.cast(DCETHotfix.KChannel, aChannel)
    end
    ...
    Output = function (bytes, count, user)
      ...
      if aChannel == nil then
        DCETHotfix.Log.Error1("not found kchannel, " .. System.cast(System.UInt32, user))
        return
      end

      local kChannel = System.as(aChannel, DCETHotfix.KChannel)
      kChannel:Output(bytes, count)
    end
    ConnectChannel = function (this, remoteEndPoint)
      local localConn = System.toUInt32(DCETHotfix.RandomHelper.RandomNumber(1000, 2147483647 --[[Int32.MaxValue]]))
      local oldChannel
      local default
      ...
      local channel = System.new(DCETHotfix.KChannel, 2, localConn, this.socket, remoteEndPoint, this)
      this.localConnChannels:set(channel:getLocalConn(), channel)
      return channel
    end
    ConnectChannel1 = function (this, address)
      local ipEndPoint2 = DCETModel.NetworkHelper.ToIPEndPoint(address)
