...
System.import(function (out)
  ...
  DictInt64TChannel = System.Dictionary(System.Int64, DCETHotfix.TChannel)
end)
  ...
  namespace.class("TService", function (namespace)
    ...
    OnComplete = function (this, sender, e)
      repeat
        ...
        if default == 1 --[[SocketAsyncOperation.Accept]] then
          DCETModel.OneThreadSynchronizationContext.getInstance():Post(System.fn(this, OnAcceptComplete), e)
          break
        else
    ...
    OnAcceptComplete = function (this, o)
      ...
      if e:getSocketError() ~= 0 --[[SocketError.Success]] then
        DCETHotfix.Log.Error1("accept error " .. e:getSocketError():EnumToString(SystemNetSockets.SocketError))
        AcceptAsync(this)
        return
      end
      local channel = System.new(DCETHotfix.TChannel, 2, e:getAcceptSocket(), this)
      ...
      System.try(function ()
        ...
        DCETHotfix.Log.Error(exception)
      end)
    ...
    ConnectChannel = function (this, ipEndPoint)
      local channel = DCETHotfix.TChannel(ipEndPoint, this)
      this.idChannels:set(channel.Id, channel)
      channel:setParent(this)
      return channel
    end
    ConnectChannel1 = function (this, address)
      local ipEndPoint = DCETModel.NetworkHelper.ToIPEndPoint(address)
