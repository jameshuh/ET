...
System.namespace("DCET", function (namespace)
  ...
  namespace.class("TChannel", function (namespace)
    ...
    internal = function (this)
      ...
      this.recvBuffer = DCET.CircularBuffer()
      this.sendBuffer = DCET.CircularBuffer()
    end
    ...
    StartRecv = function (this)
      local size = this.recvBuffer.ChunkSize - this.recvBuffer.LastIndex
      RecvAsync(this, this.recvBuffer:getLast(), this.recvBuffer.LastIndex, size)
    end
    ...
    OnRecvComplete = function (this, o)
      ...
      this.recvBuffer.LastIndex = this.recvBuffer.LastIndex + e:getBytesTransferred()
      if this.recvBuffer.LastIndex == this.recvBuffer.ChunkSize then
    ...
    StartSend = function (this)
      ...
      local sendSize = this.sendBuffer.ChunkSize - this.sendBuffer.FirstIndex
      if sendSize > this.sendBuffer:getLength() then
        sendSize = System.toInt32(this.sendBuffer:getLength())
      end

      SendAsync(this, this.sendBuffer:getFirst(), this.sendBuffer.FirstIndex, sendSize)
    end
    ...
    OnSendComplete = function (this, o)
      ...
      this.sendBuffer.FirstIndex = this.sendBuffer.FirstIndex + e:getBytesTransferred()
      if this.sendBuffer.FirstIndex == this.sendBuffer.ChunkSize then
