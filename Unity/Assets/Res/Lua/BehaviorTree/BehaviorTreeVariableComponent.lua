...
local System = System
local DCET = DCET
local DictStringEntity = System.Dictionary(System.String, DCET.Entity)
...
System.namespace("DCET", function (namespace)
  ...
  namespace.class("BehaviorTreeVariableComponent", function (namespace)
    ...
    GetVariable = function (this, name, T)
      ...
      return System.cast(DCET.VariableComponent_1(T), variables:get(name))
    end
    SetVariable = function (this, name, value, T)
      ...
      local result = System.cast(DCET.VariableComponent_1(T), variables:get(name))
      result.Value = value
