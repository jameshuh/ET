          ...
          if bts ~= nil then
            for _, bt in System.each(bts) do
              if UnityEngine.op_Implicit(bt) then
                (System.as(DCETModel.GameObjectHelper.Ensure(bt:getgameObject(), System.typeof(BehaviorDesignerRuntime.BehaviorTreeController)), BehaviorDesignerRuntime.BehaviorTreeController)):Init()
              end
            end
          end
        end
