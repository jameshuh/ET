...
namespace DCET {
  ...
  public partial class G2C_PlayerInfo : pb::IMessage {
    ...
    private global::DCET.PlayerInfo playerInfo_;
    public global::DCET.PlayerInfo PlayerInfo {
    ...
    private static readonly pb::FieldCodec<global::DCET.PlayerInfo> _repeated_playerInfos_codec
        = pb::FieldCodec.ForMessage(18, global::DCET.PlayerInfo.Parser);
    private pbc::RepeatedField<global::DCET.PlayerInfo> playerInfos_ = new pbc::RepeatedField<global::DCET.PlayerInfo>();
    public pbc::RepeatedField<global::DCET.PlayerInfo> PlayerInfos {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (playerInfo_ == null) {
              playerInfo_ = new global::DCET.PlayerInfo();
            }
