...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_LazyBsonDocumentWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonDocument>), typeof(System.Object), "SerializerBase_MongoDB_Bson_LazyBsonDocument");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonDocument> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonDocument>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonDocument>>(L, 1);
			...
			MongoDB.Bson.LazyBsonDocument o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.LazyBsonDocument arg2 = (MongoDB.Bson.LazyBsonDocument)ToLua.CheckObject<MongoDB.Bson.LazyBsonDocument>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonDocument> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonDocument>)o;
