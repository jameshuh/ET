...
public class FairyGUI_GComboBoxWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("gettitle", get_title);
		L.RegFunction("settitle", set_title);
		L.RegVar("text", get_text, set_text);
		L.RegFunction("gettext", get_text);
		L.RegFunction("settext", set_text);
		L.RegVar("titleColor", get_titleColor, set_titleColor);
		L.RegFunction("gettitleColor", get_titleColor);
		L.RegFunction("settitleColor", set_titleColor);
		L.RegVar("titleFontSize", get_titleFontSize, set_titleFontSize);
		L.RegFunction("gettitleFontSize", get_titleFontSize);
		L.RegFunction("settitleFontSize", set_titleFontSize);
		L.RegVar("items", get_items, set_items);
		L.RegFunction("getitems", get_items);
		L.RegFunction("setitems", set_items);
		L.RegVar("icons", get_icons, set_icons);
		L.RegFunction("geticons", get_icons);
		L.RegFunction("seticons", set_icons);
		L.RegVar("values", get_values, set_values);
		L.RegFunction("getvalues", get_values);
		L.RegFunction("setvalues", set_values);
		...
		L.RegFunction("getpopupDirection", get_popupDirection);
		L.RegFunction("setpopupDirection", set_popupDirection);
		L.EndClass();
	}
	...
	static int set_popupDirection(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GComboBox obj = (FairyGUI.GComboBox)o;
			FairyGUI.PopupDirection arg0 = (FairyGUI.PopupDirection)LuaDLL.luaL_checknumber(L, 2);
