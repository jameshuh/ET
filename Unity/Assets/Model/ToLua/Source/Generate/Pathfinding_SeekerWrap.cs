...
public class Pathfinding_SeekerWrap
{
	...
	static int RunModifiers(IntPtr L)
	{
		try
		{
			...
			Pathfinding.Seeker obj = (Pathfinding.Seeker)ToLua.CheckObject<Pathfinding.Seeker>(L, 1);
			Pathfinding.Seeker.ModifierPass arg0 = (Pathfinding.Seeker.ModifierPass)LuaDLL.luaL_checknumber(L, 2);
			PF.Path arg1 = (PF.Path)ToLua.CheckObject<PF.Path>(L, 3);
	...
	static int StartPath(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.Vector3, UnityEngine.Vector3>(L, 2))
			{
				...
				PF.Path o = obj.StartPath(arg0, arg1);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 3 && TypeChecker.CheckTypes<PF.Path, PF.OnPathDelegate>(L, 2))
			{
				Pathfinding.Seeker obj = (Pathfinding.Seeker)ToLua.CheckObject<Pathfinding.Seeker>(L, 1);
				PF.Path arg0 = (PF.Path)ToLua.ToObject(L, 2);
				PF.OnPathDelegate arg1 = (PF.OnPathDelegate)ToLua.ToObject(L, 3);
				PF.Path o = obj.StartPath(arg0, arg1);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 4 && TypeChecker.CheckTypes<PF.Path, PF.OnPathDelegate, int>(L, 2))
			{
				Pathfinding.Seeker obj = (Pathfinding.Seeker)ToLua.CheckObject<Pathfinding.Seeker>(L, 1);
				PF.Path arg0 = (PF.Path)ToLua.ToObject(L, 2);
				PF.OnPathDelegate arg1 = (PF.OnPathDelegate)ToLua.ToObject(L, 3);
				int arg2 = (int)LuaDLL.lua_tonumber(L, 4);
				PF.Path o = obj.StartPath(arg0, arg1, arg2);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 4 && TypeChecker.CheckTypes<UnityEngine.Vector3, UnityEngine.Vector3, PF.OnPathDelegate>(L, 2))
			{
				Pathfinding.Seeker obj = (Pathfinding.Seeker)ToLua.CheckObject<Pathfinding.Seeker>(L, 1);
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
				PF.OnPathDelegate arg2 = (PF.OnPathDelegate)ToLua.ToObject(L, 4);
				PF.Path o = obj.StartPath(arg0, arg1, arg2);
				ToLua.PushObject(L, o);
				return 1;
			}
			else if (count == 5)
			{
				...
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Vector3 arg1 = ToLua.ToVector3(L, 3);
				PF.OnPathDelegate arg2 = (PF.OnPathDelegate)ToLua.CheckDelegate<PF.OnPathDelegate>(L, 4);
				int arg3 = (int)LuaDLL.luaL_checknumber(L, 5);
				PF.Path o = obj.StartPath(arg0, arg1, arg2, arg3);
				ToLua.PushObject(L, o);
				return 1;
			}
			else
	...
	static int get_pathCallback(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Pathfinding.Seeker obj = (Pathfinding.Seeker)o;
			PF.OnPathDelegate ret = obj.pathCallback;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_preProcessPath(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Pathfinding.Seeker obj = (Pathfinding.Seeker)o;
			PF.OnPathDelegate ret = obj.preProcessPath;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_postProcessPath(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			Pathfinding.Seeker obj = (Pathfinding.Seeker)o;
			PF.OnPathDelegate ret = obj.postProcessPath;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
