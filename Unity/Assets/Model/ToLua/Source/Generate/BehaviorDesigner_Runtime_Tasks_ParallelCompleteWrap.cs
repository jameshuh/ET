...
public class BehaviorDesigner_Runtime_Tasks_ParallelCompleteWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(BehaviorDesigner.Runtime.Tasks.ParallelComplete), typeof(BehaviorDesigner.Runtime.Tasks.Composite));
		...
		L.RegFunction("New", _CreateBehaviorDesigner_Runtime_Tasks_ParallelComplete);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateBehaviorDesigner_Runtime_Tasks_ParallelComplete(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				BehaviorDesigner.Runtime.Tasks.ParallelComplete obj = new BehaviorDesigner.Runtime.Tasks.ParallelComplete();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: BehaviorDesigner.Runtime.Tasks.ParallelComplete.New");
			}
		}
		catch (Exception e)
		{
	...
	static int OnAwake(IntPtr L)
	{
		try
		{
			...
			BehaviorDesigner.Runtime.Tasks.ParallelComplete obj = (BehaviorDesigner.Runtime.Tasks.ParallelComplete)ToLua.CheckObject<BehaviorDesigner.Runtime.Tasks.ParallelComplete>(L, 1);
			obj.OnAwake();
			return 0;
		}
		catch (Exception e)
	...
	static int OnChildStarted(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: BehaviorDesigner.Runtime.Tasks.ParallelComplete.OnChildStarted");
			}
		}
		catch (Exception e)
		{
	...
	static int OnChildExecuted(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: BehaviorDesigner.Runtime.Tasks.ParallelComplete.OnChildExecuted");
			}
		}
		catch (Exception e)
		{
	...
	static int OnConditionalAbort(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: BehaviorDesigner.Runtime.Tasks.ParallelComplete.OnConditionalAbort");
			}
		}
		catch (Exception e)
		{
	...
	static int OverrideStatus(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: BehaviorDesigner.Runtime.Tasks.ParallelComplete.OverrideStatus");
			}
		}
		catch (Exception e)
		{
