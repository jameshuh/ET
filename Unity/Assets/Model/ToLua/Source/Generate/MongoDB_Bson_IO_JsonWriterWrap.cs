...
public class MongoDB_Bson_IO_JsonWriterWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.IO.JsonWriter), typeof(MongoDB.Bson.IO.BsonWriter));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_IO_JsonWriter);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.RegVar("BaseTextWriter", get_BaseTextWriter, null);
		L.RegFunction("getBaseTextWriter", get_BaseTextWriter);
	...
	static int _CreateMongoDB_Bson_IO_JsonWriter(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				MongoDB.Bson.IO.JsonWriter obj = new MongoDB.Bson.IO.JsonWriter(arg0);
			...
			else if (count == 2)
			{
				...
				MongoDB.Bson.IO.JsonWriter obj = new MongoDB.Bson.IO.JsonWriter(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.IO.JsonWriter.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.IO.JsonWriter obj = (MongoDB.Bson.IO.JsonWriter)ToLua.CheckObject<MongoDB.Bson.IO.JsonWriter>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_BaseTextWriter(IntPtr L)
	{
		object o = null;
		...
		try
		{
			...
			MongoDB.Bson.IO.JsonWriter obj = (MongoDB.Bson.IO.JsonWriter)o;
			System.IO.TextWriter ret = obj.BaseTextWriter;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index BaseTextWriter on a nil value");
		}
	}
	...
	static int get_Settings(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			MongoDB.Bson.IO.JsonWriter obj = (MongoDB.Bson.IO.JsonWriter)o;
			MongoDB.Bson.IO.JsonWriterSettings ret = obj.Settings;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
