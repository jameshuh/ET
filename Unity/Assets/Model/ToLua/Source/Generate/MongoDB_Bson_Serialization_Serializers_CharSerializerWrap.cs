...
public class MongoDB_Bson_Serialization_Serializers_CharSerializerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.CharSerializer), typeof(MongoDB.Bson.Serialization.Serializers.StructSerializerBase<char>));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_Serialization_Serializers_CharSerializer);
	...
	static int _CreateMongoDB_Bson_Serialization_Serializers_CharSerializer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				MongoDB.Bson.Serialization.Serializers.CharSerializer obj = new MongoDB.Bson.Serialization.Serializers.CharSerializer();
			...
			else if (count == 1)
			{
				...
				MongoDB.Bson.Serialization.Serializers.CharSerializer obj = new MongoDB.Bson.Serialization.Serializers.CharSerializer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.Serialization.Serializers.CharSerializer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.CharSerializer obj = (MongoDB.Bson.Serialization.Serializers.CharSerializer)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.CharSerializer>(L, 1);
			...
			char o = obj.Deserialize(arg0, arg1);
	...
	static int WithRepresentation(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.CharSerializer o = obj.WithRepresentation(arg0);
	...
	static int get_Representation(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.CharSerializer obj = (MongoDB.Bson.Serialization.Serializers.CharSerializer)o;
