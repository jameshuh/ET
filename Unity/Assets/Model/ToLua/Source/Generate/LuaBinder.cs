...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule("DCET");
		L.BeginModule("Model");
		DCET_Model_BundleDownloaderWrap.Register(L);
		DCET_Model_GlobalConfigComponentWrap.Register(L);
		DCET_Model_GlobalProtoWrap.Register(L);
		DCET_Model_KcpWrap.Register(L);
		DCET_Model_AppTypeWrap.Register(L);
		DCET_Model_AppTypeHelperWrap.Register(L);
		DCET_Model_ComponentViewWrap.Register(L);
		DCET_Model_DefineWrap.Register(L);
		DCET_Model_GameLoopWrap.Register(L);
		DCET_Model_IStaticMethodWrap.Register(L);
		DCET_Model_MonoStaticMethodWrap.Register(L);
		DCET_Model_OneThreadSynchronizationContextWrap.Register(L);
		...
		DCET_Model_JsonHelperWrap.Register(L);
		DCET_Model_MD5HelperWrap.Register(L);
		DCET_Model_MongoHelperWrap.Register(L);
		DCET_Model_NetworkHelperWrap.Register(L);
		DCET_Model_PathHelperWrap.Register(L);
		DCET_Model_ProcessHelperWrap.Register(L);
		DCET_Model_ResourcesHelperWrap.Register(L);
		DCET_Model_StringHelperWrap.Register(L);
		DCET_Model_ZipHelperWrap.Register(L);
		DCET_Model_AssetBundleLoaderAsyncWrap.Register(L);
		DCET_Model_AssetBundlesWrap.Register(L);
		DCET_Model_AssetLoaderAsyncWrap.Register(L);
		DCET_Model_CameraDepthTextureWrap.Register(L);
		DCET_Model_GizmosDebugWrap.Register(L);
		DCET_Model_LogWrap.Register(L);
		DCET_Model_LogTypeWrap.Register(L);
		DCET_Model_PrefabLightmapDataWrap.Register(L);
		DCET_Model_ReferenceLoaderWrap.Register(L);
		DCET_Model_AcceptAllCertificateWrap.Register(L);
		DCET_Model_UnityWebRequestAsyncWrap.Register(L);
		L.RegFunction("KcpOutput", DCET_Model_KcpOutput);
		L.BeginModule("PrefabLightmapData");
		DCET_Model_PrefabLightmapData_MeshRendererLightmapDataWrap.Register(L);
		DCET_Model_PrefabLightmapData_TerrainLightmapDataWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
		...
		Google_Protobuf_ByteStringWrap.Register(L);
		Google_Protobuf_CodedInputStreamWrap.Register(L);
		Google_Protobuf_CodedOutputStreamWrap.Register(L);
		Google_Protobuf_FieldCodecWrap.Register(L);
		Google_Protobuf_InvalidProtocolBufferExceptionWrap.Register(L);
		Google_Protobuf_MessageExtensionsWrap.Register(L);
		Google_Protobuf_MessageParserWrap.Register(L);
		Google_Protobuf_ProtoPreconditionsWrap.Register(L);
		Google_Protobuf_WireFormatWrap.Register(L);
		L.BeginModule("Compatibility");
		Google_Protobuf_Compatibility_StreamExtensionsWrap.Register(L);
		L.EndModule();
		L.BeginModule("ByteString");
		Google_Protobuf_ByteString_UnsafeWrap.Register(L);
		L.EndModule();
		L.BeginModule("CodedOutputStream");
		Google_Protobuf_CodedOutputStream_OutOfSpaceExceptionWrap.Register(L);
		L.EndModule();
		L.BeginModule("WireFormat");
		Google_Protobuf_WireFormat_WireTypeWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
		...
		L.EndModule();
		L.EndModule();
		L.BeginModule("ETModel");
		ETModel_MonoBehaviourBridgeWrap.Register(L);
		L.EndModule();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DCET_Model_KcpOutput(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<DCET.Model.KcpOutput>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<DCET.Model.KcpOutput>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
