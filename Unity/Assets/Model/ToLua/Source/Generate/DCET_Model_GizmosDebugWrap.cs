...
public class DCET_Model_GizmosDebugWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCET.Model.GizmosDebug), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_Path(IntPtr L)
	{
		...
		try
		{
			...
			DCET.Model.GizmosDebug obj = (DCET.Model.GizmosDebug)o;
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.Push(L, DCET.Model.GizmosDebug.Instance);
			return 1;
		}
		catch (Exception e)
		{
