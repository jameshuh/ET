...
public class FairyGUI_WindowWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getbringToFontOnClick", get_bringToFontOnClick);
		L.RegFunction("setbringToFontOnClick", set_bringToFontOnClick);
		L.RegVar("contentPane", get_contentPane, set_contentPane);
		L.RegFunction("getcontentPane", get_contentPane);
		L.RegFunction("setcontentPane", set_contentPane);
		L.RegVar("frame", get_frame, null);
		L.RegFunction("getframe", get_frame);
		L.RegVar("closeButton", get_closeButton, set_closeButton);
		L.RegFunction("getcloseButton", get_closeButton);
		L.RegFunction("setcloseButton", set_closeButton);
		L.RegVar("dragArea", get_dragArea, set_dragArea);
		L.RegFunction("getdragArea", get_dragArea);
		L.RegFunction("setdragArea", set_dragArea);
		L.RegVar("contentArea", get_contentArea, set_contentArea);
		L.RegFunction("getcontentArea", get_contentArea);
		L.RegFunction("setcontentArea", set_contentArea);
		L.RegVar("modalWaitingPane", get_modalWaitingPane, null);
		L.RegFunction("getmodalWaitingPane", get_modalWaitingPane);
		L.RegVar("isShowing", get_isShowing, null);
		L.RegFunction("getisShowing", get_isShowing);
		L.RegVar("isTop", get_isTop, null);
		L.RegFunction("getisTop", get_isTop);
		L.RegVar("modal", get_modal, set_modal);
		L.RegFunction("getmodal", get_modal);
		L.RegFunction("setmodal", set_modal);
		L.RegVar("modalWaiting", get_modalWaiting, null);
		L.RegFunction("getmodalWaiting", get_modalWaiting);
		L.EndClass();
	}
