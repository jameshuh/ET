...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_BsonRegularExpressionWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonRegularExpression>), typeof(System.Object), "SerializerBase_MongoDB_Bson_BsonRegularExpression");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonRegularExpression> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonRegularExpression>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonRegularExpression>>(L, 1);
			...
			MongoDB.Bson.BsonRegularExpression o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.BsonRegularExpression arg2 = (MongoDB.Bson.BsonRegularExpression)ToLua.CheckObject<MongoDB.Bson.BsonRegularExpression>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonRegularExpression> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonRegularExpression>)o;
