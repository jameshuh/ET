...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_System_TimeSpanWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<System.TimeSpan>), typeof(System.Object), "SerializerBase_System_TimeSpan");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.TimeSpan> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.TimeSpan>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<System.TimeSpan>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.TimeSpan> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.TimeSpan>)o;
