...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_uintWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<uint>), typeof(System.Object), "SerializerBase_uint");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<uint> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<uint>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<uint>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<uint> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<uint>)o;
