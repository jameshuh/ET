...
public class MongoDB_Bson_BsonStringWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.BsonString), typeof(MongoDB.Bson.BsonValue));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_BsonString);
	...
	static int _CreateMongoDB_Bson_BsonString(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				MongoDB.Bson.BsonString obj = new MongoDB.Bson.BsonString(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.BsonString.New");
			}
		}
		catch (Exception e)
		{
	...
	static int op_Equality(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.BsonString arg0 = (MongoDB.Bson.BsonString)ToLua.ToObject(L, 1);
			MongoDB.Bson.BsonString arg1 = (MongoDB.Bson.BsonString)ToLua.ToObject(L, 2);
			bool o = arg0 == arg1;
	...
	static int Create(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.BsonString o = MongoDB.Bson.BsonString.Create(arg0);
	...
	static int CompareTo(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<MongoDB.Bson.BsonString>(L, 2))
			{
				MongoDB.Bson.BsonString obj = (MongoDB.Bson.BsonString)ToLua.CheckObject<MongoDB.Bson.BsonString>(L, 1);
				MongoDB.Bson.BsonString arg0 = (MongoDB.Bson.BsonString)ToLua.ToObject(L, 2);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: MongoDB.Bson.BsonString.CompareTo");
			}
		}
		catch (Exception e)
		{
	...
	static int Equals(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: MongoDB.Bson.BsonString.Equals");
			}
		}
		catch (Exception e)
		{
	...
	static int get_Empty(IntPtr L)
	{
		try
		{
			ToLua.PushObject(L, MongoDB.Bson.BsonString.Empty);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_BsonType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.BsonString obj = (MongoDB.Bson.BsonString)o;
