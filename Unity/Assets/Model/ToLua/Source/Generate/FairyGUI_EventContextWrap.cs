...
public class FairyGUI_EventContextWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getsender", get_sender);
		L.RegVar("initiator", get_initiator, null);
		L.RegFunction("getinitiator", get_initiator);
		L.RegVar("inputEvent", get_inputEvent, null);
		L.RegFunction("getinputEvent", get_inputEvent);
		L.RegVar("isDefaultPrevented", get_isDefaultPrevented, null);
		L.RegFunction("getisDefaultPrevented", get_isDefaultPrevented);
		L.EndClass();
	}
