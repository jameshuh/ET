...
public class DCET_Model_FileHelperWrap
{
	...
	static int GetAllFiles(IntPtr L)
	{
		try
		{
			...
			DCET.Model.FileHelper.GetAllFiles(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int CleanDirectory(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				DCET.Model.FileHelper.CleanDirectory(arg0);
				return 0;
			}
			else if (count == 2)
			{
				string arg0 = ToLua.CheckString(L, 1);
				string arg1 = ToLua.CheckString(L, 2);
				DCET.Model.FileHelper.CleanDirectory(arg0, arg1);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DCET.Model.FileHelper.CleanDirectory");
			}
		}
		catch (Exception e)
		{
	...
	static int CopyFile(IntPtr L)
	{
		try
		{
			...
			bool o = DCET.Model.FileHelper.CopyFile(arg0, arg1, arg2);
	...
	static int CopyDirectory(IntPtr L)
	{
		try
		{
			...
			string arg0 = ToLua.CheckString(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			DCET.Model.FileHelper.CopyDirectory(arg0, arg1);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int ReplaceExtensionName(IntPtr L)
	{
		try
		{
			...
			DCET.Model.FileHelper.ReplaceExtensionName(arg0, arg1, arg2);
			return 0;
		}
		catch (Exception e)
		{
