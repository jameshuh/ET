...
public class FairyGUI_ImageWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getscale9Grid", get_scale9Grid);
		L.RegFunction("setscale9Grid", set_scale9Grid);
		L.RegVar("scaleByTile", get_scaleByTile, set_scaleByTile);
		L.RegFunction("getscaleByTile", get_scaleByTile);
		L.RegFunction("setscaleByTile", set_scaleByTile);
		L.RegVar("tileGridIndice", get_tileGridIndice, set_tileGridIndice);
		L.RegFunction("gettileGridIndice", get_tileGridIndice);
		L.RegFunction("settileGridIndice", set_tileGridIndice);
		L.EndClass();
	}
