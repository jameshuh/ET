...
public class MongoDB_Bson_Serialization_Serializers_GuidSerializerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.GuidSerializer), typeof(MongoDB.Bson.Serialization.Serializers.StructSerializerBase<System.Guid>));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_Serialization_Serializers_GuidSerializer);
	...
	static int _CreateMongoDB_Bson_Serialization_Serializers_GuidSerializer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				MongoDB.Bson.Serialization.Serializers.GuidSerializer obj = new MongoDB.Bson.Serialization.Serializers.GuidSerializer();
			...
			else if (count == 1)
			{
				...
				MongoDB.Bson.Serialization.Serializers.GuidSerializer obj = new MongoDB.Bson.Serialization.Serializers.GuidSerializer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.Serialization.Serializers.GuidSerializer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.GuidSerializer obj = (MongoDB.Bson.Serialization.Serializers.GuidSerializer)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.GuidSerializer>(L, 1);
	...
	static int WithRepresentation(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.GuidSerializer o = obj.WithRepresentation(arg0);
	...
	static int get_Representation(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.GuidSerializer obj = (MongoDB.Bson.Serialization.Serializers.GuidSerializer)o;
