...
public class BehaviorDesigner_Runtime_Tasks_TaskWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("setGameObject", set_GameObject);
		L.RegVar("Transform", null, set_Transform);
		L.RegFunction("setTransform", set_Transform);
		L.RegVar("NodeData", get_NodeData, set_NodeData);
		L.RegFunction("getNodeData", get_NodeData);
		L.RegFunction("setNodeData", set_NodeData);
		L.RegVar("Owner", get_Owner, set_Owner);
		L.RegFunction("getOwner", get_Owner);
		L.RegFunction("setOwner", set_Owner);
		L.RegVar("ID", get_ID, set_ID);
		L.RegFunction("getID", get_ID);
		L.RegFunction("setID", set_ID);
		L.RegVar("FriendlyName", get_FriendlyName, set_FriendlyName);
		L.RegFunction("getFriendlyName", get_FriendlyName);
		L.RegFunction("setFriendlyName", set_FriendlyName);
		L.RegVar("IsInstant", get_IsInstant, set_IsInstant);
		L.RegFunction("getIsInstant", get_IsInstant);
		L.RegFunction("setIsInstant", set_IsInstant);
		L.RegVar("ReferenceID", get_ReferenceID, set_ReferenceID);
		L.RegFunction("getReferenceID", get_ReferenceID);
		L.RegFunction("setReferenceID", set_ReferenceID);
		L.RegVar("Disabled", get_Disabled, set_Disabled);
		L.RegFunction("getDisabled", get_Disabled);
		L.RegFunction("setDisabled", set_Disabled);
		L.EndClass();
	}
