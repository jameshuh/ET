...
public class MongoDB_Bson_Serialization_Serializers_BsonValueSerializerBase_MongoDB_Bson_BsonDocumentWrapperWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonDocumentWrapper>), typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDocumentWrapper>), "BsonValueSerializerBase_MongoDB_Bson_BsonDocumentWrapper");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonDocumentWrapper> obj = (MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonDocumentWrapper>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonDocumentWrapper>>(L, 1);
