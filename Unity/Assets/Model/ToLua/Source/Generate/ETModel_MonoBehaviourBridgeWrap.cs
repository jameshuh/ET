...
public class ETModel_MonoBehaviourBridgeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(ETModel.MonoBehaviourBridge), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_onAwake(IntPtr L)
	{
		...
		try
		{
			...
			ETModel.MonoBehaviourBridge obj = (ETModel.MonoBehaviourBridge)o;
