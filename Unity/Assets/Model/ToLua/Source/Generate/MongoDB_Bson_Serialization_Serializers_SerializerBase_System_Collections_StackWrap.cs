...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_System_Collections_StackWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Stack>), typeof(System.Object), "SerializerBase_System_Collections_Stack");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Stack> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Stack>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Stack>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Stack> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Collections.Stack>)o;
