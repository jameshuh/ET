...
public class FairyGUI_Utils_HtmlLinkWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(FairyGUI.Utils.HtmlLink), typeof(System.Object));
		...
		L.RegFunction("New", _CreateFairyGUI_Utils_HtmlLink);
	...
	static int _CreateFairyGUI_Utils_HtmlLink(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				FairyGUI.Utils.HtmlLink obj = new FairyGUI.Utils.HtmlLink();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: FairyGUI.Utils.HtmlLink.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Create(IntPtr L)
	{
		try
		{
			...
			FairyGUI.Utils.HtmlLink obj = (FairyGUI.Utils.HtmlLink)ToLua.CheckObject<FairyGUI.Utils.HtmlLink>(L, 1);
	...
	static int get_displayObject(IntPtr L)
	{
		...
		try
		{
			...
			FairyGUI.Utils.HtmlLink obj = (FairyGUI.Utils.HtmlLink)o;
