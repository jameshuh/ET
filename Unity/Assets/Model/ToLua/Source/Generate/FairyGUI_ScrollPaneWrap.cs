...
public class FairyGUI_ScrollPaneWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getdraggingPane", get_draggingPane);
		L.RegVar("onScroll", get_onScroll, null);
		L.RegFunction("getonScroll", get_onScroll);
		L.RegVar("onScrollEnd", get_onScrollEnd, null);
		L.RegFunction("getonScrollEnd", get_onScrollEnd);
		L.RegVar("onPullDownRelease", get_onPullDownRelease, null);
		L.RegFunction("getonPullDownRelease", get_onPullDownRelease);
		L.RegVar("onPullUpRelease", get_onPullUpRelease, null);
		L.RegFunction("getonPullUpRelease", get_onPullUpRelease);
		L.RegVar("owner", get_owner, null);
		L.RegFunction("getowner", get_owner);
		L.RegVar("hzScrollBar", get_hzScrollBar, null);
		L.RegFunction("gethzScrollBar", get_hzScrollBar);
		L.RegVar("vtScrollBar", get_vtScrollBar, null);
		L.RegFunction("getvtScrollBar", get_vtScrollBar);
		L.RegVar("header", get_header, null);
		L.RegFunction("getheader", get_header);
		L.RegVar("footer", get_footer, null);
		L.RegFunction("getfooter", get_footer);
		L.RegVar("bouncebackEffect", get_bouncebackEffect, set_bouncebackEffect);
		L.RegFunction("getbouncebackEffect", get_bouncebackEffect);
		L.RegFunction("setbouncebackEffect", set_bouncebackEffect);
		L.RegVar("touchEffect", get_touchEffect, set_touchEffect);
		L.RegFunction("gettouchEffect", get_touchEffect);
		L.RegFunction("settouchEffect", set_touchEffect);
		L.RegVar("inertiaDisabled", get_inertiaDisabled, set_inertiaDisabled);
		L.RegFunction("getinertiaDisabled", get_inertiaDisabled);
		L.RegFunction("setinertiaDisabled", set_inertiaDisabled);
		L.RegVar("softnessOnTopOrLeftSide", get_softnessOnTopOrLeftSide, set_softnessOnTopOrLeftSide);
		L.RegFunction("getsoftnessOnTopOrLeftSide", get_softnessOnTopOrLeftSide);
		L.RegFunction("setsoftnessOnTopOrLeftSide", set_softnessOnTopOrLeftSide);
		L.RegVar("scrollStep", get_scrollStep, set_scrollStep);
		L.RegFunction("getscrollStep", get_scrollStep);
		L.RegFunction("setscrollStep", set_scrollStep);
		L.RegVar("snapToItem", get_snapToItem, set_snapToItem);
		L.RegFunction("getsnapToItem", get_snapToItem);
		L.RegFunction("setsnapToItem", set_snapToItem);
		L.RegVar("pageMode", get_pageMode, set_pageMode);
		L.RegFunction("getpageMode", get_pageMode);
		L.RegFunction("setpageMode", set_pageMode);
		L.RegVar("pageController", get_pageController, set_pageController);
		L.RegFunction("getpageController", get_pageController);
		L.RegFunction("setpageController", set_pageController);
		L.RegVar("mouseWheelEnabled", get_mouseWheelEnabled, set_mouseWheelEnabled);
		L.RegFunction("getmouseWheelEnabled", get_mouseWheelEnabled);
		L.RegFunction("setmouseWheelEnabled", set_mouseWheelEnabled);
		L.RegVar("decelerationRate", get_decelerationRate, set_decelerationRate);
		L.RegFunction("getdecelerationRate", get_decelerationRate);
		L.RegFunction("setdecelerationRate", set_decelerationRate);
		L.RegVar("percX", get_percX, set_percX);
		L.RegFunction("getpercX", get_percX);
		L.RegFunction("setpercX", set_percX);
		L.RegVar("percY", get_percY, set_percY);
		L.RegFunction("getpercY", get_percY);
		L.RegFunction("setpercY", set_percY);
		L.RegVar("posX", get_posX, set_posX);
		L.RegFunction("getposX", get_posX);
		L.RegFunction("setposX", set_posX);
		L.RegVar("posY", get_posY, set_posY);
		L.RegFunction("getposY", get_posY);
		L.RegFunction("setposY", set_posY);
		L.RegVar("isBottomMost", get_isBottomMost, null);
		L.RegFunction("getisBottomMost", get_isBottomMost);
		L.RegVar("isRightMost", get_isRightMost, null);
		L.RegFunction("getisRightMost", get_isRightMost);
		L.RegVar("currentPageX", get_currentPageX, set_currentPageX);
		L.RegFunction("getcurrentPageX", get_currentPageX);
		L.RegFunction("setcurrentPageX", set_currentPageX);
		L.RegVar("currentPageY", get_currentPageY, set_currentPageY);
		L.RegFunction("getcurrentPageY", get_currentPageY);
		L.RegFunction("setcurrentPageY", set_currentPageY);
		L.RegVar("scrollingPosX", get_scrollingPosX, null);
		L.RegFunction("getscrollingPosX", get_scrollingPosX);
		L.RegVar("scrollingPosY", get_scrollingPosY, null);
		L.RegFunction("getscrollingPosY", get_scrollingPosY);
		L.RegVar("contentWidth", get_contentWidth, null);
		L.RegFunction("getcontentWidth", get_contentWidth);
		L.RegVar("contentHeight", get_contentHeight, null);
		L.RegFunction("getcontentHeight", get_contentHeight);
		L.RegVar("viewWidth", get_viewWidth, set_viewWidth);
		L.RegFunction("getviewWidth", get_viewWidth);
		L.RegFunction("setviewWidth", set_viewWidth);
		L.RegVar("viewHeight", get_viewHeight, set_viewHeight);
		L.RegFunction("getviewHeight", get_viewHeight);
		L.RegFunction("setviewHeight", set_viewHeight);
		L.EndClass();
	}
