...
public class DCET_Model_DefineWrap
{
	...
	static int get_IsAsync(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, DCET.Model.Define.IsAsync);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_IsEditorMode(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, DCET.Model.Define.IsEditorMode);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_IsDevelopmentBuild(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, DCET.Model.Define.IsDevelopmentBuild);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_IsLua(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, DCET.Model.Define.IsLua);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_IsAsync(IntPtr L)
	{
		try
		{
			...
			DCET.Model.Define.IsAsync = arg0;
			return 0;
		}
		catch (Exception e)
		{
	...
	static int set_IsEditorMode(IntPtr L)
	{
		...
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			DCET.Model.Define.IsEditorMode = arg0;
			return 0;
		}
		catch (Exception e)
		{
	...
	static int set_IsDevelopmentBuild(IntPtr L)
	{
		...
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			DCET.Model.Define.IsDevelopmentBuild = arg0;
			return 0;
		}
		catch (Exception e)
		{
