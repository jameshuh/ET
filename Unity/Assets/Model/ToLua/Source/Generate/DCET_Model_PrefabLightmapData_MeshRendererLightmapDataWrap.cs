...
public class DCET_Model_PrefabLightmapData_MeshRendererLightmapDataWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCET.Model.PrefabLightmapData.MeshRendererLightmapData), null);
		L.RegFunction("New", _CreateDCET_Model_PrefabLightmapData_MeshRendererLightmapData);
	...
	static int _CreateDCET_Model_PrefabLightmapData_MeshRendererLightmapData(IntPtr L)
	{
		DCET.Model.PrefabLightmapData.MeshRendererLightmapData obj = new DCET.Model.PrefabLightmapData.MeshRendererLightmapData();
	...
	static int get_renderer(IntPtr L)
	{
		...
		try
		{
			...
			DCET.Model.PrefabLightmapData.MeshRendererLightmapData obj = (DCET.Model.PrefabLightmapData.MeshRendererLightmapData)o;
	...
	static int __default__(IntPtr L)
	{
		try
		{
			var o = new DCET.Model.PrefabLightmapData.MeshRendererLightmapData();
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int __clone__(IntPtr L)
	{
		try
		{
			...
			var obj = (DCET.Model.PrefabLightmapData.MeshRendererLightmapData)ToLua.CheckObject(L, 1, typeof(DCET.Model.PrefabLightmapData.MeshRendererLightmapData));
			var o = obj;
			ToLua.PushValue(L, o);
			ToLua.SetBack(L, 1, obj);
			return 1;
