...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(DCET.Model.KcpOutput), factory.DCET_Model_KcpOutput);
		...
		DelegateTraits<DCET.Model.KcpOutput>.Init(factory.DCET_Model_KcpOutput);
		...
		TypeTraits<DCET.Model.KcpOutput>.Init(factory.Check_DCET_Model_KcpOutput);
		...
		StackTraits<DCET.Model.KcpOutput>.Push = factory.Push_DCET_Model_KcpOutput;
	...
	class DCET_Model_KcpOutput_Event : LuaDelegate
	{
		public DCET_Model_KcpOutput_Event(LuaFunction func) : base(func) { }
		public DCET_Model_KcpOutput_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public DCET.Model.KcpOutput DCET_Model_KcpOutput(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			DCET.Model.KcpOutput fn = delegate(System.IntPtr param0, int param1, System.IntPtr param2, System.IntPtr param3) { return 0; };
			return fn;
		}

		if(!flag)
		{
			DCET_Model_KcpOutput_Event target = new DCET_Model_KcpOutput_Event(func);
			DCET.Model.KcpOutput d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			DCET_Model_KcpOutput_Event target = new DCET_Model_KcpOutput_Event(func, self);
			DCET.Model.KcpOutput d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_DCET_Model_KcpOutput(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(DCET.Model.KcpOutput), L, pos);
	}

	void Push_DCET_Model_KcpOutput(IntPtr L, DCET.Model.KcpOutput o)
	{
		ToLua.Push(L, o);
	}
