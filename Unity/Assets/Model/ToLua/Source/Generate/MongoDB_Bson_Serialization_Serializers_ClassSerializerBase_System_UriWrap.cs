...
public class MongoDB_Bson_Serialization_Serializers_ClassSerializerBase_System_UriWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.ClassSerializerBase<System.Uri>), typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Uri>), "ClassSerializerBase_System_Uri");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.ClassSerializerBase<System.Uri> obj = (MongoDB.Bson.Serialization.Serializers.ClassSerializerBase<System.Uri>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.ClassSerializerBase<System.Uri>>(L, 1);
