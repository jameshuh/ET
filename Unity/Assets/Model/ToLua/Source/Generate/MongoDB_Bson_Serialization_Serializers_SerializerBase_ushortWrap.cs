...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_ushortWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<ushort>), typeof(System.Object), "SerializerBase_ushort");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<ushort> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<ushort>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<ushort>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<ushort> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<ushort>)o;
