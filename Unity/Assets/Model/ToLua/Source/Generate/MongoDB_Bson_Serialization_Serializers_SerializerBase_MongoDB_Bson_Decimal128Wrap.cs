...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_Decimal128Wrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.Decimal128>), typeof(System.Object), "SerializerBase_MongoDB_Bson_Decimal128");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.Decimal128> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.Decimal128>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.Decimal128>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.Decimal128> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.Decimal128>)o;
