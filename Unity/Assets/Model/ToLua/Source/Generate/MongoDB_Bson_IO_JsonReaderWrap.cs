...
public class MongoDB_Bson_IO_JsonReaderWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.IO.JsonReader), typeof(MongoDB.Bson.IO.BsonReader));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_IO_JsonReader);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateMongoDB_Bson_IO_JsonReader(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes<string>(L, 1))
			{
				...
				MongoDB.Bson.IO.JsonReader obj = new MongoDB.Bson.IO.JsonReader(arg0);
			...
			else if (count == 2 && TypeChecker.CheckTypes<string, MongoDB.Bson.IO.JsonReaderSettings>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				MongoDB.Bson.IO.JsonReaderSettings arg1 = (MongoDB.Bson.IO.JsonReaderSettings)ToLua.ToObject(L, 2);
				MongoDB.Bson.IO.JsonReader obj = new MongoDB.Bson.IO.JsonReader(arg0, arg1);
				ToLua.PushObject(L, obj);
				return 1;
			}
			else if (count == 2 && TypeChecker.CheckTypes<System.IO.TextReader, MongoDB.Bson.IO.JsonReaderSettings>(L, 1))
			{
				System.IO.TextReader arg0 = (System.IO.TextReader)ToLua.ToObject(L, 1);
				MongoDB.Bson.IO.JsonReaderSettings arg1 = (MongoDB.Bson.IO.JsonReaderSettings)ToLua.ToObject(L, 2);
				MongoDB.Bson.IO.JsonReader obj = new MongoDB.Bson.IO.JsonReader(arg0, arg1);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.IO.JsonReader.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.IO.JsonReader obj = (MongoDB.Bson.IO.JsonReader)ToLua.CheckObject<MongoDB.Bson.IO.JsonReader>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
	...
	static int ReadName(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: MongoDB.Bson.IO.JsonReader.ReadName");
			}
		}
		catch (Exception e)
		{
