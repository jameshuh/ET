...
public class FairyGUI_StageWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getstageHeight", get_stageHeight);
		L.RegVar("stageWidth", get_stageWidth, null);
		L.RegFunction("getstageWidth", get_stageWidth);
		L.RegVar("soundVolume", get_soundVolume, set_soundVolume);
		L.RegFunction("getsoundVolume", get_soundVolume);
		L.RegFunction("setsoundVolume", set_soundVolume);
		L.RegVar("inst", get_inst, null);
		L.RegFunction("getinst", get_inst);
		L.RegVar("touchScreen", get_touchScreen, set_touchScreen);
		L.RegFunction("gettouchScreen", get_touchScreen);
		L.RegFunction("settouchScreen", set_touchScreenter);
		L.RegVar("keyboardInput", get_keyboardInput, set_keyboardInput);
		L.RegFunction("getkeyboardInput", get_keyboardInput);
		L.RegFunction("setkeyboardInput", set_keyboardInputter);
		L.RegVar("isTouchOnUI", get_isTouchOnUI, null);
		L.RegFunction("getisTouchOnUI", get_isTouchOnUI);
		L.RegVar("onStageResized", get_onStageResized, null);
		L.RegFunction("getonStageResized", get_onStageResized);
		L.RegVar("touchTarget", get_touchTarget, null);
		L.RegFunction("gettouchTarget", get_touchTarget);
		L.RegVar("focus", get_focus, set_focus);
		L.RegFunction("getfocus", get_focus);
		L.RegFunction("setfocus", set_focus);
		L.RegVar("touchPosition", get_touchPosition, null);
		L.RegFunction("gettouchPosition", get_touchPosition);
		...
		L.RegFunction("getkeyboard", get_keyboard);
		L.RegFunction("setkeyboard", set_keyboard);
		L.EndClass();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_touchScreenter(IntPtr L)
	{
		try
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_keyboardInputter(IntPtr L)
	{
		try
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 1);
