...
public class FairyGUI_GProgressBarWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("gettitleType", get_titleType);
		L.RegFunction("settitleType", set_titleType);
		L.RegVar("max", get_max, set_max);
		L.RegFunction("getmax", get_max);
		L.RegFunction("setmax", set_max);
		L.RegVar("value", get_value, set_value);
		L.RegFunction("getvalue", get_value);
		L.RegFunction("setvalue", set_value);
		L.RegVar("reverse", get_reverse, set_reverse);
		L.RegFunction("getreverse", get_reverse);
		L.RegFunction("setreverse", set_reverse);
		L.EndClass();
	}
	...
	static int set_titleType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GProgressBar obj = (FairyGUI.GProgressBar)o;
			FairyGUI.ProgressTitleType arg0 = (FairyGUI.ProgressTitleType)LuaDLL.luaL_checknumber(L, 2);
			obj.titleType = arg0;
			return 0;
		}
		catch(Exception e)
