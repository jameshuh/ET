...
public class MongoDB_Bson_IO_ByteArrayBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.IO.ByteArrayBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateMongoDB_Bson_IO_ByteArrayBuffer);
	...
	static int _CreateMongoDB_Bson_IO_ByteArrayBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				MongoDB.Bson.IO.ByteArrayBuffer obj = new MongoDB.Bson.IO.ByteArrayBuffer(arg0);
			...
			else if (count == 2 && TypeChecker.CheckTypes<bool>(L, 2))
			{
				...
				MongoDB.Bson.IO.ByteArrayBuffer obj = new MongoDB.Bson.IO.ByteArrayBuffer(arg0, arg1);
				ToLua.PushSealed(L, obj);
				return 1;
			}
			...
			else if (count == 3)
			{
				...
				MongoDB.Bson.IO.ByteArrayBuffer obj = new MongoDB.Bson.IO.ByteArrayBuffer(arg0, arg1, arg2);
				ToLua.PushSealed(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: MongoDB.Bson.IO.ByteArrayBuffer.New");
			}
		}
		catch (Exception e)
		{
	...
	static int AccessBackingBytes(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.IO.ByteArrayBuffer obj = (MongoDB.Bson.IO.ByteArrayBuffer)ToLua.CheckObject(L, 1, typeof(MongoDB.Bson.IO.ByteArrayBuffer));
	...
	static int get_Capacity(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.IO.ByteArrayBuffer obj = (MongoDB.Bson.IO.ByteArrayBuffer)o;
