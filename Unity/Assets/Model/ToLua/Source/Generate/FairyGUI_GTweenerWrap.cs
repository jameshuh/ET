...
public class FairyGUI_GTweenerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getcompleted", get_completed);
		L.RegVar("allCompleted", get_allCompleted, null);
		L.RegFunction("getallCompleted", get_allCompleted);
		L.EndClass();
	}
	...
	static int SetTarget(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				FairyGUI.GTweener obj = (FairyGUI.GTweener)ToLua.CheckObject<FairyGUI.GTweener>(L, 1);
				object arg0 = ToLua.ToVarObject(L, 2);
				FairyGUI.TweenPropType arg1 = (FairyGUI.TweenPropType)LuaDLL.luaL_checknumber(L, 3);
