...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_System_UriWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Uri>), typeof(System.Object), "SerializerBase_System_Uri");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Uri> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Uri>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Uri>>(L, 1);
			...
			System.Uri o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			System.Uri arg2 = (System.Uri)ToLua.CheckObject<System.Uri>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Uri> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<System.Uri>)o;
