...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_charWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<char>), typeof(System.Object), "SerializerBase_char");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<char> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<char>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<char>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<char> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<char>)o;
