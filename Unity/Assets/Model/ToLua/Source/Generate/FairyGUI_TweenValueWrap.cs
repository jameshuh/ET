...
public class FairyGUI_TweenValueWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getvec2", get_vec2);
		L.RegFunction("setvec2", set_vec2);
		L.RegVar("vec3", get_vec3, set_vec3);
		L.RegFunction("getvec3", get_vec3);
		L.RegFunction("setvec3", set_vec3);
		L.RegVar("vec4", get_vec4, set_vec4);
		L.RegFunction("getvec4", get_vec4);
		L.RegFunction("setvec4", set_vec4);
