...
public class FairyGUI_GTextFieldWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("gettemplateVars", get_templateVars);
		L.RegFunction("settemplateVars", set_templateVars);
		...
		L.RegFunction("getUBBEnabled", get_UBBEnabled);
		L.RegFunction("setUBBEnabled", set_UBBEnabled);
