...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_LazyBsonArrayWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonArray>), typeof(System.Object), "SerializerBase_MongoDB_Bson_LazyBsonArray");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonArray> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonArray>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonArray>>(L, 1);
			...
			MongoDB.Bson.LazyBsonArray o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.LazyBsonArray arg2 = (MongoDB.Bson.LazyBsonArray)ToLua.CheckObject<MongoDB.Bson.LazyBsonArray>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonArray> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.LazyBsonArray>)o;
