...
public class DCET_Model_UnityWebRequestAsyncWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCET.Model.UnityWebRequestAsync), typeof(System.Object));
		L.RegFunction("Dispose", Dispose);
		L.RegFunction("Update", Update);
		L.RegFunction("DownloadAsync", DownloadAsync);
		L.RegFunction("New", _CreateDCET_Model_UnityWebRequestAsync);
	...
	static int _CreateDCET_Model_UnityWebRequestAsync(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				DCET.Model.UnityWebRequestAsync obj = new DCET.Model.UnityWebRequestAsync();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: DCET.Model.UnityWebRequestAsync.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Dispose(IntPtr L)
	{
		try
		{
			...
			DCET.Model.UnityWebRequestAsync obj = (DCET.Model.UnityWebRequestAsync)ToLua.CheckObject<DCET.Model.UnityWebRequestAsync>(L, 1);
			obj.Dispose();
			return 0;
		}
		catch (Exception e)
	...
	static int get_certificateHandler(IntPtr L)
	{
		try
		{
			ToLua.PushObject(L, DCET.Model.UnityWebRequestAsync.certificateHandler);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_Request(IntPtr L)
	{
		...
		try
		{
			...
			DCET.Model.UnityWebRequestAsync obj = (DCET.Model.UnityWebRequestAsync)o;
	...
	static int set_certificateHandler(IntPtr L)
	{
		try
		{
			DCET.Model.AcceptAllCertificate arg0 = (DCET.Model.AcceptAllCertificate)ToLua.CheckObject<DCET.Model.AcceptAllCertificate>(L, 2);
			DCET.Model.UnityWebRequestAsync.certificateHandler = arg0;
			return 0;
		}
		catch (Exception e)
		{
