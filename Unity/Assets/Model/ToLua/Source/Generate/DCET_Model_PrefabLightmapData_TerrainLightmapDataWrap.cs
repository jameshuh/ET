...
public class DCET_Model_PrefabLightmapData_TerrainLightmapDataWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCET.Model.PrefabLightmapData.TerrainLightmapData), null);
		L.RegFunction("New", _CreateDCET_Model_PrefabLightmapData_TerrainLightmapData);
	...
	static int _CreateDCET_Model_PrefabLightmapData_TerrainLightmapData(IntPtr L)
	{
		DCET.Model.PrefabLightmapData.TerrainLightmapData obj = new DCET.Model.PrefabLightmapData.TerrainLightmapData();
	...
	static int get_terrain(IntPtr L)
	{
		...
		try
		{
			...
			DCET.Model.PrefabLightmapData.TerrainLightmapData obj = (DCET.Model.PrefabLightmapData.TerrainLightmapData)o;
	...
	static int __default__(IntPtr L)
	{
		try
		{
			var o = new DCET.Model.PrefabLightmapData.TerrainLightmapData();
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int __clone__(IntPtr L)
	{
		try
		{
			...
			var obj = (DCET.Model.PrefabLightmapData.TerrainLightmapData)ToLua.CheckObject(L, 1, typeof(DCET.Model.PrefabLightmapData.TerrainLightmapData));
			var o = obj;
			ToLua.PushValue(L, o);
			ToLua.SetBack(L, 1, obj);
			return 1;
