...
public class MongoDB_Bson_IO_BsonWriterWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.IO.BsonWriter), typeof(System.Object));
		...
		L.RegFunction("getDisposed", get_Disposed);
		L.EndClass();
	}
	...
	static int Close(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.IO.BsonWriter obj = (MongoDB.Bson.IO.BsonWriter)ToLua.CheckObject<MongoDB.Bson.IO.BsonWriter>(L, 1);
			obj.Close();
			return 0;
		}
		catch (Exception e)
	...
	static int get_Position(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.IO.BsonWriter obj = (MongoDB.Bson.IO.BsonWriter)o;
