...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_BsonDocumentWrapperWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDocumentWrapper>), typeof(System.Object), "SerializerBase_MongoDB_Bson_BsonDocumentWrapper");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDocumentWrapper> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDocumentWrapper>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDocumentWrapper>>(L, 1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.BsonDocumentWrapper arg2 = (MongoDB.Bson.BsonDocumentWrapper)ToLua.CheckObject<MongoDB.Bson.BsonDocumentWrapper>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDocumentWrapper> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonDocumentWrapper>)o;
