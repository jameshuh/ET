...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_doubleWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<double>), typeof(System.Object), "SerializerBase_double");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<double> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<double>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<double>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<double> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<double>)o;
