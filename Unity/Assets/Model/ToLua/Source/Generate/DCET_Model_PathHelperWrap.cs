...
public class DCET_Model_PathHelperWrap
{
	...
	static int get_AppHotfixResPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, DCET.Model.PathHelper.AppHotfixResPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_AppResPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, DCET.Model.PathHelper.AppResPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_AppResPath4Web(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, DCET.Model.PathHelper.AppResPath4Web);
			return 1;
		}
		catch (Exception e)
		{
