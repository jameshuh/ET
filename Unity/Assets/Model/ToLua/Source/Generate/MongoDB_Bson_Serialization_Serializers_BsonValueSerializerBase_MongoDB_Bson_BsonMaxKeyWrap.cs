...
public class MongoDB_Bson_Serialization_Serializers_BsonValueSerializerBase_MongoDB_Bson_BsonMaxKeyWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonMaxKey>), typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.BsonMaxKey>), "BsonValueSerializerBase_MongoDB_Bson_BsonMaxKey");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonMaxKey> obj = (MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonMaxKey>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.BsonValueSerializerBase<MongoDB.Bson.BsonMaxKey>>(L, 1);
