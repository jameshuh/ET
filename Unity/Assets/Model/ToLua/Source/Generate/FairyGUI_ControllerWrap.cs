...
public class FairyGUI_ControllerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getselectedPage", get_selectedPage);
		L.RegFunction("setselectedPage", set_selectedPage);
		L.RegVar("previsousIndex", get_previsousIndex, null);
		L.RegFunction("getprevisousIndex", get_previsousIndex);
		L.RegVar("previousPage", get_previousPage, null);
		L.RegFunction("getpreviousPage", get_previousPage);
		L.RegVar("pageCount", get_pageCount, null);
		L.RegFunction("getpageCount", get_pageCount);
		L.EndClass();
	}
