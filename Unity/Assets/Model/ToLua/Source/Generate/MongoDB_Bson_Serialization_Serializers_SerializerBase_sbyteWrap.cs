...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_sbyteWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<sbyte>), typeof(System.Object), "SerializerBase_sbyte");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<sbyte> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<sbyte>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<sbyte>>(L, 1);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<sbyte> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<sbyte>)o;
