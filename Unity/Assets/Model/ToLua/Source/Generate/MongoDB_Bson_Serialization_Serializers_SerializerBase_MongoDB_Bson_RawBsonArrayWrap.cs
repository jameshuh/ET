...
public class MongoDB_Bson_Serialization_Serializers_SerializerBase_MongoDB_Bson_RawBsonArrayWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonArray>), typeof(System.Object), "SerializerBase_MongoDB_Bson_RawBsonArray");
	...
	static int Deserialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonArray> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonArray>)ToLua.CheckObject<MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonArray>>(L, 1);
			...
			MongoDB.Bson.RawBsonArray o = obj.Deserialize(arg0, arg1);
	...
	static int Serialize(IntPtr L)
	{
		try
		{
			...
			MongoDB.Bson.RawBsonArray arg2 = (MongoDB.Bson.RawBsonArray)ToLua.CheckObject<MongoDB.Bson.RawBsonArray>(L, 4);
	...
	static int get_ValueType(IntPtr L)
	{
		...
		try
		{
			...
			MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonArray> obj = (MongoDB.Bson.Serialization.Serializers.SerializerBase<MongoDB.Bson.RawBsonArray>)o;
