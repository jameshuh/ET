...
public class PF_NNConstraintWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(PF.NNConstraint), typeof(System.Object));
		L.RegFunction("SuitableGraph", SuitableGraph);
		L.RegFunction("Suitable", Suitable);
		L.RegFunction("New", _CreatePF_NNConstraint);
		...
		L.RegFunction("getNone", get_None);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreatePF_NNConstraint(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				PF.NNConstraint obj = new PF.NNConstraint();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: PF.NNConstraint.New");
			}
		}
		catch (Exception e)
		{
	...
	static int SuitableGraph(IntPtr L)
	{
		try
		{
			...
			PF.NNConstraint obj = (PF.NNConstraint)ToLua.CheckObject<PF.NNConstraint>(L, 1);
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
			PF.NavGraph arg1 = (PF.NavGraph)ToLua.CheckObject<PF.NavGraph>(L, 3);
	...
	static int get_graphMask(IntPtr L)
	{
		...
		try
		{
			...
			PF.NNConstraint obj = (PF.NNConstraint)o;
	...
	static int get_Default(IntPtr L)
	{
		try
		{
			ToLua.PushObject(L, PF.NNConstraint.Default);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_None(IntPtr L)
	{
		try
		{
			ToLua.PushObject(L, PF.NNConstraint.None);
			return 1;
		}
		catch (Exception e)
		{
