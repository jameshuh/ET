...
{
    unsafe class DCET_Model_GameObjectHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.GameObjectHelper);
        ...
        static StackObject* Get_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = DCET.Model.GameObjectHelper.Get<UnityEngine.TextAsset>(@gameObject, @key);
