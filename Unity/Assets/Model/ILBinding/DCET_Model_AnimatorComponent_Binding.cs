...
{
    unsafe class DCET_Model_AnimatorComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.AnimatorComponent);
        ...
        static StackObject* SetFloatValue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.AnimatorComponent instance_of_this_method = (DCET.Model.AnimatorComponent)typeof(DCET.Model.AnimatorComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
