...
{
    unsafe class DCET_Model_G2C_EnterMap_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.G2C_EnterMap);
            args = new Type[]{};
        ...
        static StackObject* get_UnitId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.G2C_EnterMap instance_of_this_method = (DCET.Model.G2C_EnterMap)typeof(DCET.Model.G2C_EnterMap).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
