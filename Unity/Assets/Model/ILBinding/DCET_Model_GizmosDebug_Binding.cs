...
{
    unsafe class DCET_Model_GizmosDebug_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(DCET.Model.GizmosDebug);
            args = new Type[]{};
        ...
        static StackObject* get_Instance_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = DCET.Model.GizmosDebug.Instance;
        ...
        {
            return ((DCET.Model.GizmosDebug)o).Path;
        }
        static void set_Path_0(ref object o, object v)
        {
            ((DCET.Model.GizmosDebug)o).Path = (System.Collections.Generic.List<UnityEngine.Vector3>)v;
        }
