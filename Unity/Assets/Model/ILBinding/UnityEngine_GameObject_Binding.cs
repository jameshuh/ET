...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_GameObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(DCET.Model.ComponentView)};
            if (genericMethods.TryGetValue("AddComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(DCET.Model.ComponentView)))
                    {
            ...
            args = new Type[]{typeof(BehaviorDesigner.Runtime.BehaviorTree)};
            if (genericMethods.TryGetValue("GetComponentsInChildren", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(BehaviorDesigner.Runtime.BehaviorTree[])))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(BehaviorDesigner.Runtime.BehaviorTreeController)};
            if (genericMethods.TryGetValue("GetComponent", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(BehaviorDesigner.Runtime.BehaviorTreeController)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* AddComponent_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.AddComponent<DCET.Model.ComponentView>();
        ...
        static StackObject* GetComponent_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<BehaviorDesigner.Runtime.BehaviorTreeController>();
        ...
        static StackObject* AddComponent_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.AddComponent<BehaviorDesigner.Runtime.BehaviorTreeController>();
        ...
        static StackObject* GetComponent_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetComponent<BehaviorDesigner.Runtime.BehaviorTree>();
