...
{
    unsafe class DCET_Model_SceneChangeComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.SceneChangeComponent);
        ...
        static StackObject* ChangeSceneAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.SceneChangeComponent instance_of_this_method = (DCET.Model.SceneChangeComponent)typeof(DCET.Model.SceneChangeComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
