...
{
    unsafe class DCET_Model_SessionCallbackComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(DCET.Model.SessionCallbackComponent);
        ...
        {
            return ((DCET.Model.SessionCallbackComponent)o).MessageCallback;
        }
        static void set_MessageCallback_0(ref object o, object v)
        {
            ((DCET.Model.SessionCallbackComponent)o).MessageCallback = (System.Action<DCET.Model.Session, System.UInt16, System.IO.MemoryStream>)v;
        }
        static object get_DisposeCallback_1(ref object o)
        {
            return ((DCET.Model.SessionCallbackComponent)o).DisposeCallback;
        }
        static void set_DisposeCallback_1(ref object o, object v)
        {
            ((DCET.Model.SessionCallbackComponent)o).DisposeCallback = (System.Action<DCET.Model.Session>)v;
        }
