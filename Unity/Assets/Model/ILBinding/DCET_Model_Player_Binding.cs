...
{
    unsafe class DCET_Model_Player_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.Player);
        ...
        static StackObject* set_UnitId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.Player instance_of_this_method = (DCET.Model.Player)typeof(DCET.Model.Player).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
