...
{
    unsafe class DCET_Model_ETTaskCompletionSource_1_Google_Protobuf_Adapt_IMessage_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.ETTaskCompletionSource<Google.Protobuf.Adapt_IMessage.Adaptor>);
            args = new Type[]{};
        ...
        static StackObject* get_Task_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.ETTaskCompletionSource<Google.Protobuf.Adapt_IMessage.Adaptor> instance_of_this_method = (DCET.Model.ETTaskCompletionSource<Google.Protobuf.Adapt_IMessage.Adaptor>)typeof(DCET.Model.ETTaskCompletionSource<Google.Protobuf.Adapt_IMessage.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new DCET.Model.ETTaskCompletionSource<Google.Protobuf.Adapt_IMessage.Adaptor>();
