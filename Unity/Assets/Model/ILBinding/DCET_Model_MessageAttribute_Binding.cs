...
{
    unsafe class DCET_Model_MessageAttribute_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.MessageAttribute);
            args = new Type[]{};
        ...
        static StackObject* get_Opcode_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.MessageAttribute instance_of_this_method = (DCET.Model.MessageAttribute)typeof(DCET.Model.MessageAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
