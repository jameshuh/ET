...
{
    unsafe class DCET_Model_GlobalProto_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(DCET.Model.GlobalProto);
        ...
        {
            return ((DCET.Model.GlobalProto)o).Address;
        }
        static void set_Address_0(ref object o, object v)
        {
            ((DCET.Model.GlobalProto)o).Address = (System.String)v;
        }
