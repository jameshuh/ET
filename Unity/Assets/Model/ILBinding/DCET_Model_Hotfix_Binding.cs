...
{
    unsafe class DCET_Model_Hotfix_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(DCET.Model.Hotfix);
            args = new Type[]{};
        ...
        static StackObject* GetHotfixTypes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.Hotfix instance_of_this_method = (DCET.Model.Hotfix)typeof(DCET.Model.Hotfix).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return ((DCET.Model.Hotfix)o).Update;
        }
        static void set_Update_0(ref object o, object v)
        {
            ((DCET.Model.Hotfix)o).Update = (System.Action)v;
        }
        static object get_LateUpdate_1(ref object o)
        {
            return ((DCET.Model.Hotfix)o).LateUpdate;
        }
        static void set_LateUpdate_1(ref object o, object v)
        {
            ((DCET.Model.Hotfix)o).LateUpdate = (System.Action)v;
        }
        static object get_OnApplicationQuit_2(ref object o)
        {
            return ((DCET.Model.Hotfix)o).OnApplicationQuit;
        }
        static void set_OnApplicationQuit_2(ref object o, object v)
        {
            ((DCET.Model.Hotfix)o).OnApplicationQuit = (System.Action)v;
        }
