...
{
    unsafe class DCET_Model_M2C_PathfindingResult_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.M2C_PathfindingResult);
            args = new Type[]{};
        ...
        static StackObject* get_Id_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.M2C_PathfindingResult instance_of_this_method = (DCET.Model.M2C_PathfindingResult)typeof(DCET.Model.M2C_PathfindingResult).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
