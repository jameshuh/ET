...
{
    unsafe class DCET_Model_M2C_CreateUnits_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.M2C_CreateUnits);
            args = new Type[]{};
        ...
        static StackObject* get_Units_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.M2C_CreateUnits instance_of_this_method = (DCET.Model.M2C_CreateUnits)typeof(DCET.Model.M2C_CreateUnits).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
