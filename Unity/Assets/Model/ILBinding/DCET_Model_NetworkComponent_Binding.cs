...
{
    unsafe class DCET_Model_NetworkComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.NetworkComponent);
            args = new Type[]{};
        ...
        static StackObject* get_MessagePacker_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.NetworkComponent instance_of_this_method = (DCET.Model.NetworkComponent)typeof(DCET.Model.NetworkComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
