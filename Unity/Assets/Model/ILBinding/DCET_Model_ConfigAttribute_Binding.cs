...
{
    unsafe class DCET_Model_ConfigAttribute_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.ConfigAttribute);
            args = new Type[]{};
        ...
        static StackObject* get_Type_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.ConfigAttribute instance_of_this_method = (DCET.Model.ConfigAttribute)typeof(DCET.Model.ConfigAttribute).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
