...
{
    unsafe class DCET_Model_UnitInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.UnitInfo);
            args = new Type[]{};
        ...
        static StackObject* get_UnitId_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.UnitInfo instance_of_this_method = (DCET.Model.UnitInfo)typeof(DCET.Model.UnitInfo).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
