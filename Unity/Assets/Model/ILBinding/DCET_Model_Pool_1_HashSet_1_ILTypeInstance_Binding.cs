...
{
    unsafe class DCET_Model_Pool_1_HashSet_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.Pool<System.Collections.Generic.HashSet<ILRuntime.Runtime.Intepreter.ILTypeInstance>>);
            args = new Type[]{};
        ...
        static StackObject* Fetch_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.Pool<System.Collections.Generic.HashSet<ILRuntime.Runtime.Intepreter.ILTypeInstance>> instance_of_this_method = (DCET.Model.Pool<System.Collections.Generic.HashSet<ILRuntime.Runtime.Intepreter.ILTypeInstance>>)typeof(DCET.Model.Pool<System.Collections.Generic.HashSet<ILRuntime.Runtime.Intepreter.ILTypeInstance>>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new DCET.Model.Pool<System.Collections.Generic.HashSet<ILRuntime.Runtime.Intepreter.ILTypeInstance>>();
