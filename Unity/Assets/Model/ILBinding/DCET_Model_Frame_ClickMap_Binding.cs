...
{
    unsafe class DCET_Model_Frame_ClickMap_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.Frame_ClickMap);
        ...
        static StackObject* set_X_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.Frame_ClickMap instance_of_this_method = (DCET.Model.Frame_ClickMap)typeof(DCET.Model.Frame_ClickMap).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new DCET.Model.Frame_ClickMap();
