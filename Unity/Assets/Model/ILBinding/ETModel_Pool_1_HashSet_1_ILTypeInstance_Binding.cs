...
{
    unsafe class ETModel_Pool_1_HashSet_1_ILTypeInstance_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.Pool<System.Collections.Generic.HashSet<ILRuntime.Runtime.Intepreter.ILTypeInstance>>);
            args = new Type[]{};
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ETModel.Pool<System.Collections.Generic.HashSet<ILRuntime.Runtime.Intepreter.ILTypeInstance>>();
