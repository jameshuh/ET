...
{
    unsafe class DCET_Model_UnitFactory_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.UnitFactory);
            args = new Type[]{typeof(DCET.Model.Entity), typeof(System.Int64)};
        ...
        static StackObject* Create_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = DCET.Model.UnitFactory.Create(@domain, @id);
