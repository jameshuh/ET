...
{
    unsafe class DCET_Model_IMessagePacker_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(DCET.Model.IMessagePacker);
        ...
        static StackObject* DeserializeFrom_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            DCET.Model.IMessagePacker instance_of_this_method = (DCET.Model.IMessagePacker)typeof(DCET.Model.IMessagePacker).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
