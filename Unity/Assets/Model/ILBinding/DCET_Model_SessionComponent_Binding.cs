...
{
    unsafe class DCET_Model_SessionComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(DCET.Model.SessionComponent);
        ...
        {
            return DCET.Model.SessionComponent.Instance;
        }
        static void set_Instance_0(ref object o, object v)
        {
            DCET.Model.SessionComponent.Instance = (DCET.Model.SessionComponent)v;
        }
        static object get_Session_1(ref object o)
        {
            return ((DCET.Model.SessionComponent)o).Session;
        }
        static void set_Session_1(ref object o, object v)
        {
            ((DCET.Model.SessionComponent)o).Session = (DCET.Model.Session)v;
        }
