...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOBsonReaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.BsonReader);
			Utils.BeginObjectRegister(type, L, translator, 0, 35, 3, 0);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.IO.BsonReader does not have a constructor!");
        }
