...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOInt64JsonTokenWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.Int64JsonToken);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && (LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) || LuaAPI.lua_isint64(L, 3)))
				{
					...
					MongoDB.Bson.IO.Int64JsonToken gen_ret = new MongoDB.Bson.IO.Int64JsonToken(_lexeme, _value);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.IO.Int64JsonToken constructor!");
        ...
        static int _g_get_DoubleValue(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.IO.Int64JsonToken gen_to_be_invoked = (MongoDB.Bson.IO.Int64JsonToken)translator.FastGetCSObj(L, 1);
