		    ...
		    try {
                ...
                
                {
                    PF.Path _path = (PF.Path)translator.GetObject(L, 1, typeof(PF.Path));
                        ...
                        System.Collections.Generic.List<PF.Funnel.PathPart> gen_ret = PF.Funnel.SplitIntoParts( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    PF.Funnel.PathPart _part;translator.Get(L, 2, out _part);
                        ...
                        PF.Funnel.FunnelPortals gen_ret = PF.Funnel.ConstructFunnelPortals( _nodes, _part );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ShrinkPortals_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    PF.Funnel.ShrinkPortals( _portals, _shrink );
        ...
        static int _m_Unwrap_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    PF.Funnel.Unwrap( _funnel, _left, _right );
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _splitAtEveryPortal = LuaAPI.lua_toboolean(L, 3);
                        ...
                        System.Collections.Generic.List<UnityEngine.Vector3> gen_ret = PF.Funnel.Calculate( _funnel, _unwrap, _splitAtEveryPortal );
                        translator.Push(L, gen_ret);
