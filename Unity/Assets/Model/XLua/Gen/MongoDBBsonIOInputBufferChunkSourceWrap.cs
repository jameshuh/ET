...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOInputBufferChunkSourceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.InputBufferChunkSource);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "MaxUnpooledChunkSize", _g_get_MaxUnpooledChunkSize);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 5 && translator.Assignable<MongoDB.Bson.IO.IBsonChunkSource>(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5))
				{
					...
					int _maxUnpooledChunkSize = LuaAPI.xlua_tointeger(L, 3);
					int _minChunkSize = LuaAPI.xlua_tointeger(L, 4);
					int _maxChunkSize = LuaAPI.xlua_tointeger(L, 5);
					
					MongoDB.Bson.IO.InputBufferChunkSource gen_ret = new MongoDB.Bson.IO.InputBufferChunkSource(_baseSource, _maxUnpooledChunkSize, _minChunkSize, _maxChunkSize);
				...
				if(LuaAPI.lua_gettop(L) == 4 && translator.Assignable<MongoDB.Bson.IO.IBsonChunkSource>(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
				{
					...
					MongoDB.Bson.IO.InputBufferChunkSource gen_ret = new MongoDB.Bson.IO.InputBufferChunkSource(_baseSource, _maxUnpooledChunkSize, _minChunkSize);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<MongoDB.Bson.IO.IBsonChunkSource>(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					...
					MongoDB.Bson.IO.InputBufferChunkSource gen_ret = new MongoDB.Bson.IO.InputBufferChunkSource(_baseSource, _maxUnpooledChunkSize);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.IO.IBsonChunkSource>(L, 2))
				{
					...
					MongoDB.Bson.IO.InputBufferChunkSource gen_ret = new MongoDB.Bson.IO.InputBufferChunkSource(_baseSource);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.IO.InputBufferChunkSource constructor!");
        ...
        static int _m_Dispose(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.IO.InputBufferChunkSource gen_to_be_invoked = (MongoDB.Bson.IO.InputBufferChunkSource)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_MaxUnpooledChunkSize(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                MongoDB.Bson.IO.InputBufferChunkSource gen_to_be_invoked = (MongoDB.Bson.IO.InputBufferChunkSource)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.MaxUnpooledChunkSize);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
