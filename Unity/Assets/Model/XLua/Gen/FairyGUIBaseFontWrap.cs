...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIBaseFontWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 5, 11, 10);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _height;
                        ...
                        bool gen_ret = gen_to_be_invoked.GetGlyphSize( _ch, out _width, out _height );
		    ...
		    try {
                ...
                
                {
                    ...
                    FairyGUI.GlyphInfo _glyph;translator.Get(L, 3, out _glyph);
                        ...
                        bool gen_ret = gen_to_be_invoked.GetGlyph( _ch, ref _glyph );
                        LuaAPI.lua_pushboolean(L, gen_ret);
