...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelIUpdateSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.IUpdateSystem);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.IUpdateSystem does not have a constructor!");
        }
        ...
        static int _m_Type(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.IUpdateSystem gen_to_be_invoked = (DCET.Model.IUpdateSystem)translator.FastGetCSObj(L, 1);
