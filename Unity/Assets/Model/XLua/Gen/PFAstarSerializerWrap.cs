		    ...
		    try {
                ...
                
                {
                    PF.NavGraph _graph = (PF.NavGraph)translator.GetObject(L, 2, typeof(PF.NavGraph));
                        ...
                        byte[] gen_ret = gen_to_be_invoked.Serialize( _graph );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.OpenDeserialize( _bytes );
        ...
        static int _m_SaveToFile_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    PF.AstarSerializer.SaveToFile( _path, _data );
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        byte[] gen_ret = PF.AstarSerializer.LoadFromFile( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
