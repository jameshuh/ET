...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelC2M_TestRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.C2M_TestRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.C2M_TestRequest gen_ret = new DCET.Model.C2M_TestRequest();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.C2M_TestRequest constructor!");
        ...
        static int _m_WriteTo(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.C2M_TestRequest gen_to_be_invoked = (DCET.Model.C2M_TestRequest)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCET.Model.C2M_TestRequest.Parser);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_Request(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.C2M_TestRequest gen_to_be_invoked = (DCET.Model.C2M_TestRequest)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.Request);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_Request(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.C2M_TestRequest gen_to_be_invoked = (DCET.Model.C2M_TestRequest)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.Request = LuaAPI.lua_tostring(L, 2);
