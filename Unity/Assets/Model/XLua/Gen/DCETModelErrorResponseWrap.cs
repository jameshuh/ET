...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelErrorResponseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ErrorResponse);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.ErrorResponse gen_ret = new DCET.Model.ErrorResponse();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ErrorResponse constructor!");
        ...
        static int _g_get_Error(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.ErrorResponse gen_to_be_invoked = (DCET.Model.ErrorResponse)translator.FastGetCSObj(L, 1);
