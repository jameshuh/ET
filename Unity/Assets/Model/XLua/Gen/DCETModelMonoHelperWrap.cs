...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelMonoHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 8, 18, 18);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.MonoHelper does not have a constructor!");
        }
        ...
        static int _m_StartHotfix_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCET.Model.MonoHelper.StartHotfix(  );
