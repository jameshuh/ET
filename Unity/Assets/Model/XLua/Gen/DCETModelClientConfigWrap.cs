...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelClientConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ClientConfig);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.ClientConfig gen_ret = new DCET.Model.ClientConfig();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ClientConfig constructor!");
        ...
        static int _g_get_Address(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.ClientConfig gen_to_be_invoked = (DCET.Model.ClientConfig)translator.FastGetCSObj(L, 1);
