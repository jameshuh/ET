...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelIDeserializeSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.IDeserializeSystem);
        ...
        static int _m_Type(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.IDeserializeSystem gen_to_be_invoked = (DCET.Model.IDeserializeSystem)translator.FastGetCSObj(L, 1);
