...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonLazyBsonArrayWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.LazyBsonArray);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.IO.IByteBuffer>(L, 2))
				{
					...
					MongoDB.Bson.LazyBsonArray gen_ret = new MongoDB.Bson.LazyBsonArray(_slice);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.LazyBsonArray constructor!");
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.LazyBsonArray gen_to_be_invoked = (MongoDB.Bson.LazyBsonArray)translator.FastGetCSObj(L, 1);
