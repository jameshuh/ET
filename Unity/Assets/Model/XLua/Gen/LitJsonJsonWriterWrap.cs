...
namespace XLua.CSObjectWrap
{
    ...
    public class LitJsonJsonWriterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "LowerCaseProperties", _g_get_LowerCaseProperties);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "LowerCaseProperties", _s_set_LowerCaseProperties);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_LowerCaseProperties(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                LitJson.JsonWriter gen_to_be_invoked = (LitJson.JsonWriter)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.LowerCaseProperties);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
