...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonSerializationConventionsIDiscriminatorConventionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.Serialization.Conventions.IDiscriminatorConvention);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.Serialization.Conventions.IDiscriminatorConvention does not have a constructor!");
        }
        ...
        static int _m_GetActualType(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.Serialization.Conventions.IDiscriminatorConvention gen_to_be_invoked = (MongoDB.Bson.Serialization.Conventions.IDiscriminatorConvention)translator.FastGetCSObj(L, 1);
