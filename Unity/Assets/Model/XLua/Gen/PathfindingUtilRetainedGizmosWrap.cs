		    ...
		    try {
                ...
                
                {
                    Pathfinding.Util.RetainedGizmos.Hasher _hasher;translator.Get(L, 2, out _hasher);
                        ...
                        Pathfinding.Util.GraphGizmoHelper gen_ret = gen_to_be_invoked.GetGizmoHelper( _hasher );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    Pathfinding.Util.RetainedGizmos.Hasher _hasher;translator.Get(L, 2, out _hasher);
                        ...
                        bool gen_ret = gen_to_be_invoked.HasCachedMesh( _hasher );
		    ...
		    try {
                ...
                
                {
                    Pathfinding.Util.RetainedGizmos.Hasher _hasher;translator.Get(L, 2, out _hasher);
                        ...
                        bool gen_ret = gen_to_be_invoked.Draw( _hasher );
                        LuaAPI.lua_pushboolean(L, gen_ret);
