...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelPrefabLightmapDataTerrainLightmapDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.PrefabLightmapData.TerrainLightmapData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(DCET.Model.PrefabLightmapData.TerrainLightmapData));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.PrefabLightmapData.TerrainLightmapData constructor!");
        ...
        static int _g_get_terrain(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.PrefabLightmapData.TerrainLightmapData gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
