...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonSerializationSerializersBooleanSerializerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.Serialization.Serializers.BooleanSerializer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MongoDB.Bson.Serialization.Serializers.BooleanSerializer gen_ret = new MongoDB.Bson.Serialization.Serializers.BooleanSerializer();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.BsonType>(L, 2))
				{
					...
					MongoDB.Bson.Serialization.Serializers.BooleanSerializer gen_ret = new MongoDB.Bson.Serialization.Serializers.BooleanSerializer(_representation);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.Serialization.Serializers.BooleanSerializer constructor!");
        ...
        static int _m_Deserialize(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.Serialization.Serializers.BooleanSerializer gen_to_be_invoked = (MongoDB.Bson.Serialization.Serializers.BooleanSerializer)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    MongoDB.Bson.Serialization.BsonDeserializationArgs _args;translator.Get(L, 3, out _args);
                        ...
                        bool gen_ret = gen_to_be_invoked.Deserialize( _context, _args );
		    ...
		    try {
                ...
                
                {
                    MongoDB.Bson.BsonType _representation;translator.Get(L, 2, out _representation);
                        ...
                        MongoDB.Bson.Serialization.Serializers.BooleanSerializer gen_ret = gen_to_be_invoked.WithRepresentation( _representation );
                        translator.Push(L, gen_ret);
