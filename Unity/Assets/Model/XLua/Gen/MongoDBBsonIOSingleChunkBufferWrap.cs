...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOSingleChunkBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.SingleChunkBuffer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 4 && translator.Assignable<MongoDB.Bson.IO.IBsonChunk>(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4))
				{
					MongoDB.Bson.IO.IBsonChunk _chunk = (MongoDB.Bson.IO.IBsonChunk)translator.GetObject(L, 2, typeof(MongoDB.Bson.IO.IBsonChunk));
					int _length = LuaAPI.xlua_tointeger(L, 3);
					bool _isReadOnly = LuaAPI.lua_toboolean(L, 4);
					
					MongoDB.Bson.IO.SingleChunkBuffer gen_ret = new MongoDB.Bson.IO.SingleChunkBuffer(_chunk, _length, _isReadOnly);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<MongoDB.Bson.IO.IBsonChunk>(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					MongoDB.Bson.IO.IBsonChunk _chunk = (MongoDB.Bson.IO.IBsonChunk)translator.GetObject(L, 2, typeof(MongoDB.Bson.IO.IBsonChunk));
					int _length = LuaAPI.xlua_tointeger(L, 3);
					
					MongoDB.Bson.IO.SingleChunkBuffer gen_ret = new MongoDB.Bson.IO.SingleChunkBuffer(_chunk, _length);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.IO.SingleChunkBuffer constructor!");
        ...
        static int _m_AccessBackingBytes(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.IO.SingleChunkBuffer gen_to_be_invoked = (MongoDB.Bson.IO.SingleChunkBuffer)translator.FastGetCSObj(L, 1);
