...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelComponentViewWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ComponentView);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.ComponentView gen_ret = new DCET.Model.ComponentView();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ComponentView constructor!");
        ...
        static int _g_get_Component(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.ComponentView gen_to_be_invoked = (DCET.Model.ComponentView)translator.FastGetCSObj(L, 1);
