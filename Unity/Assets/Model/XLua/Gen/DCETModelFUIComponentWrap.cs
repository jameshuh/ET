...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelFUIComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.FUIComponent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.FUIComponent gen_ret = new DCET.Model.FUIComponent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.FUIComponent constructor!");
        ...
        static int _s_set_Root(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.FUIComponent gen_to_be_invoked = (DCET.Model.FUIComponent)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.Root = (DCET.Model.FUI)translator.GetObject(L, 2, typeof(DCET.Model.FUI));
