...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonRawBsonDocumentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.RawBsonDocument);
			Utils.BeginObjectRegister(type, L, translator, 0, 23, 5, 0);
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<MongoDB.Bson.RawBsonDocument>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<MongoDB.Bson.RawBsonDocument>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<MongoDB.Bson.BsonValue>(L, 3))
				{
        ...
        static int _m_Add(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.RawBsonDocument.Add!");
        ...
        static int _m_AddRange(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.RawBsonDocument.AddRange!");
        ...
        static int _m_GetElement(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.RawBsonDocument.GetElement!");
        ...
        static int _m_GetValue(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.RawBsonDocument.GetValue!");
		    ...
		    try {
                ...
                
                {
                    MongoDB.Bson.IO.BsonBinaryReaderSettings _binaryReaderSettings = (MongoDB.Bson.IO.BsonBinaryReaderSettings)translator.GetObject(L, 2, typeof(MongoDB.Bson.IO.BsonBinaryReaderSettings));
                        ...
                        MongoDB.Bson.BsonDocument gen_ret = gen_to_be_invoked.Materialize( _binaryReaderSettings );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Merge(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.RawBsonDocument.Merge!");
        ...
        static int _m_Set(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.RawBsonDocument.Set!");
        ...
        static int _m_SetElement(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.RawBsonDocument.SetElement!");
        ...
        static int _m_TryGetElement(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                    MongoDB.Bson.BsonElement _element;
                    
                        bool gen_ret = gen_to_be_invoked.TryGetElement( _name, out _element );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                    translator.Push(L, _element);
