...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelIChangeSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.IChangeSystem);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.IChangeSystem does not have a constructor!");
        }
        ...
        static int _m_Type(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.IChangeSystem gen_to_be_invoked = (DCET.Model.IChangeSystem)translator.FastGetCSObj(L, 1);
