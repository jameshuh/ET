...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelETCancellationTokenSourceAwake2SystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ETCancellationTokenSourceAwake2System);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.ETCancellationTokenSourceAwake2System gen_ret = new DCET.Model.ETCancellationTokenSourceAwake2System();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ETCancellationTokenSourceAwake2System constructor!");
