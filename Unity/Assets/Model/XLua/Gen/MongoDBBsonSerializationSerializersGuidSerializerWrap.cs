...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonSerializationSerializersGuidSerializerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.Serialization.Serializers.GuidSerializer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MongoDB.Bson.Serialization.Serializers.GuidSerializer gen_ret = new MongoDB.Bson.Serialization.Serializers.GuidSerializer();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.BsonType>(L, 2))
				{
					...
					MongoDB.Bson.Serialization.Serializers.GuidSerializer gen_ret = new MongoDB.Bson.Serialization.Serializers.GuidSerializer(_representation);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.Serialization.Serializers.GuidSerializer constructor!");
        ...
        static int _m_Deserialize(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.Serialization.Serializers.GuidSerializer gen_to_be_invoked = (MongoDB.Bson.Serialization.Serializers.GuidSerializer)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    MongoDB.Bson.Serialization.BsonDeserializationArgs _args;translator.Get(L, 3, out _args);
                        ...
                        System.Guid gen_ret = gen_to_be_invoked.Deserialize( _context, _args );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Serialize(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.Guid _value;translator.Get(L, 4, out _value);
		    ...
		    try {
                ...
                
                {
                    MongoDB.Bson.BsonType _representation;translator.Get(L, 2, out _representation);
                        ...
                        MongoDB.Bson.Serialization.Serializers.GuidSerializer gen_ret = gen_to_be_invoked.WithRepresentation( _representation );
                        translator.Push(L, gen_ret);
