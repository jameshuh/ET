...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.Object);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.Object does not have a constructor!");
        }
        ...
        static int _m_BeginInit(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.Object gen_to_be_invoked = (DCET.Model.Object)translator.FastGetCSObj(L, 1);
