...
namespace XLua.CSObjectWrap
{
    ...
    public class MikuLuaProfilerSampleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 4, 19, 17);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "selfLuaGC", _g_get_selfLuaGC);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "selfMonoGC", _g_get_selfMonoGC);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "needShow", _g_get_needShow);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "needShow", _s_set_needShow);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_selfLuaGC(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                MikuLuaProfiler.Sample gen_to_be_invoked = (MikuLuaProfiler.Sample)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked.selfLuaGC);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_selfMonoGC(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                MikuLuaProfiler.Sample gen_to_be_invoked = (MikuLuaProfiler.Sample)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked.selfMonoGC);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_needShow(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                MikuLuaProfiler.Sample gen_to_be_invoked = (MikuLuaProfiler.Sample)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.needShow);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
