...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOBsonDocumentWriterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.BsonDocumentWriter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.BsonDocument>(L, 2))
				{
					...
					MongoDB.Bson.IO.BsonDocumentWriter gen_ret = new MongoDB.Bson.IO.BsonDocumentWriter(_document);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<MongoDB.Bson.BsonDocument>(L, 2) && translator.Assignable<MongoDB.Bson.IO.BsonDocumentWriterSettings>(L, 3))
				{
					MongoDB.Bson.BsonDocument _document = (MongoDB.Bson.BsonDocument)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonDocument));
					MongoDB.Bson.IO.BsonDocumentWriterSettings _settings = (MongoDB.Bson.IO.BsonDocumentWriterSettings)translator.GetObject(L, 3, typeof(MongoDB.Bson.IO.BsonDocumentWriterSettings));
					
					MongoDB.Bson.IO.BsonDocumentWriter gen_ret = new MongoDB.Bson.IO.BsonDocumentWriter(_document, _settings);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.IO.BsonDocumentWriter constructor!");
        ...
        static int _m_Close(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.IO.BsonDocumentWriter gen_to_be_invoked = (MongoDB.Bson.IO.BsonDocumentWriter)translator.FastGetCSObj(L, 1);
