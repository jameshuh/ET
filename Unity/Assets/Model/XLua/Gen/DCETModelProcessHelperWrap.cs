...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelProcessHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ProcessHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.ProcessHelper does not have a constructor!");
        }
        ...
        static int _m_Run_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _exe = LuaAPI.lua_tostring(L, 1);
                    string _arguments = LuaAPI.lua_tostring(L, 2);
                    string _workingDirectory = LuaAPI.lua_tostring(L, 3);
                    bool _waitExit = LuaAPI.lua_toboolean(L, 4);
                    
                        System.Diagnostics.Process gen_ret = DCET.Model.ProcessHelper.Run( _exe, _arguments, _workingDirectory, _waitExit );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _workingDirectory = LuaAPI.lua_tostring(L, 3);
                        ...
                        System.Diagnostics.Process gen_ret = DCET.Model.ProcessHelper.Run( _exe, _arguments, _workingDirectory );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _arguments = LuaAPI.lua_tostring(L, 2);
                        ...
                        System.Diagnostics.Process gen_ret = DCET.Model.ProcessHelper.Run( _exe, _arguments );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ProcessHelper.Run!");
