...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelIStaticMethodWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.IStaticMethod);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.IStaticMethod does not have a constructor!");
        }
        ...
        static int _m_Run(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.IStaticMethod gen_to_be_invoked = (DCET.Model.IStaticMethod)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.IStaticMethod.Run!");
