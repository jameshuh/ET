...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelUnitInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.UnitInfo);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.UnitInfo gen_ret = new DCET.Model.UnitInfo();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.UnitInfo constructor!");
        ...
        static int _m_WriteTo(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.UnitInfo gen_to_be_invoked = (DCET.Model.UnitInfo)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCET.Model.UnitInfo.Parser);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
