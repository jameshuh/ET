...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOIByteBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.IByteBuffer);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.IO.IByteBuffer does not have a constructor!");
        }
