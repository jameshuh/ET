...
namespace XLua.CSObjectWrap
{
    ...
    public class MikuLuaProfilerMikuLuaProfilerLuaProfilerWrapWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "beginSampleCustom", _g_get_beginSampleCustom);
			...
			Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "setting", _s_set_setting);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "beginSample", _s_set_beginSample);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "beginSampleCustom", _s_set_beginSampleCustom);
        ...
        static int _g_get_setting(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, MikuLuaProfiler.MikuLuaProfilerLuaProfilerWrap.setting);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_beginSampleCustom(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, MikuLuaProfiler.MikuLuaProfilerLuaProfilerWrap.beginSampleCustom);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_setting(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    MikuLuaProfiler.MikuLuaProfilerLuaProfilerWrap.setting = (MikuLuaProfiler.LuaDeepProfilerSetting)translator.GetObject(L, 1, typeof(MikuLuaProfiler.LuaDeepProfilerSetting));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_beginSampleCustom(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    MikuLuaProfiler.MikuLuaProfilerLuaProfilerWrap.beginSampleCustom = translator.GetDelegate<MikuLuaProfiler.LuaCSFunction>(L, 1);
