...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelRandomHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.RandomHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.RandomHelper does not have a constructor!");
        }
        ...
        static int _m_RandInt64_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        long gen_ret = DCET.Model.RandomHelper.RandInt64(  );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _upper = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = DCET.Model.RandomHelper.RandomNumber( _lower, _upper );
