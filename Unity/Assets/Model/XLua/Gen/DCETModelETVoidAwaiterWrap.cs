...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelETVoidAwaiterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ETVoid.Awaiter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(DCET.Model.ETVoid.Awaiter));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ETVoid.Awaiter constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.ETVoid.Awaiter gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
