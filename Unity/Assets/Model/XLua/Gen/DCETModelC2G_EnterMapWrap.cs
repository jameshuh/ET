...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelC2G_EnterMapWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.C2G_EnterMap);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.C2G_EnterMap gen_ret = new DCET.Model.C2G_EnterMap();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.C2G_EnterMap constructor!");
        ...
        static int _m_WriteTo(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.C2G_EnterMap gen_to_be_invoked = (DCET.Model.C2G_EnterMap)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCET.Model.C2G_EnterMap.Parser);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
