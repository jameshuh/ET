...
namespace XLua.CSObjectWrap
{
    ...
    public class BehaviorDesignerRuntimeTasksReturnFailureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BehaviorDesigner.Runtime.Tasks.ReturnFailure);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BehaviorDesigner.Runtime.Tasks.ReturnFailure gen_ret = new BehaviorDesigner.Runtime.Tasks.ReturnFailure();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BehaviorDesigner.Runtime.Tasks.ReturnFailure constructor!");
        ...
        static int _m_CanExecute(RealStatePtr L)
        {
		    try {
                ...
                BehaviorDesigner.Runtime.Tasks.ReturnFailure gen_to_be_invoked = (BehaviorDesigner.Runtime.Tasks.ReturnFailure)translator.FastGetCSObj(L, 1);
