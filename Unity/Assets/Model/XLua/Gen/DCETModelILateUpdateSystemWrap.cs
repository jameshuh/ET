...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelILateUpdateSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ILateUpdateSystem);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.ILateUpdateSystem does not have a constructor!");
        }
