...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelIActorMessageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.IActorMessage);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.IActorMessage does not have a constructor!");
        }
        ...
        static int _g_get_ActorId(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.IActorMessage gen_to_be_invoked = (DCET.Model.IActorMessage)translator.FastGetCSObj(L, 1);
