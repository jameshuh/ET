...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonBsonDecimal128Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.BsonDecimal128);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.Decimal128>(L, 2))
				{
					MongoDB.Bson.Decimal128 _value;translator.Get(L, 2, out _value);
					
					MongoDB.Bson.BsonDecimal128 gen_ret = new MongoDB.Bson.BsonDecimal128(_value);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonDecimal128 constructor!");
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<MongoDB.Bson.BsonDecimal128>(L, 1) && translator.Assignable<MongoDB.Bson.BsonDecimal128>(L, 2))
				{
					MongoDB.Bson.BsonDecimal128 leftside = (MongoDB.Bson.BsonDecimal128)translator.GetObject(L, 1, typeof(MongoDB.Bson.BsonDecimal128));
					MongoDB.Bson.BsonDecimal128 rightside = (MongoDB.Bson.BsonDecimal128)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonDecimal128));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need MongoDB.Bson.BsonDecimal128!");
		    ...
		    try {
                ...
                
                {
                    object _value = translator.GetObject(L, 1, typeof(object));
                        ...
                        MongoDB.Bson.BsonDecimal128 gen_ret = MongoDB.Bson.BsonDecimal128.Create( _value );
                        translator.Push(L, gen_ret);
        ...
        static int _m_CompareTo(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<MongoDB.Bson.BsonDecimal128>(L, 2)) 
                {
                    MongoDB.Bson.BsonDecimal128 _other = (MongoDB.Bson.BsonDecimal128)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonDecimal128));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonDecimal128.CompareTo!");
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<MongoDB.Bson.BsonDecimal128>(L, 2)) 
                {
                    MongoDB.Bson.BsonDecimal128 _rhs = (MongoDB.Bson.BsonDecimal128)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonDecimal128));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonDecimal128.Equals!");
