...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelUnitFactoryWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.UnitFactory);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.UnitFactory does not have a constructor!");
        }
