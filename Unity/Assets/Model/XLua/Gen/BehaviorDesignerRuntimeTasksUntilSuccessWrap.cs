...
namespace XLua.CSObjectWrap
{
    ...
    public class BehaviorDesignerRuntimeTasksUntilSuccessWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BehaviorDesigner.Runtime.Tasks.UntilSuccess);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BehaviorDesigner.Runtime.Tasks.UntilSuccess gen_ret = new BehaviorDesigner.Runtime.Tasks.UntilSuccess();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BehaviorDesigner.Runtime.Tasks.UntilSuccess constructor!");
        ...
        static int _m_CanExecute(RealStatePtr L)
        {
		    try {
                ...
                BehaviorDesigner.Runtime.Tasks.UntilSuccess gen_to_be_invoked = (BehaviorDesigner.Runtime.Tasks.UntilSuccess)translator.FastGetCSObj(L, 1);
