...
namespace XLua.CSObjectWrap
{
    ...
    public class PFTriangleMeshNodeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 19, 3, 3);
		    ...
		    try {
                ...
                
                {
                    uint _graphIndex = LuaAPI.xlua_touint(L, 1);
                        ...
                        PF.INavmeshHolder gen_ret = PF.TriangleMeshNode.GetNavmeshHolder( _graphIndex );
        ...
        static int _m_SetNavmeshHolder_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    PF.TriangleMeshNode.SetNavmeshHolder( _graphIndex, _graph );
		    ...
		    try {
                ...
                
                {
                    int _i = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.GetVertexIndex( _i );
		    ...
		    try {
                ...
                
                {
                    int _i = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.GetVertexArrayIndex( _i );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_GetVertices(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetVertices( out _v0, out _v1, out _v2 );
        ...
        static int _m_GetVerticesInGraphSpace(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetVerticesInGraphSpace( out _v0, out _v1, out _v2 );
                    translator.Push(L, _v0);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _p;translator.Get(L, 2, out _p);
                        ...
                        bool gen_ret = gen_to_be_invoked.ContainsPoint( _p );
		    ...
		    try {
                ...
                
                {
                    PF.Int3 _p;translator.Get(L, 2, out _p);
                        ...
                        bool gen_ret = gen_to_be_invoked.ContainsPointInGraphSpace( _p );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_Open(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Open( _path, _pathNode, _handler );
		    ...
		    try {
                ...
                
                {
                    PF.GraphNode _other = (PF.GraphNode)translator.GetObject(L, 2, typeof(PF.GraphNode));
                        ...
                        int gen_ret = gen_to_be_invoked.SharedEdge( _other );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 5&& translator.Assignable<PF.GraphNode>(L, 2)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Vector3>>(L, 3)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Vector3>>(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    bool _backwards = LuaAPI.lua_toboolean(L, 5);
                        ...
                        bool gen_ret = gen_to_be_invoked.GetPortal( _toNode, _left, _right, _backwards );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 5&& translator.Assignable<PF.GraphNode>(L, 2)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Vector3>>(L, 3)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Vector3>>(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    int _bIndex;
                        ...
                        bool gen_ret = gen_to_be_invoked.GetPortal( _toNode, _left, _right, _backwards, out _aIndex, out _bIndex );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _m_SerializeNode(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SerializeNode( _ctx );
        ...
        static int _m_DeserializeNode(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DeserializeNode( _ctx );
