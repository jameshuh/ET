...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonBsonDoubleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.BsonDouble);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					MongoDB.Bson.BsonDouble gen_ret = new MongoDB.Bson.BsonDouble(_value);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonDouble constructor!");
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<MongoDB.Bson.BsonDouble>(L, 1) && translator.Assignable<MongoDB.Bson.BsonDouble>(L, 2))
				{
					MongoDB.Bson.BsonDouble leftside = (MongoDB.Bson.BsonDouble)translator.GetObject(L, 1, typeof(MongoDB.Bson.BsonDouble));
					MongoDB.Bson.BsonDouble rightside = (MongoDB.Bson.BsonDouble)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonDouble));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need MongoDB.Bson.BsonDouble!");
		    ...
		    try {
                ...
                
                {
                    object _value = translator.GetObject(L, 1, typeof(object));
                        ...
                        MongoDB.Bson.BsonDouble gen_ret = MongoDB.Bson.BsonDouble.Create( _value );
                        translator.Push(L, gen_ret);
        ...
        static int _m_CompareTo(RealStatePtr L)
        {
		    try {
                ...
                {
                    MongoDB.Bson.BsonDouble _other = (MongoDB.Bson.BsonDouble)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonDouble));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonDouble.CompareTo!");
