...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonBsonInternalExceptionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.BsonInternalException);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MongoDB.Bson.BsonInternalException gen_ret = new MongoDB.Bson.BsonInternalException();
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					MongoDB.Bson.BsonInternalException gen_ret = new MongoDB.Bson.BsonInternalException(_message);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && translator.Assignable<System.Exception>(L, 3))
				{
					...
					MongoDB.Bson.BsonInternalException gen_ret = new MongoDB.Bson.BsonInternalException(_message, _innerException);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Runtime.Serialization.SerializationInfo>(L, 2) && translator.Assignable<System.Runtime.Serialization.StreamingContext>(L, 3))
				{
					...
					MongoDB.Bson.BsonInternalException gen_ret = new MongoDB.Bson.BsonInternalException(_info, _context);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonInternalException constructor!");
