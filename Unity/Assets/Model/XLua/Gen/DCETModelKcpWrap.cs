...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelKcpWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.Kcp);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.Kcp gen_ret = new DCET.Model.Kcp();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.Kcp constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    uint _current = LuaAPI.xlua_touint(L, 2);
                        ...
                        uint gen_ret = DCET.Model.Kcp.KcpCheck( _kcp, _current );
		    ...
		    try {
                ...
                
                {
                    ...
                    System.IntPtr _user = LuaAPI.lua_touserdata(L, 2);
                        ...
                        System.IntPtr gen_ret = DCET.Model.Kcp.KcpCreate( _conv, _user );
		    ...
		    try {
                ...
                
                {
                    System.IntPtr _ptr = LuaAPI.lua_touserdata(L, 1);
                        ...
                        uint gen_ret = DCET.Model.Kcp.KcpGetconv( _ptr );
                        LuaAPI.xlua_pushuint(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _nc = LuaAPI.xlua_tointeger(L, 5);
                        ...
                        int gen_ret = DCET.Model.Kcp.KcpNodelay( _kcp, _nodelay, _interval, _resend, _nc );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.IntPtr _kcp = LuaAPI.lua_touserdata(L, 1);
                        ...
                        int gen_ret = DCET.Model.Kcp.KcpPeeksize( _kcp );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _len = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        int gen_ret = DCET.Model.Kcp.KcpRecv( _kcp, _buffer, _len );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_KcpRelease_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCET.Model.Kcp.KcpRelease( _kcp );
        ...
        static int _m_KcpSetminrto_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCET.Model.Kcp.KcpSetminrto( _kcp, _minrto );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _mtu = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = DCET.Model.Kcp.KcpSetmtu( _kcp, _mtu );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_KcpSetoutput_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.IntPtr _kcp = LuaAPI.lua_touserdata(L, 1);
                    DCET.Model.KcpOutput _output = translator.GetDelegate<DCET.Model.KcpOutput>(L, 2);
                    
                    DCET.Model.Kcp.KcpSetoutput( _kcp, _output );
        ...
        static int _m_KcpUpdate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCET.Model.Kcp.KcpUpdate( _kcp, _current );
		    ...
		    try {
                ...
                
                {
                    System.IntPtr _kcp = LuaAPI.lua_touserdata(L, 1);
                        ...
                        int gen_ret = DCET.Model.Kcp.KcpWaitsnd( _kcp );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _rcvwnd = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        int gen_ret = DCET.Model.Kcp.KcpWndsize( _kcp, _sndwnd, _rcvwnd );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
