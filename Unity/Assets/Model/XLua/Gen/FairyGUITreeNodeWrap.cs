...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITreeNodeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 12, 9, 2);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.TreeNode _child = (FairyGUI.TreeNode)translator.GetObject(L, 2, typeof(FairyGUI.TreeNode));
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.AddChild( _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.AddChildAt( _child, _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.TreeNode _child = (FairyGUI.TreeNode)translator.GetObject(L, 2, typeof(FairyGUI.TreeNode));
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.RemoveChild( _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.RemoveChildAt( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.GetChildAt( _index );
                        translator.Push(L, gen_ret);
