...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonSerializationSerializersInt32SerializerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.Serialization.Serializers.Int32Serializer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MongoDB.Bson.Serialization.Serializers.Int32Serializer gen_ret = new MongoDB.Bson.Serialization.Serializers.Int32Serializer();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.BsonType>(L, 2))
				{
					...
					MongoDB.Bson.Serialization.Serializers.Int32Serializer gen_ret = new MongoDB.Bson.Serialization.Serializers.Int32Serializer(_representation);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<MongoDB.Bson.BsonType>(L, 2) && translator.Assignable<MongoDB.Bson.Serialization.Options.RepresentationConverter>(L, 3))
				{
					...
					MongoDB.Bson.Serialization.Serializers.Int32Serializer gen_ret = new MongoDB.Bson.Serialization.Serializers.Int32Serializer(_representation, _converter);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.Serialization.Serializers.Int32Serializer constructor!");
        ...
        static int _m_Deserialize(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.Serialization.Serializers.Int32Serializer gen_to_be_invoked = (MongoDB.Bson.Serialization.Serializers.Int32Serializer)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    MongoDB.Bson.Serialization.BsonDeserializationArgs _args;translator.Get(L, 3, out _args);
                        ...
                        int gen_ret = gen_to_be_invoked.Deserialize( _context, _args );
		    ...
		    try {
                ...
                
                {
                    MongoDB.Bson.Serialization.Options.RepresentationConverter _converter = (MongoDB.Bson.Serialization.Options.RepresentationConverter)translator.GetObject(L, 2, typeof(MongoDB.Bson.Serialization.Options.RepresentationConverter));
                        ...
                        MongoDB.Bson.Serialization.Serializers.Int32Serializer gen_ret = gen_to_be_invoked.WithConverter( _converter );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    MongoDB.Bson.BsonType _representation;translator.Get(L, 2, out _representation);
                        ...
                        MongoDB.Bson.Serialization.Serializers.Int32Serializer gen_ret = gen_to_be_invoked.WithRepresentation( _representation );
                        translator.Push(L, gen_ret);
