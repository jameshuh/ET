...
namespace XLua.CSObjectWrap
{
    ...
    public class LitJsonIJsonWrapperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LitJson.IJsonWrapper);
        ...
        {
            return LuaAPI.luaL_error(L, "LitJson.IJsonWrapper does not have a constructor!");
        }
        ...
        static int _m_GetJsonType(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        translator.PushLitJsonJsonType(L, gen_ret);
