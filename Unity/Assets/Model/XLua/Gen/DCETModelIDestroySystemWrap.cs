...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelIDestroySystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.IDestroySystem);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.IDestroySystem does not have a constructor!");
        }
        ...
        static int _m_Type(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.IDestroySystem gen_to_be_invoked = (DCET.Model.IDestroySystem)translator.FastGetCSObj(L, 1);
