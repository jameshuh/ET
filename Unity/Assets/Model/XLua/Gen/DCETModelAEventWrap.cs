...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelAEventWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.AEvent);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.AEvent does not have a constructor!");
        }
        ...
        static int _m_Handle(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.AEvent gen_to_be_invoked = (DCET.Model.AEvent)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.AEvent.Handle!");
