...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonMaterializedOnDemandBsonArrayWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.MaterializedOnDemandBsonArray);
			Utils.BeginObjectRegister(type, L, translator, 0, 19, 5, 1);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.MaterializedOnDemandBsonArray does not have a constructor!");
        }
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable<MongoDB.Bson.MaterializedOnDemandBsonArray>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<MongoDB.Bson.MaterializedOnDemandBsonArray>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<MongoDB.Bson.BsonValue>(L, 3))
				{
        ...
        static int _m_AddRange(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.MaterializedOnDemandBsonArray.AddRange!");
        ...
        static int _m_CompareTo(RealStatePtr L)
        {
		    try {
                ...
                {
                    MongoDB.Bson.BsonArray _other = (MongoDB.Bson.BsonArray)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonArray));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.MaterializedOnDemandBsonArray.CompareTo!");
        ...
        static int _m_IndexOf(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.MaterializedOnDemandBsonArray.IndexOf!");
