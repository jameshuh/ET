...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaCSObjectWrapSystemCollectionsIEnumeratorBridgeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XLua.CSObjectWrap.SystemCollectionsIEnumeratorBridge);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__Create", _m___Create_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<XLua.LuaEnv>(L, 3))
				{
					...
					XLua.CSObjectWrap.SystemCollectionsIEnumeratorBridge gen_ret = new XLua.CSObjectWrap.SystemCollectionsIEnumeratorBridge(_reference, _luaenv);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLua.CSObjectWrap.SystemCollectionsIEnumeratorBridge constructor!");
