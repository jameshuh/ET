...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonSerializationIIdGeneratorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.Serialization.IIdGenerator);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.Serialization.IIdGenerator does not have a constructor!");
        }
        ...
        static int _m_GenerateId(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.Serialization.IIdGenerator gen_to_be_invoked = (MongoDB.Bson.Serialization.IIdGenerator)translator.FastGetCSObj(L, 1);
