...
using Pathfinding;using DCET.Model;
...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector3Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 6, 11, 6, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "IgnoreYAxis", _m_IgnoreYAxis);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "PointOnLeftSideOfVector", _m_PointOnLeftSideOfVector);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IgnoreYAxis(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.IgnoreYAxis(  );
                        translator.PushUnityEngineVector2(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_PointOnLeftSideOfVector(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3 _originPoint;translator.Get(L, 2, out _originPoint);
                    UnityEngine.Vector3 _point;translator.Get(L, 3, out _point);
                    
                        bool gen_ret = gen_to_be_invoked.PointOnLeftSideOfVector( _originPoint, _point );
                        LuaAPI.lua_pushboolean(L, gen_ret);
