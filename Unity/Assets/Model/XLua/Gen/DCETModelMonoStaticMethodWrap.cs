...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelMonoStaticMethodWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.MonoStaticMethod);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Type>(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
					...
					DCET.Model.MonoStaticMethod gen_ret = new DCET.Model.MonoStaticMethod(_type, _methodName);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.MonoStaticMethod constructor!");
        ...
        static int _m_Run(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.MonoStaticMethod gen_to_be_invoked = (DCET.Model.MonoStaticMethod)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.MonoStaticMethod.Run!");
