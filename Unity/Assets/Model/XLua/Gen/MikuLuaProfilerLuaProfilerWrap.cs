    ...
    public class MikuLuaProfilerLuaProfilerWrap 
    {
        ...
        static int _m_BeginSample_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TLIGHTUSERDATA == LuaAPI.lua_type(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    System.IntPtr _luaState = LuaAPI.lua_touserdata(L, 1);
                    string _name = LuaAPI.lua_tostring(L, 2);
                    bool _needShow = LuaAPI.lua_toboolean(L, 3);
                    
                    MikuLuaProfiler.LuaProfiler.BeginSample( _luaState, _name, _needShow );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MikuLuaProfiler.LuaProfiler.BeginSample!");
