...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelGlobalProtoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.GlobalProto);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.GlobalProto gen_ret = new DCET.Model.GlobalProto();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.GlobalProto constructor!");
        ...
        static int _m_GetUrl(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.GlobalProto gen_to_be_invoked = (DCET.Model.GlobalProto)translator.FastGetCSObj(L, 1);
