...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonSerializationAttributesBsonDictionaryOptionsAttributeWrap 
    {
        ...
        static int _g_get_Representation(RealStatePtr L)
        {
		    try {
                ...
                translator.PushMongoDBBsonSerializationOptionsDictionaryRepresentation(L, gen_to_be_invoked.Representation);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
