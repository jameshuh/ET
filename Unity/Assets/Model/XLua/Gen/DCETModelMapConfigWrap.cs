...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelMapConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.MapConfig);
			Utils.BeginObjectRegister(type, L, translator, 0, 0, 1, 1);
			
			
			
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "MapType", _g_get_MapType);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "MapType", _s_set_MapType);
