...
namespace XLua.CSObjectWrap
{
    ...
    public class BehaviorDesignerRuntimeTasksInverterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BehaviorDesigner.Runtime.Tasks.Inverter);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BehaviorDesigner.Runtime.Tasks.Inverter gen_ret = new BehaviorDesigner.Runtime.Tasks.Inverter();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BehaviorDesigner.Runtime.Tasks.Inverter constructor!");
        ...
        static int _m_CanExecute(RealStatePtr L)
        {
		    try {
                ...
                BehaviorDesigner.Runtime.Tasks.Inverter gen_to_be_invoked = (BehaviorDesigner.Runtime.Tasks.Inverter)translator.FastGetCSObj(L, 1);
