...
namespace XLua.CSObjectWrap
{
    ...
    public class PFGuidWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PF.Guid);
			Utils.BeginObjectRegister(type, L, translator, 1, 4, 0, 0);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					PF.Guid gen_ret = new PF.Guid(_bytes);
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					PF.Guid gen_ret = new PF.Guid(_str);
					translator.Push(L, gen_ret);
				...
				{
				    translator.Push(L, default(PF.Guid));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PF.Guid constructor!");
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<PF.Guid>(L, 1) && translator.Assignable<PF.Guid>(L, 2))
				{
					PF.Guid leftside;translator.Get(L, 1, out leftside);
					PF.Guid rightside;translator.Get(L, 2, out rightside);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need PF.Guid!");
		    ...
		    try {
                ...
                
                {
                    string _input = LuaAPI.lua_tostring(L, 1);
                        ...
                        PF.Guid gen_ret = PF.Guid.Parse( _input );
                        translator.Push(L, gen_ret);
        ...
        static int _m_NewGuid_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        PF.Guid gen_ret = PF.Guid.NewGuid(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    object __rhs = translator.GetObject(L, 2, typeof(object));
                    
                        bool gen_ret = gen_to_be_invoked.Equals( __rhs );
