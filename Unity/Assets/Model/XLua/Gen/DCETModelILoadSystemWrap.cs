...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelILoadSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ILoadSystem);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.ILoadSystem does not have a constructor!");
        }
        ...
        static int _m_Type(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.ILoadSystem gen_to_be_invoked = (DCET.Model.ILoadSystem)translator.FastGetCSObj(L, 1);
