		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<PF.SerializeSettings>(L, 2)) 
                {
                    PF.SerializeSettings _settings = (PF.SerializeSettings)translator.GetObject(L, 2, typeof(PF.SerializeSettings));
                        ...
                        byte[] gen_ret = gen_to_be_invoked.SerializeGraphs( _settings );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<PF.SerializeSettings>(L, 2)) 
                {
                    ...
                    uint _checksum;
                        ...
                        byte[] gen_ret = gen_to_be_invoked.SerializeGraphs( _settings, out _checksum );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        PF.NavGraph gen_ret = gen_to_be_invoked.AddGraph( _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    PF.NavGraph _graph = (PF.NavGraph)translator.GetObject(L, 2, typeof(PF.NavGraph));
                        ...
                        bool gen_ret = gen_to_be_invoked.RemoveGraph( _graph );
		    ...
		    try {
                ...
                
                {
                    System.Func<PF.NavGraph, bool> _predicate = translator.GetDelegate<System.Func<PF.NavGraph, bool>>(L, 2);
                        ...
                        PF.NavGraph gen_ret = gen_to_be_invoked.FindGraph( _predicate );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        PF.NavGraph gen_ret = gen_to_be_invoked.FindGraphOfType( _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        PF.NavGraph gen_ret = gen_to_be_invoked.FindGraphWhichInheritsFrom( _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        System.Collections.IEnumerable gen_ret = gen_to_be_invoked.FindGraphsOfType( _type );
		    ...
		    try {
                ...
                
                {
                    PF.NavGraph _graph = (PF.NavGraph)translator.GetObject(L, 2, typeof(PF.NavGraph));
                        ...
                        int gen_ret = gen_to_be_invoked.GetGraphIndex( _graph );
