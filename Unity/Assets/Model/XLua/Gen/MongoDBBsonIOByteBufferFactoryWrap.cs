...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOByteBufferFactoryWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.ByteBufferFactory);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.IO.ByteBufferFactory does not have a constructor!");
        }
