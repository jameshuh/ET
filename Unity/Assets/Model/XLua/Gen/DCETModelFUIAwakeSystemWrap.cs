...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelFUIAwakeSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.FUIAwakeSystem);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.FUIAwakeSystem gen_ret = new DCET.Model.FUIAwakeSystem();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.FUIAwakeSystem constructor!");
