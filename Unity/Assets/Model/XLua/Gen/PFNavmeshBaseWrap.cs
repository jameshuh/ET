...
namespace XLua.CSObjectWrap
{
    ...
    public class PFNavmeshBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 21, 12, 10);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _z = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        PF.NavmeshTile gen_ret = gen_to_be_invoked.GetTile( _x, _z );
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        PF.Int3 gen_ret = gen_to_be_invoked.GetVertex( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        PF.Int3 gen_ret = gen_to_be_invoked.GetVertexInGraphSpace( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        int gen_ret = PF.NavmeshBase.GetTileIndex( _index );
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        PF.Int2 gen_ret = gen_to_be_invoked.GetTileCoordinates( _position );
                        translator.Push(L, gen_ret);
        ...
        static int _m_CreateNodeConnections_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    PF.NavmeshBase.CreateNodeConnections( _nodes );
        ...
        static int _m_ConnectTiles(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ConnectTiles( _tile1, _tile2 );
        ...
        static int _m_CreateNodes(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.CreateNodes( _buffer, _tris, _tileIndex, _graphIndex );
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Vector3>(L, 3)) 
                {
                    ...
                    UnityEngine.Vector3 _end;translator.Get(L, 3, out _end);
                        ...
                        bool gen_ret = gen_to_be_invoked.Linecast( _origin, _end );
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& translator.Assignable<PF.GraphNode>(L, 4)) 
                {
                    ...
                    PF.GraphNode _hint = (PF.GraphNode)translator.GetObject(L, 4, typeof(PF.GraphNode));
                        ...
                        bool gen_ret = gen_to_be_invoked.Linecast( _origin, _end, _hint );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& translator.Assignable<PF.GraphNode>(L, 4)) 
                {
                    ...
                    PF.GraphHitInfo _hit;
                        ...
                        bool gen_ret = gen_to_be_invoked.Linecast( _origin, _end, _hint, out _hit );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& translator.Assignable<PF.GraphNode>(L, 4)&& translator.Assignable<System.Collections.Generic.List<PF.GraphNode>>(L, 5)) 
                {
                    ...
                    System.Collections.Generic.List<PF.GraphNode> _trace = (System.Collections.Generic.List<PF.GraphNode>)translator.GetObject(L, 5, typeof(System.Collections.Generic.List<PF.GraphNode>));
                        ...
                        bool gen_ret = gen_to_be_invoked.Linecast( _origin, _end, _hint, out _hit, _trace );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                    translator.Push(L, _hit);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<PF.NavmeshBase>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& translator.Assignable<PF.GraphNode>(L, 4)) 
                {
                    ...
                    PF.GraphHitInfo _hit;
                        ...
                        bool gen_ret = PF.NavmeshBase.Linecast( _graph, _origin, _end, _hint, out _hit );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                    translator.Push(L, _hit);
                ...
                if(gen_param_count == 5&& translator.Assignable<PF.NavmeshBase>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& translator.Assignable<PF.GraphNode>(L, 4)&& translator.Assignable<System.Collections.Generic.List<PF.GraphNode>>(L, 5)) 
                {
                    ...
                    System.Collections.Generic.List<PF.GraphNode> _trace = (System.Collections.Generic.List<PF.GraphNode>)translator.GetObject(L, 5, typeof(System.Collections.Generic.List<PF.GraphNode>));
                        ...
                        bool gen_ret = PF.NavmeshBase.Linecast( _graph, _origin, _end, _hint, out _hit, _trace );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                    translator.Push(L, _hit);
		    ...
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    int _depth = LuaAPI.xlua_tointeger(L, 5);
                        ...
                        UnityEngine.Bounds gen_ret = gen_to_be_invoked.GetTileBounds( _x, _z, _width, _depth );
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    int _width = LuaAPI.xlua_tointeger(L, 4);
                        ...
                        UnityEngine.Bounds gen_ret = gen_to_be_invoked.GetTileBounds( _x, _z, _width );
                        translator.PushUnityEngineBounds(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _z = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        UnityEngine.Bounds gen_ret = gen_to_be_invoked.GetTileBounds( _x, _z );
                        translator.PushUnityEngineBounds(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<PF.IntRect>(L, 2)) 
                {
                    PF.IntRect _rect;translator.Get(L, 2, out _rect);
                    
                        UnityEngine.Bounds gen_ret = gen_to_be_invoked.GetTileBounds( _rect );
                        translator.PushUnityEngineBounds(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    int _depth = LuaAPI.xlua_tointeger(L, 5);
                        ...
                        UnityEngine.Bounds gen_ret = gen_to_be_invoked.GetTileBoundsInGraphSpace( _x, _z, _width, _depth );
                        translator.PushUnityEngineBounds(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    int _width = LuaAPI.xlua_tointeger(L, 4);
                        ...
                        UnityEngine.Bounds gen_ret = gen_to_be_invoked.GetTileBoundsInGraphSpace( _x, _z, _width );
                        translator.PushUnityEngineBounds(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _z = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        UnityEngine.Bounds gen_ret = gen_to_be_invoked.GetTileBoundsInGraphSpace( _x, _z );
                        translator.PushUnityEngineBounds(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<PF.IntRect>(L, 2)) 
                {
                    PF.IntRect _rect;translator.Get(L, 2, out _rect);
                        ...
                        UnityEngine.Bounds gen_ret = gen_to_be_invoked.GetTileBoundsInGraphSpace( _rect );
                        translator.PushUnityEngineBounds(L, gen_ret);
        ...
        static int _m_OnDrawGizmos(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnDrawGizmos( _gizmos, _drawNodes );
        ...
        static int _m_CreateNavmeshSurfaceVisualization(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.CreateNavmeshSurfaceVisualization( _tile, _helper );
        ...
        static int _m_DrawUnwalkableNodes(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DrawUnwalkableNodes( _size );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Bounds _bounds;translator.Get(L, 2, out _bounds);
                        ...
                        PF.IntRect gen_ret = gen_to_be_invoked.GetTouchingTiles( _bounds );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Rect _rect;translator.Get(L, 2, out _rect);
                        ...
                        PF.IntRect gen_ret = gen_to_be_invoked.GetTouchingTilesInGraphSpace( _rect );
                        translator.Push(L, gen_ret);
