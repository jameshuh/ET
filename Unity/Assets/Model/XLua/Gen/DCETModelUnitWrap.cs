...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelUnitWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.Unit);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.Unit gen_ret = new DCET.Model.Unit();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.Unit constructor!");
        ...
        static int _m_Awake(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.Unit gen_to_be_invoked = (DCET.Model.Unit)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.Awake( _gameObject );
