...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOBsonWriterSettingsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.BsonWriterSettings);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "MaxSerializationDepth", _g_get_MaxSerializationDepth);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "GuidRepresentation", _s_set_GuidRepresentation);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "MaxSerializationDepth", _s_set_MaxSerializationDepth);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.IO.BsonWriterSettings does not have a constructor!");
        }
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        MongoDB.Bson.IO.BsonWriterSettings gen_ret = gen_to_be_invoked.Clone(  );
        ...
        static int _m_FrozenCopy(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        MongoDB.Bson.IO.BsonWriterSettings gen_ret = gen_to_be_invoked.FrozenCopy(  );
                        translator.Push(L, gen_ret);
        ...
        static int _g_get_MaxSerializationDepth(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.IO.BsonWriterSettings gen_to_be_invoked = (MongoDB.Bson.IO.BsonWriterSettings)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.MaxSerializationDepth);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
