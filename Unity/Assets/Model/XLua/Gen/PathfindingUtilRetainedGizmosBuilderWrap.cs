        ...
        static int _m_DrawMesh(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DrawMesh( _gizmos, _vertices, _triangles, _colors );
        ...
        static int _m_DrawWireCube(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DrawWireCube( _tr, _bounds, _color );
        ...
        static int _m_DrawLine(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DrawLine( _start, _end, _color );
        ...
        static int _m_Submit(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Submit( _gizmos, _hasher );
