...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelCircularBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.CircularBuffer);
			Utils.BeginObjectRegister(type, L, translator, 0, 9, 10, 4);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.CircularBuffer gen_ret = new DCET.Model.CircularBuffer();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.CircularBuffer constructor!");
        ...
        static int _m_AddLast(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.CircularBuffer gen_to_be_invoked = (DCET.Model.CircularBuffer)translator.FastGetCSObj(L, 1);
		    ...
		    try {
                ...
                
                {
                    System.IO.Stream _stream = (System.IO.Stream)translator.GetObject(L, 2, typeof(System.IO.Stream));
                        ...
                        DCET.Model.ETTask gen_ret = gen_to_be_invoked.ReadAsync( _stream );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Read(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<System.IO.Stream>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.Read( _stream, _count );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.CircularBuffer.Read!");
        ...
        static int _m_Write(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.IO.Stream>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.Write( _stream );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.CircularBuffer.Write!");
		    ...
		    try {
                ...
                
                {
                    System.IO.Stream _stream = (System.IO.Stream)translator.GetObject(L, 2, typeof(System.IO.Stream));
                        ...
                        DCET.Model.ETTask<int> gen_ret = gen_to_be_invoked.WriteAsync( _stream );
                        translator.Push(L, gen_ret);
