...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelPathHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.PathHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.PathHelper does not have a constructor!");
        }
        ...
        static int _g_get_AppHotfixResPath(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushstring(L, DCET.Model.PathHelper.AppHotfixResPath);
        ...
        static int _g_get_AppResPath(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushstring(L, DCET.Model.PathHelper.AppResPath);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_AppResPath4Web(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushstring(L, DCET.Model.PathHelper.AppResPath4Web);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
