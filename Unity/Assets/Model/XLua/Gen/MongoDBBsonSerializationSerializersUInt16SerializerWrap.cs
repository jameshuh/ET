...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonSerializationSerializersUInt16SerializerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.Serialization.Serializers.UInt16Serializer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MongoDB.Bson.Serialization.Serializers.UInt16Serializer gen_ret = new MongoDB.Bson.Serialization.Serializers.UInt16Serializer();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.BsonType>(L, 2))
				{
					...
					MongoDB.Bson.Serialization.Serializers.UInt16Serializer gen_ret = new MongoDB.Bson.Serialization.Serializers.UInt16Serializer(_representation);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<MongoDB.Bson.BsonType>(L, 2) && translator.Assignable<MongoDB.Bson.Serialization.Options.RepresentationConverter>(L, 3))
				{
					...
					MongoDB.Bson.Serialization.Serializers.UInt16Serializer gen_ret = new MongoDB.Bson.Serialization.Serializers.UInt16Serializer(_representation, _converter);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.Serialization.Serializers.UInt16Serializer constructor!");
        ...
        static int _m_Deserialize(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.Serialization.Serializers.UInt16Serializer gen_to_be_invoked = (MongoDB.Bson.Serialization.Serializers.UInt16Serializer)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    MongoDB.Bson.Serialization.BsonDeserializationArgs _args;translator.Get(L, 3, out _args);
                        ...
                        ushort gen_ret = gen_to_be_invoked.Deserialize( _context, _args );
        ...
        static int _m_Serialize(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    ushort _value = (ushort)LuaAPI.xlua_tointeger(L, 4);
		    ...
		    try {
                ...
                
                {
                    MongoDB.Bson.Serialization.Options.RepresentationConverter _converter = (MongoDB.Bson.Serialization.Options.RepresentationConverter)translator.GetObject(L, 2, typeof(MongoDB.Bson.Serialization.Options.RepresentationConverter));
                        ...
                        MongoDB.Bson.Serialization.Serializers.UInt16Serializer gen_ret = gen_to_be_invoked.WithConverter( _converter );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    MongoDB.Bson.BsonType _representation;translator.Get(L, 2, out _representation);
                        ...
                        MongoDB.Bson.Serialization.Serializers.UInt16Serializer gen_ret = gen_to_be_invoked.WithRepresentation( _representation );
                        translator.Push(L, gen_ret);
