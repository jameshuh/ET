...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOBsonBinaryReaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.BsonBinaryReader);
			Utils.BeginObjectRegister(type, L, translator, 0, 33, 2, 0);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "BsonStream", _g_get_BsonStream);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.IO.Stream>(L, 2))
				{
					...
					MongoDB.Bson.IO.BsonBinaryReader gen_ret = new MongoDB.Bson.IO.BsonBinaryReader(_stream);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.IO.Stream>(L, 2) && translator.Assignable<MongoDB.Bson.IO.BsonBinaryReaderSettings>(L, 3))
				{
					System.IO.Stream _stream = (System.IO.Stream)translator.GetObject(L, 2, typeof(System.IO.Stream));
					MongoDB.Bson.IO.BsonBinaryReaderSettings _settings = (MongoDB.Bson.IO.BsonBinaryReaderSettings)translator.GetObject(L, 3, typeof(MongoDB.Bson.IO.BsonBinaryReaderSettings));
					
					MongoDB.Bson.IO.BsonBinaryReader gen_ret = new MongoDB.Bson.IO.BsonBinaryReader(_stream, _settings);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.IO.BsonBinaryReader constructor!");
        ...
        static int _m_Close(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.IO.BsonBinaryReader gen_to_be_invoked = (MongoDB.Bson.IO.BsonBinaryReader)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_BsonStream(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                MongoDB.Bson.IO.BsonBinaryReader gen_to_be_invoked = (MongoDB.Bson.IO.BsonBinaryReader)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.BsonStream);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
