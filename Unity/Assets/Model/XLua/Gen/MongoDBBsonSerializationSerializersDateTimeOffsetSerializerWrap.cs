...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonSerializationSerializersDateTimeOffsetSerializerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.Serialization.Serializers.DateTimeOffsetSerializer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MongoDB.Bson.Serialization.Serializers.DateTimeOffsetSerializer gen_ret = new MongoDB.Bson.Serialization.Serializers.DateTimeOffsetSerializer();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<MongoDB.Bson.BsonType>(L, 2))
				{
					...
					MongoDB.Bson.Serialization.Serializers.DateTimeOffsetSerializer gen_ret = new MongoDB.Bson.Serialization.Serializers.DateTimeOffsetSerializer(_representation);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.Serialization.Serializers.DateTimeOffsetSerializer constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    MongoDB.Bson.Serialization.BsonDeserializationArgs _args;translator.Get(L, 3, out _args);
                        ...
                        System.DateTimeOffset gen_ret = gen_to_be_invoked.Deserialize( _context, _args );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Serialize(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.DateTimeOffset _value;translator.Get(L, 4, out _value);
