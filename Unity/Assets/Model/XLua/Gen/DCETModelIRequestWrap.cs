...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelIRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.IRequest);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.IRequest does not have a constructor!");
        }
        ...
        static int _g_get_RpcId(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.IRequest gen_to_be_invoked = (DCET.Model.IRequest)translator.FastGetCSObj(L, 1);
