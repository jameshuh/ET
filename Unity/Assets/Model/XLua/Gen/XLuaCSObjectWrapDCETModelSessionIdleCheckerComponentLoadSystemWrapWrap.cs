...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaCSObjectWrapDCETModelSessionIdleCheckerComponentLoadSystemWrapWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XLua.CSObjectWrap.DCETModelSessionIdleCheckerComponentLoadSystemWrap);
        ...
        static int _m___Register_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XLua.CSObjectWrap.DCETModelSessionIdleCheckerComponentLoadSystemWrap.__Register( _L );
