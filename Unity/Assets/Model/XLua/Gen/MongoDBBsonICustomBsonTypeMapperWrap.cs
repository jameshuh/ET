...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonICustomBsonTypeMapperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.ICustomBsonTypeMapper);
			Utils.BeginObjectRegister(type, L, translator, 0, 1, 0, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "TryMapToBsonValue", _m_TryMapToBsonValue);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.ICustomBsonTypeMapper does not have a constructor!");
        }
