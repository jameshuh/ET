...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelReferenceLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ReferenceLoader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.ReferenceLoader gen_ret = new DCET.Model.ReferenceLoader();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ReferenceLoader constructor!");
        ...
        static int _m_Init_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCET.Model.ReferenceLoader.Init( __object );
        ...
        static int _g_get_prefab(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.ReferenceLoader gen_to_be_invoked = (DCET.Model.ReferenceLoader)translator.FastGetCSObj(L, 1);
