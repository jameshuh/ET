...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 38, 97, 49);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "asGWindow", _m_asGWindow);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_asGWindow(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        DCET.Model.GWindow gen_ret = gen_to_be_invoked.asGWindow(  );
                        translator.Push(L, gen_ret);
