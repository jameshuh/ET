...
namespace XLua.CSObjectWrap
{
    ...
    public class PathfindingAdvancedSmoothTurnConstructorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 4, 9, 9);
        ...
        static int _m_Prepare(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Prepare( _i, _vectorPath );
        ...
        static int _m_TangentToPoint(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.TangentToPoint( _turnList );
        ...
        static int _m_GetPath(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetPath( _turn, _output );
        ...
        static int _m_Setup_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Pathfinding.AdvancedSmooth.TurnConstructor.Setup( _i, _vectorPath );
        ...
        static int _m_DebugCircleSegment(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DebugCircleSegment( _center, _startAngle, _endAngle, _radius, _color );
		    ...
		    try {
                ...
                
                {
                    ...
                    double _radius = LuaAPI.lua_tonumber(L, 3);
                        ...
                        double gen_ret = gen_to_be_invoked.GetLengthFromAngle( _angle, _radius );
		    ...
		    try {
                ...
                
                {
                    double _a = LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.AngleToVector( _a );
		    ...
		    try {
                ...
                
                {
                    double _rad = LuaAPI.lua_tonumber(L, 2);
                        ...
                        double gen_ret = gen_to_be_invoked.ToDegrees( _rad );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    double _a = LuaAPI.lua_tonumber(L, 2);
                        ...
                        double gen_ret = gen_to_be_invoked.ClampAngle( _a );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _v;translator.Get(L, 2, out _v);
                        ...
                        double gen_ret = gen_to_be_invoked.Atan2( _v );
                        LuaAPI.lua_pushnumber(L, gen_ret);
