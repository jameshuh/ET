...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelVersionConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.VersionConfig);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.VersionConfig gen_ret = new DCET.Model.VersionConfig();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.VersionConfig constructor!");
        ...
        static int _m_EndInit(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.VersionConfig gen_to_be_invoked = (DCET.Model.VersionConfig)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_FileInfoDict(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.VersionConfig gen_to_be_invoked = (DCET.Model.VersionConfig)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.FileInfoDict = (System.Collections.Generic.Dictionary<string, DCET.Model.FileVersionInfo>)translator.GetObject(L, 2, typeof(System.Collections.Generic.Dictionary<string, DCET.Model.FileVersionInfo>));
