...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelAsyncETVoidMethodBuilderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.AsyncETVoidMethodBuilder);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(DCET.Model.AsyncETVoidMethodBuilder));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.AsyncETVoidMethodBuilder constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        DCET.Model.AsyncETVoidMethodBuilder gen_ret = DCET.Model.AsyncETVoidMethodBuilder.Create(  );
