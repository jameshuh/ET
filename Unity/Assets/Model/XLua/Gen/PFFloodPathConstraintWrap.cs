...
namespace XLua.CSObjectWrap
{
    ...
    public class PFFloodPathConstraintWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PF.FloodPathConstraint);
        ...
        static int _m_Suitable(RealStatePtr L)
        {
		    try {
                ...
                PF.FloodPathConstraint gen_to_be_invoked = (PF.FloodPathConstraint)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    PF.GraphNode _node = (PF.GraphNode)translator.GetObject(L, 2, typeof(PF.GraphNode));
                        ...
                        bool gen_ret = gen_to_be_invoked.Suitable( _node );
