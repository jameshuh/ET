...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOIBsonChunkWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.IBsonChunk);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.IO.IBsonChunk does not have a constructor!");
        }
        ...
        static int _m_Fork(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.IO.IBsonChunk gen_to_be_invoked = (MongoDB.Bson.IO.IBsonChunk)translator.FastGetCSObj(L, 1);
