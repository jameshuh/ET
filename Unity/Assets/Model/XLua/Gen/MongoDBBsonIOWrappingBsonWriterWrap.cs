...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOWrappingBsonWriterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.WrappingBsonWriter);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.IO.WrappingBsonWriter does not have a constructor!");
        }
