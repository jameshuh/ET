...
namespace XLua.CSObjectWrap
{
    ...
    public class PathfindingRVORVOControllerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 6, 17, 13);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    float _deltaTime = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.CalculateMovementDelta( _deltaTime );
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _deltaTime = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.CalculateMovementDelta( _position, _deltaTime );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _p;translator.Get(L, 2, out _p);
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.To2D( _p );
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    ...
                    float _elevation;
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.To2D( _p, out _elevation );
                        translator.PushUnityEngineVector2(L, gen_ret);
