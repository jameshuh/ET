...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelM2C_TestResponseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.M2C_TestResponse);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "Response", _s_set_Response);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.M2C_TestResponse gen_ret = new DCET.Model.M2C_TestResponse();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.M2C_TestResponse constructor!");
        ...
        static int _m_WriteTo(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.M2C_TestResponse gen_to_be_invoked = (DCET.Model.M2C_TestResponse)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCET.Model.M2C_TestResponse.Parser);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_Response(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.M2C_TestResponse gen_to_be_invoked = (DCET.Model.M2C_TestResponse)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushstring(L, gen_to_be_invoked.Response);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_Response(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DCET.Model.M2C_TestResponse gen_to_be_invoked = (DCET.Model.M2C_TestResponse)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.Response = LuaAPI.lua_tostring(L, 2);
