...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelWaitSendBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.WaitSendBuffer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
					...
					DCET.Model.WaitSendBuffer gen_ret = new DCET.Model.WaitSendBuffer(_bytes, _length);
				...
				{
				    translator.Push(L, default(DCET.Model.WaitSendBuffer));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.WaitSendBuffer constructor!");
        ...
        static int _g_get_Bytes(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.WaitSendBuffer gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
