...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelETTaskWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ETTask);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<DCET.Model.IAwaiter>(L, 2))
				{
					DCET.Model.IAwaiter _awaiter = (DCET.Model.IAwaiter)translator.GetObject(L, 2, typeof(DCET.Model.IAwaiter));
					
					DCET.Model.ETTask gen_ret = new DCET.Model.ETTask(_awaiter);
				...
				{
				    translator.Push(L, default(DCET.Model.ETTask));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ETTask constructor!");
        ...
        static int _m_GetResult(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.ETTask gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _m_GetAwaiter(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        DCET.Model.ETTask.Awaiter gen_ret = gen_to_be_invoked.GetAwaiter(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    DCET.Model.ETTask _other;translator.Get(L, 2, out _other);
		    ...
		    try {
                ...
                
                {
                    System.Exception _ex = (System.Exception)translator.GetObject(L, 1, typeof(System.Exception));
                        ...
                        DCET.Model.ETTask gen_ret = DCET.Model.ETTask.FromException( _ex );
                        translator.Push(L, gen_ret);
        ...
        static int _m_FromCanceled_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 0) 
                {
                        ...
                        DCET.Model.ETTask gen_ret = DCET.Model.ETTask.FromCanceled(  );
                        translator.Push(L, gen_ret);
                ...
                {
                    System.Threading.CancellationToken _token;translator.Get(L, 1, out _token);
                    
                        DCET.Model.ETTask gen_ret = DCET.Model.ETTask.FromCanceled( _token );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ETTask.FromCanceled!");
        ...
        static int _g_get_CompletedTask(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCET.Model.ETTask.CompletedTask);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
