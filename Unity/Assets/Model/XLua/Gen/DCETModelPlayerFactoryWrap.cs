...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelPlayerFactoryWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.PlayerFactory);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.PlayerFactory does not have a constructor!");
        }
