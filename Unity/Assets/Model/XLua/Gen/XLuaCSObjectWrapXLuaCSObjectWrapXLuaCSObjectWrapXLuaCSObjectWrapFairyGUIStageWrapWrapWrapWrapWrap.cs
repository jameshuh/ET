...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaCSObjectWrapXLuaCSObjectWrapXLuaCSObjectWrapXLuaCSObjectWrapFairyGUIStageWrapWrapWrapWrapWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XLua.CSObjectWrap.XLuaCSObjectWrapXLuaCSObjectWrapXLuaCSObjectWrapFairyGUIStageWrapWrapWrapWrap);
        ...
        static int _m___Register_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    XLua.CSObjectWrap.XLuaCSObjectWrapXLuaCSObjectWrapXLuaCSObjectWrapFairyGUIStageWrapWrapWrapWrap.__Register( _L );
