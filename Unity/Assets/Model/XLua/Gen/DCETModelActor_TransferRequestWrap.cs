...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelActor_TransferRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.Actor_TransferRequest);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "MapIndex", _g_get_MapIndex);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "RpcId", _s_set_RpcId);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "ActorId", _s_set_ActorId);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "MapIndex", _s_set_MapIndex);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.Actor_TransferRequest gen_ret = new DCET.Model.Actor_TransferRequest();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.Actor_TransferRequest constructor!");
        ...
        static int _g_get_Parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCET.Model.Actor_TransferRequest.Parser);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_MapIndex(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DCET.Model.Actor_TransferRequest gen_to_be_invoked = (DCET.Model.Actor_TransferRequest)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.MapIndex);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_MapIndex(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DCET.Model.Actor_TransferRequest gen_to_be_invoked = (DCET.Model.Actor_TransferRequest)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.MapIndex = LuaAPI.xlua_tointeger(L, 2);
