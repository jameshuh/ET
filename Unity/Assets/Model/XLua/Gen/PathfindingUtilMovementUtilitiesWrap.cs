		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _forward;translator.Get(L, 5, out _forward);
                        ...
                        UnityEngine.Vector2 gen_ret = Pathfinding.Util.MovementUtilities.ClampVelocity( _velocity, _maxSpeed, _slowdownFactor, _slowWhenNotFacingTarget, _forward );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _forwardsVector;translator.Get(L, 7, out _forwardsVector);
                        ...
                        UnityEngine.Vector2 gen_ret = Pathfinding.Util.MovementUtilities.CalculateAccelerationToReachPoint( _deltaPosition, _targetVelocity, _currentVelocity, _forwardsAcceleration, _rotationSpeed, _maxSpeed, _forwardsVector );
                        translator.PushUnityEngineVector2(L, gen_ret);
