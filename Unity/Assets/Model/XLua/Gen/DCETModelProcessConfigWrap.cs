...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelProcessConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ProcessConfig);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.ProcessConfig gen_ret = new DCET.Model.ProcessConfig();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ProcessConfig constructor!");
        ...
        static int _g_get_ServerIP(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.ProcessConfig gen_to_be_invoked = (DCET.Model.ProcessConfig)translator.FastGetCSObj(L, 1);
