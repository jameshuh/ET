...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelActor_TransferResponseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.Actor_TransferResponse);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.Actor_TransferResponse gen_ret = new DCET.Model.Actor_TransferResponse();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.Actor_TransferResponse constructor!");
        ...
        static int _m_WriteTo(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.Actor_TransferResponse gen_to_be_invoked = (DCET.Model.Actor_TransferResponse)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Parser(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCET.Model.Actor_TransferResponse.Parser);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
