...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOBsonBinaryWriterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.BsonBinaryWriter);
			Utils.BeginObjectRegister(type, L, translator, 0, 27, 4, 0);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.IO.Stream>(L, 2))
				{
					...
					MongoDB.Bson.IO.BsonBinaryWriter gen_ret = new MongoDB.Bson.IO.BsonBinaryWriter(_stream);
					translator.Push(L, gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.IO.Stream>(L, 2) && translator.Assignable<MongoDB.Bson.IO.BsonBinaryWriterSettings>(L, 3))
				{
					System.IO.Stream _stream = (System.IO.Stream)translator.GetObject(L, 2, typeof(System.IO.Stream));
					MongoDB.Bson.IO.BsonBinaryWriterSettings _settings = (MongoDB.Bson.IO.BsonBinaryWriterSettings)translator.GetObject(L, 3, typeof(MongoDB.Bson.IO.BsonBinaryWriterSettings));
					
					MongoDB.Bson.IO.BsonBinaryWriter gen_ret = new MongoDB.Bson.IO.BsonBinaryWriter(_stream, _settings);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.IO.BsonBinaryWriter constructor!");
