...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelGizmosDebugWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.GizmosDebug);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCET.Model.GizmosDebug gen_ret = new DCET.Model.GizmosDebug();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.GizmosDebug constructor!");
        ...
        static int _g_get_Instance(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCET.Model.GizmosDebug.Instance);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_Path(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.GizmosDebug gen_to_be_invoked = (DCET.Model.GizmosDebug)translator.FastGetCSObj(L, 1);
