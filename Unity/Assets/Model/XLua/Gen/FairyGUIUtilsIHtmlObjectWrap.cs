...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsIHtmlObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.Utils.IHtmlObject);
        ...
        {
            return LuaAPI.luaL_error(L, "FairyGUI.Utils.IHtmlObject does not have a constructor!");
        }
        ...
        static int _m_Create(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Utils.IHtmlObject gen_to_be_invoked = (FairyGUI.Utils.IHtmlObject)translator.FastGetCSObj(L, 1);
