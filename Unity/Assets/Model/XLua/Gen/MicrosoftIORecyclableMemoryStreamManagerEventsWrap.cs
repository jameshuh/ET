        ...
        static int _m_MemoryStreamCreated(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamCreated( _guid, _tag, _requestedSize );
        ...
        static int _m_MemoryStreamDisposed(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamDisposed( _guid, _tag );
        ...
        static int _m_MemoryStreamDoubleDispose(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamDoubleDispose( _guid, _tag, _allocationStack, _disposeStack1, _disposeStack2 );
        ...
        static int _m_MemoryStreamFinalized(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamFinalized( _guid, _tag, _allocationStack );
        ...
        static int _m_MemoryStreamToArray(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamToArray( _guid, _tag, _stack, _size );
        ...
        static int _m_MemoryStreamManagerInitialized(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamManagerInitialized( _blockSize, _largeBufferMultiple, _maximumBufferSize );
        ...
        static int _m_MemoryStreamNewLargeBufferCreated(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamNewLargeBufferCreated( _requiredSize, _largePoolInUseBytes );
        ...
        static int _m_MemoryStreamNonPooledLargeBufferCreated(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamNonPooledLargeBufferCreated( _requiredSize, _tag, _allocationStack );
        ...
        static int _m_MemoryStreamDiscardBuffer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamDiscardBuffer( _bufferType, _tag, _reason );
        ...
        static int _m_MemoryStreamOverCapacity(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.MemoryStreamOverCapacity( _requestedCapacity, _maxCapacity, _tag, _allocationStack );
