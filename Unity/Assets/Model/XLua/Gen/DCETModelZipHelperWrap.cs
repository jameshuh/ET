...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelZipHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.ZipHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "DCET.Model.ZipHelper does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    byte[] _content = LuaAPI.lua_tobytes(L, 1);
                        ...
                        byte[] gen_ret = DCET.Model.ZipHelper.Compress( _content );
        ...
        static int _m_Decompress_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _content = LuaAPI.lua_tobytes(L, 1);
                        ...
                        byte[] gen_ret = DCET.Model.ZipHelper.Decompress( _content );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    int _count = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        byte[] gen_ret = DCET.Model.ZipHelper.Decompress( _content, _offset, _count );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.ZipHelper.Decompress!");
