...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETModelAsyncETTaskMethodBuilderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCET.Model.AsyncETTaskMethodBuilder);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(DCET.Model.AsyncETTaskMethodBuilder));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCET.Model.AsyncETTaskMethodBuilder constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        DCET.Model.AsyncETTaskMethodBuilder gen_ret = DCET.Model.AsyncETTaskMethodBuilder.Create(  );
        ...
        static int _m_SetException(RealStatePtr L)
        {
		    try {
                ...
                DCET.Model.AsyncETTaskMethodBuilder gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
