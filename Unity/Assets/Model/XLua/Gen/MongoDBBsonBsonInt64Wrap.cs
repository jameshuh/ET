...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonBsonInt64Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.BsonInt64);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) || LuaAPI.lua_isint64(L, 2)))
				{
					...
					MongoDB.Bson.BsonInt64 gen_ret = new MongoDB.Bson.BsonInt64(_value);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonInt64 constructor!");
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<MongoDB.Bson.BsonInt64>(L, 1) && translator.Assignable<MongoDB.Bson.BsonInt64>(L, 2))
				{
					MongoDB.Bson.BsonInt64 leftside = (MongoDB.Bson.BsonInt64)translator.GetObject(L, 1, typeof(MongoDB.Bson.BsonInt64));
					MongoDB.Bson.BsonInt64 rightside = (MongoDB.Bson.BsonInt64)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonInt64));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of == operator, need MongoDB.Bson.BsonInt64!");
		    ...
		    try {
                ...
                
                {
                    object _value = translator.GetObject(L, 1, typeof(object));
                        ...
                        MongoDB.Bson.BsonInt64 gen_ret = MongoDB.Bson.BsonInt64.Create( _value );
                        translator.Push(L, gen_ret);
        ...
        static int _m_CompareTo(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.BsonInt64 gen_to_be_invoked = (MongoDB.Bson.BsonInt64)translator.FastGetCSObj(L, 1);
            
            
			    int gen_param_count = LuaAPI.lua_gettop(L);
            
                if(gen_param_count == 2&& translator.Assignable<MongoDB.Bson.BsonInt64>(L, 2)) 
                {
                    MongoDB.Bson.BsonInt64 _other = (MongoDB.Bson.BsonInt64)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonInt64));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonInt64.CompareTo!");
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<MongoDB.Bson.BsonInt64>(L, 2)) 
                {
                    MongoDB.Bson.BsonInt64 _rhs = (MongoDB.Bson.BsonInt64)translator.GetObject(L, 2, typeof(MongoDB.Bson.BsonInt64));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MongoDB.Bson.BsonInt64.Equals!");
