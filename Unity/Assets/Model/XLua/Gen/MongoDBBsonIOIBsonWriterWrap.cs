...
namespace XLua.CSObjectWrap
{
    ...
    public class MongoDBBsonIOIBsonWriterWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MongoDB.Bson.IO.IBsonWriter);
			Utils.BeginObjectRegister(type, L, translator, 0, 32, 4, 0);
        ...
        {
            return LuaAPI.luaL_error(L, "MongoDB.Bson.IO.IBsonWriter does not have a constructor!");
        }
        ...
        static int _m_Close(RealStatePtr L)
        {
		    try {
                ...
                MongoDB.Bson.IO.IBsonWriter gen_to_be_invoked = (MongoDB.Bson.IO.IBsonWriter)translator.FastGetCSObj(L, 1);
