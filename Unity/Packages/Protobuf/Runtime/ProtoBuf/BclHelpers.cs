...
namespace ProtoBuf
{
	public static class BclHelpers
	{
		...
		public static void WriteDateTime(DateTime value, ProtoWriter dest)
		{
			...
			WireType wireType = dest.WireType;
			TimeSpan timeSpan = ((uint)(wireType - 2) > 1u) ? (value - EpochOrigin) : ((!(value == DateTime.MaxValue)) ? ((!(value == DateTime.MinValue)) ? (value - EpochOrigin) : TimeSpan.MinValue) : TimeSpan.MaxValue);
		...
		public static void WriteNetObject(object value, ProtoWriter dest, int key, NetObjectOptions options)
		{
			...
			{
				bool flag3;
				int value2 = dest.NetCache.AddObjectKey(value, out flag3);
				ProtoWriter.WriteFieldHeader(flag3 ? 1 : 2, WireType.Variant, dest);
			...
			if (flag2)
			{
				if (flag)
				{
					...
					bool flag4;
					int value3 = dest.NetCache.AddObjectKey(type, out flag4);
					ProtoWriter.WriteFieldHeader(flag4 ? 3 : 4, WireType.Variant, dest);
