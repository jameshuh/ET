...
namespace DCET.Hotfix {
  ...
  public partial class G2C_PlayerInfo : pb::IMessage {
    ...
    private global::DCET.Hotfix.PlayerInfo playerInfo_;
    public global::DCET.Hotfix.PlayerInfo PlayerInfo {
    ...
    private static readonly pb::FieldCodec<global::DCET.Hotfix.PlayerInfo> _repeated_playerInfos_codec
        = pb::FieldCodec.ForMessage(18, global::DCET.Hotfix.PlayerInfo.Parser);
    private pbc::RepeatedField<global::DCET.Hotfix.PlayerInfo> playerInfos_ = new pbc::RepeatedField<global::DCET.Hotfix.PlayerInfo>();
    public pbc::RepeatedField<global::DCET.Hotfix.PlayerInfo> PlayerInfos {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (playerInfo_ == null) {
              playerInfo_ = new global::DCET.Hotfix.PlayerInfo();
            }
