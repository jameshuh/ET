...
{
	public static string saveDir = Path.Combine(Application.dataPath, "../Packages/DCET.Lua/Runtime/ToLua/Source/Generate/");
	public static string toluaBaseType = Path.Combine(Application.dataPath, "../Packages/DCET.Lua/Runtime/ToLua/BaseType/");
	public static string baseLuaDir = Path.Combine(Application.dataPath, "../Packages/DCET.Lua/Runtime/Tolua/Lua/");
	public static string injectionFilesPath = Path.Combine(Application.dataPath, "../Packages/DCET.Lua/Runtime/ToLua/Injection/");
	...
	public static BindType[] customTypeList
	{
		get
		{
			var result = new Dictionary<Type, BindType>();

			foreach (var item in customTypeList_)
			{
