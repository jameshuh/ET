...
{
    public static string luaDir = Application.dataPath + "/Res/Lua";                //lua逻辑代码目录
    public static string toluaDir = Path.Combine( Application.dataPath, "../Packages/DCET.Lua/Runtime/ToLua/Lua");        //tolua lua文件目录
    public static string toluaPackageDir = "Packages/com.dukechiang.dcet.lua/Runtime/ToLua/Lua";        //tolua lua文件目录
