...
public class FairyGUI_NTextureWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getoriginalSize", get_originalSize);
		...
		L.RegFunction("getnativeTexture", get_nativeTexture);
		L.RegVar("alphaTexture", get_alphaTexture, null);
		L.RegFunction("getalphaTexture", get_alphaTexture);
		L.EndClass();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DestroyMaterialManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
