...
public class DCETRuntime_PrefabLightmapData_MeshRendererLightmapDataWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCETRuntime.PrefabLightmapData.MeshRendererLightmapData), null);
		L.RegFunction("New", _CreateDCETRuntime_PrefabLightmapData_MeshRendererLightmapData);
	...
	static int _CreateDCETRuntime_PrefabLightmapData_MeshRendererLightmapData(IntPtr L)
	{
		DCETRuntime.PrefabLightmapData.MeshRendererLightmapData obj = new DCETRuntime.PrefabLightmapData.MeshRendererLightmapData();
	...
	static int get_renderer(IntPtr L)
	{
		...
		try
		{
			...
			DCETRuntime.PrefabLightmapData.MeshRendererLightmapData obj = (DCETRuntime.PrefabLightmapData.MeshRendererLightmapData)o;
	...
	static int __default__(IntPtr L)
	{
		try
		{
			var o = new DCETRuntime.PrefabLightmapData.MeshRendererLightmapData();
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int __clone__(IntPtr L)
	{
		try
		{
			...
			var obj = (DCETRuntime.PrefabLightmapData.MeshRendererLightmapData)ToLua.CheckObject(L, 1, typeof(DCETRuntime.PrefabLightmapData.MeshRendererLightmapData));
			var o = obj;
			ToLua.PushValue(L, o);
			ToLua.SetBack(L, 1, obj);
			return 1;
