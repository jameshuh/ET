...
public class DCET_Runtime_PathHelperWrap
{
	...
	static int get_AppHotfixResPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, DCET.Runtime.PathHelper.AppHotfixResPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_AppResPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, DCET.Runtime.PathHelper.AppResPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_AppResPath4Web(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, DCET.Runtime.PathHelper.AppResPath4Web);
			return 1;
		}
		catch (Exception e)
		{
