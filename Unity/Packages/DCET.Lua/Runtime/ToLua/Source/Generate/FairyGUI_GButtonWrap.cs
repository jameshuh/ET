...
public class FairyGUI_GButtonWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getpageOption", get_pageOption);
		...
		L.RegFunction("getselectedIcon", get_selectedIcon);
		L.RegFunction("setselectedIcon", set_selectedIcon);
		L.RegVar("selectedTitle", get_selectedTitle, set_selectedTitle);
		L.RegFunction("getselectedTitle", get_selectedTitle);
		L.RegFunction("setselectedTitle", set_selectedTitle);
		...
		L.RegFunction("getselected", get_selected);
		L.RegFunction("setselected", set_selected);
		L.RegVar("mode", get_mode, set_mode);
		L.RegFunction("getmode", get_mode);
		L.RegFunction("setmode", set_mode);
		L.RegVar("relatedController", get_relatedController, set_relatedController);
		L.RegFunction("getrelatedController", get_relatedController);
		L.RegFunction("setrelatedController", set_relatedController);
		L.EndClass();
	}
	...
	static int set_mode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			FairyGUI.GButton obj = (FairyGUI.GButton)o;
			FairyGUI.ButtonMode arg0 = (FairyGUI.ButtonMode)LuaDLL.luaL_checknumber(L, 2);
			obj.mode = arg0;
			return 0;
		}
		catch(Exception e)
