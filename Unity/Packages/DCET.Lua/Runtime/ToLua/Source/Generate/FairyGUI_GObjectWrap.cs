...
public class FairyGUI_GObjectWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getrelations", get_relations);
		...
		L.RegFunction("getdraggingObject", get_draggingObject);
		...
		L.RegFunction("getonPositionChanged", get_onPositionChanged);
		L.RegVar("onSizeChanged", get_onSizeChanged, null);
		L.RegFunction("getonSizeChanged", get_onSizeChanged);
		L.RegVar("onDragStart", get_onDragStart, null);
		L.RegFunction("getonDragStart", get_onDragStart);
		L.RegVar("onDragMove", get_onDragMove, null);
		L.RegFunction("getonDragMove", get_onDragMove);
		L.RegVar("onDragEnd", get_onDragEnd, null);
		L.RegFunction("getonDragEnd", get_onDragEnd);
		L.RegVar("onGearStop", get_onGearStop, null);
		L.RegFunction("getonGearStop", get_onGearStop);
		...
		L.RegFunction("getpixelSnapping", get_pixelSnapping);
		L.RegFunction("setpixelSnapping", set_pixelSnapping);
		...
		L.RegFunction("getactualWidth", get_actualWidth);
		L.RegVar("actualHeight", get_actualHeight, null);
		L.RegFunction("getactualHeight", get_actualHeight);
		L.RegVar("xMin", get_xMin, set_xMin);
		L.RegFunction("getxMin", get_xMin);
		L.RegFunction("setxMin", set_xMin);
		L.RegVar("yMin", get_yMin, set_yMin);
		L.RegFunction("getyMin", get_yMin);
		L.RegFunction("setyMin", set_yMin);
		...
		L.RegFunction("getpivotX", get_pivotX);
		L.RegFunction("setpivotX", set_pivotX);
		L.RegVar("pivotY", get_pivotY, set_pivotY);
		L.RegFunction("getpivotY", get_pivotY);
		L.RegFunction("setpivotY", set_pivotY);
		...
		L.RegFunction("getpivotAsAnchor", get_pivotAsAnchor);
		L.RegFunction("setpivotAsAnchor", set_pivotAsAnchor);
		...
		L.RegFunction("getfocusable", get_focusable);
		L.RegFunction("setfocusable", set_focusable);
		L.RegVar("focused", get_focused, null);
		L.RegFunction("getfocused", get_focused);
		L.RegVar("tooltips", get_tooltips, set_tooltips);
		L.RegFunction("gettooltips", get_tooltips);
		L.RegFunction("settooltips", set_tooltips);
		...
		L.RegFunction("getgameObjectName", get_gameObjectName);
		L.RegFunction("setgameObjectName", set_gameObjectName);
		L.RegVar("inContainer", get_inContainer, null);
		L.RegFunction("getinContainer", get_inContainer);
		L.RegVar("onStage", get_onStage, null);
		L.RegFunction("getonStage", get_onStage);
		L.RegVar("resourceURL", get_resourceURL, null);
		L.RegFunction("getresourceURL", get_resourceURL);
		L.RegVar("gearXY", get_gearXY, null);
		L.RegFunction("getgearXY", get_gearXY);
		L.RegVar("gearSize", get_gearSize, null);
		L.RegFunction("getgearSize", get_gearSize);
		L.RegVar("gearLook", get_gearLook, null);
		L.RegFunction("getgearLook", get_gearLook);
		...
		L.RegFunction("getdraggable", get_draggable);
		L.RegFunction("setdraggable", set_draggable);
		L.RegVar("dragging", get_dragging, null);
		L.RegFunction("getdragging", get_dragging);
		L.RegVar("isDisposed", get_isDisposed, null);
		L.RegFunction("getisDisposed", get_isDisposed);
		L.RegVar("asImage", get_asImage, null);
		L.RegFunction("getasImage", get_asImage);
		L.RegVar("asCom", get_asCom, null);
		L.RegFunction("getasCom", get_asCom);
		L.RegVar("asButton", get_asButton, null);
		L.RegFunction("getasButton", get_asButton);
		L.RegVar("asLabel", get_asLabel, null);
		L.RegFunction("getasLabel", get_asLabel);
		L.RegVar("asProgress", get_asProgress, null);
		L.RegFunction("getasProgress", get_asProgress);
		L.RegVar("asSlider", get_asSlider, null);
		L.RegFunction("getasSlider", get_asSlider);
		L.RegVar("asComboBox", get_asComboBox, null);
		L.RegFunction("getasComboBox", get_asComboBox);
		L.RegVar("asTextField", get_asTextField, null);
		L.RegFunction("getasTextField", get_asTextField);
		L.RegVar("asRichTextField", get_asRichTextField, null);
		L.RegFunction("getasRichTextField", get_asRichTextField);
		L.RegVar("asTextInput", get_asTextInput, null);
		L.RegFunction("getasTextInput", get_asTextInput);
		L.RegVar("asLoader", get_asLoader, null);
		L.RegFunction("getasLoader", get_asLoader);
		L.RegVar("asList", get_asList, null);
		L.RegFunction("getasList", get_asList);
		L.RegVar("asGraph", get_asGraph, null);
		L.RegFunction("getasGraph", get_asGraph);
		L.RegVar("asGroup", get_asGroup, null);
		L.RegFunction("getasGroup", get_asGroup);
		L.RegVar("asMovieClip", get_asMovieClip, null);
		L.RegFunction("getasMovieClip", get_asMovieClip);
		L.EndClass();
	}
	...
	static int AddRelation(IntPtr L)
	{
		try
		{
			...
			if (count == 3)
			{
				FairyGUI.GObject obj = (FairyGUI.GObject)ToLua.CheckObject<FairyGUI.GObject>(L, 1);
				FairyGUI.GObject arg0 = (FairyGUI.GObject)ToLua.CheckObject<FairyGUI.GObject>(L, 2);
				FairyGUI.RelationType arg1 = (FairyGUI.RelationType)LuaDLL.luaL_checknumber(L, 3);
