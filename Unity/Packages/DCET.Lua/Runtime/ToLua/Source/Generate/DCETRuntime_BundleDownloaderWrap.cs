...
public class DCETRuntime_BundleDownloaderWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCETRuntime.BundleDownloader), typeof(System.Object));
		L.RegFunction("Dispose", Dispose);
		L.RegFunction("StartAsync", StartAsync);
		L.RegFunction("GetBundleMD5", GetBundleMD5);
		L.RegFunction("DownloadAsync", DownloadAsync);
		L.RegFunction("New", _CreateDCETRuntime_BundleDownloader);
	...
	static int _CreateDCETRuntime_BundleDownloader(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				DCETRuntime.BundleDownloader obj = new DCETRuntime.BundleDownloader();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: DCETRuntime.BundleDownloader.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Dispose(IntPtr L)
	{
		try
		{
			...
			DCETRuntime.BundleDownloader obj = (DCETRuntime.BundleDownloader)ToLua.CheckObject<DCETRuntime.BundleDownloader>(L, 1);
			obj.Dispose();
			return 0;
		}
		catch (Exception e)
	...
	static int GetBundleMD5(IntPtr L)
	{
		try
		{
			...
			DCETRuntime.VersionConfig arg0 = (DCETRuntime.VersionConfig)ToLua.CheckObject<DCETRuntime.VersionConfig>(L, 1);
			string arg1 = ToLua.CheckString(L, 2);
			string o = DCETRuntime.BundleDownloader.GetBundleMD5(arg0, arg1);
	...
	static int get_bundles(IntPtr L)
	{
		...
		try
		{
			...
			DCETRuntime.BundleDownloader obj = (DCETRuntime.BundleDownloader)o;
	...
	static int get_webRequest(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			DCETRuntime.BundleDownloader obj = (DCETRuntime.BundleDownloader)o;
			DCETRuntime.UnityWebRequestAsync ret = obj.webRequest;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_webRequest(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			DCETRuntime.BundleDownloader obj = (DCETRuntime.BundleDownloader)o;
			DCETRuntime.UnityWebRequestAsync arg0 = (DCETRuntime.UnityWebRequestAsync)ToLua.CheckObject<DCETRuntime.UnityWebRequestAsync>(L, 2);
			obj.webRequest = arg0;
			return 0;
		}
		catch(Exception e)
