...
public class PF_Int3Wrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(PF.Int3), null);
		...
		L.RegFunction("New", _CreatePF_Int3);
		...
		L.RegFunction("getmagnitude", get_magnitude);
		L.RegVar("costMagnitude", get_costMagnitude, null);
		L.RegFunction("getcostMagnitude", get_costMagnitude);
		L.RegVar("sqrMagnitude", get_sqrMagnitude, null);
		L.RegFunction("getsqrMagnitude", get_sqrMagnitude);
	...
	static int _CreatePF_Int3(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				...
				PF.Int3 obj = new PF.Int3(arg0, arg1, arg2);
				ToLua.PushValue(L, obj);
				return 1;
			}
			else if (count == 0)
			{
				PF.Int3 obj = new PF.Int3();
				ToLua.PushValue(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: PF.Int3.New");
			}
		}
		catch (Exception e)
		{
	...
	static int _get_this(IntPtr L)
	{
		try
		{
			...
			PF.Int3 obj = (PF.Int3)ToLua.CheckObject(L, 1, typeof(PF.Int3));
	...
	static int Angle(IntPtr L)
	{
		try
		{
			...
			PF.Int3 arg0 = StackTraits<PF.Int3>.Check(L, 1);
			PF.Int3 arg1 = StackTraits<PF.Int3>.Check(L, 2);
			float o = PF.Int3.Angle(arg0, arg1);
	...
	static int DotLong(IntPtr L)
	{
		try
		{
			...
			PF.Int3 arg0 = StackTraits<PF.Int3>.Check(L, 1);
			PF.Int3 arg1 = StackTraits<PF.Int3>.Check(L, 2);
			long o = PF.Int3.DotLong(arg0, arg1);
	...
	static int Equals(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: PF.Int3.Equals");
			}
		}
		catch (Exception e)
		{
	...
	static int get_zero(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, PF.Int3.zero);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int __clone__(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			var obj = (PF.Int3)ToLua.CheckObject(L, 1, typeof(PF.Int3));
			var o = obj;
			ToLua.PushValue(L, o);
			ToLua.SetBack(L, 1, obj);
			return 1;
