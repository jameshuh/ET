...
public class FairyGUI_RichTextFieldWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("gethtmlPageContext", get_htmlPageContext);
		L.RegFunction("sethtmlPageContext", set_htmlPageContext);
		L.RegVar("htmlParseOptions", get_htmlParseOptions, null);
		L.RegFunction("gethtmlParseOptions", get_htmlParseOptions);
		L.RegVar("emojies", get_emojies, set_emojies);
		L.RegFunction("getemojies", get_emojies);
		L.RegFunction("setemojies", set_emojies);
		L.RegVar("textField", get_textField, null);
		L.RegFunction("gettextField", get_textField);
		...
		L.RegFunction("gethtmlElementCount", get_htmlElementCount);
		L.EndClass();
	}
