...
public class DCET_Runtime_MongoHelperWrap
{
	...
	static int LookupTypes(IntPtr L)
	{
		try
		{
			...
			DCET.Runtime.MongoHelper.LookupTypes(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int ToJson(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				...
				string o = DCET.Runtime.MongoHelper.ToJson(arg0);
			...
			else if (count == 2)
			{
				...
				string o = DCET.Runtime.MongoHelper.ToJson(arg0, arg1);
				LuaDLL.lua_pushstring(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DCET.Runtime.MongoHelper.ToJson");
			}
		}
		catch (Exception e)
		{
	...
	static int FromJson(IntPtr L)
	{
		try
		{
			...
			object o = DCET.Runtime.MongoHelper.FromJson(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int ToBson(IntPtr L)
	{
		try
		{
			...
			{
				object arg0 = ToLua.ToVarObject(L, 1);
				byte[] o = DCET.Runtime.MongoHelper.ToBson(arg0);
				ToLua.Push(L, o);
				return 1;
			}
			else if (count == 2)
			{
				...
				DCET.Runtime.MongoHelper.ToBson(arg0, arg1);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DCET.Runtime.MongoHelper.ToBson");
			}
		}
		catch (Exception e)
		{
	...
	static int FromBson(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<System.Type, byte[]>(L, 1))
			{
				...
				object o = DCET.Runtime.MongoHelper.FromBson(arg0, arg1);
				ToLua.Push(L, o);
				return 1;
			}
			...
			else if (count == 4 && TypeChecker.CheckTypes<System.Type, byte[], int, int>(L, 1))
			{
				...
				object o = DCET.Runtime.MongoHelper.FromBson(arg0, arg1, arg2, arg3);
				ToLua.Push(L, o);
				return 1;
			}
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DCET.Runtime.MongoHelper.FromBson");
			}
		}
		catch (Exception e)
		{
	...
	static int FromStream(IntPtr L)
	{
		try
		{
			...
			object o = DCET.Runtime.MongoHelper.FromStream(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int AvoidAOT(IntPtr L)
	{
		try
		{
			...
			DCET.Runtime.MongoHelper.AvoidAOT();
			return 0;
		}
		catch (Exception e)
		{
