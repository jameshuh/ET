...
public class FairyGUI_GRootWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getcontentScaleFactor", get_contentScaleFactor);
		L.RegVar("inst", get_inst, null);
		L.RegFunction("getinst", get_inst);
		L.RegVar("modalLayer", get_modalLayer, null);
		L.RegFunction("getmodalLayer", get_modalLayer);
		L.RegVar("hasModalWindow", get_hasModalWindow, null);
		L.RegFunction("gethasModalWindow", get_hasModalWindow);
		...
		L.RegFunction("gethasAnyPopup", get_hasAnyPopup);
	...
	static int SetContentScaleFactor(IntPtr L)
	{
		try
		{
			...
			else if (count == 4)
			{
				...
				int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
				int arg1 = (int)LuaDLL.luaL_checknumber(L, 3);
				FairyGUI.UIContentScaler.ScreenMatchMode arg2 = (FairyGUI.UIContentScaler.ScreenMatchMode)LuaDLL.luaL_checknumber(L, 4);
