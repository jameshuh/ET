...
public class DCETRuntime_GizmosDebugWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCETRuntime.GizmosDebug), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_Path(IntPtr L)
	{
		...
		try
		{
			...
			DCETRuntime.GizmosDebug obj = (DCETRuntime.GizmosDebug)o;
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.Push(L, DCETRuntime.GizmosDebug.Instance);
			return 1;
		}
		catch (Exception e)
		{
