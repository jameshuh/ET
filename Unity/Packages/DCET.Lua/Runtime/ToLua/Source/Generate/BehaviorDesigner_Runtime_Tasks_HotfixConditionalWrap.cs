...
public class BehaviorDesigner_Runtime_Tasks_HotfixConditionalWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(BehaviorDesigner.Runtime.Tasks.HotfixConditional), typeof(BehaviorDesigner.Runtime.Tasks.Conditional));
		...
		L.RegFunction("New", _CreateBehaviorDesigner_Runtime_Tasks_HotfixConditional);
	...
	static int _CreateBehaviorDesigner_Runtime_Tasks_HotfixConditional(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				BehaviorDesigner.Runtime.Tasks.HotfixConditional obj = new BehaviorDesigner.Runtime.Tasks.HotfixConditional();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: BehaviorDesigner.Runtime.Tasks.HotfixConditional.New");
			}
		}
		catch (Exception e)
		{
	...
	static int GetPriority(IntPtr L)
	{
		try
		{
			...
			BehaviorDesigner.Runtime.Tasks.HotfixConditional obj = (BehaviorDesigner.Runtime.Tasks.HotfixConditional)ToLua.CheckObject<BehaviorDesigner.Runtime.Tasks.HotfixConditional>(L, 1);
	...
	static int get_behaviorTreeConfigID(IntPtr L)
	{
		...
		try
		{
			...
			BehaviorDesigner.Runtime.Tasks.HotfixConditional obj = (BehaviorDesigner.Runtime.Tasks.HotfixConditional)o;
