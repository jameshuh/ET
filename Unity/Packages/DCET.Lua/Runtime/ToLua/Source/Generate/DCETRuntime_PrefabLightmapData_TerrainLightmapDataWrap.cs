...
public class DCETRuntime_PrefabLightmapData_TerrainLightmapDataWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCETRuntime.PrefabLightmapData.TerrainLightmapData), null);
		L.RegFunction("New", _CreateDCETRuntime_PrefabLightmapData_TerrainLightmapData);
	...
	static int _CreateDCETRuntime_PrefabLightmapData_TerrainLightmapData(IntPtr L)
	{
		DCETRuntime.PrefabLightmapData.TerrainLightmapData obj = new DCETRuntime.PrefabLightmapData.TerrainLightmapData();
	...
	static int get_terrain(IntPtr L)
	{
		...
		try
		{
			...
			DCETRuntime.PrefabLightmapData.TerrainLightmapData obj = (DCETRuntime.PrefabLightmapData.TerrainLightmapData)o;
	...
	static int __default__(IntPtr L)
	{
		try
		{
			var o = new DCETRuntime.PrefabLightmapData.TerrainLightmapData();
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int __clone__(IntPtr L)
	{
		try
		{
			...
			var obj = (DCETRuntime.PrefabLightmapData.TerrainLightmapData)ToLua.CheckObject(L, 1, typeof(DCETRuntime.PrefabLightmapData.TerrainLightmapData));
			var o = obj;
			ToLua.PushValue(L, o);
			ToLua.SetBack(L, 1, obj);
			return 1;
