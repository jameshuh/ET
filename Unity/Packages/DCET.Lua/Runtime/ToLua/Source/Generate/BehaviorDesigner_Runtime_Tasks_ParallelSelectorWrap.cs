...
public class BehaviorDesigner_Runtime_Tasks_ParallelSelectorWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(BehaviorDesigner.Runtime.Tasks.ParallelSelector), typeof(BehaviorDesigner.Runtime.Tasks.Composite));
		...
		L.RegFunction("New", _CreateBehaviorDesigner_Runtime_Tasks_ParallelSelector);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateBehaviorDesigner_Runtime_Tasks_ParallelSelector(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				BehaviorDesigner.Runtime.Tasks.ParallelSelector obj = new BehaviorDesigner.Runtime.Tasks.ParallelSelector();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: BehaviorDesigner.Runtime.Tasks.ParallelSelector.New");
			}
		}
		catch (Exception e)
		{
	...
	static int OnAwake(IntPtr L)
	{
		try
		{
			...
			BehaviorDesigner.Runtime.Tasks.ParallelSelector obj = (BehaviorDesigner.Runtime.Tasks.ParallelSelector)ToLua.CheckObject<BehaviorDesigner.Runtime.Tasks.ParallelSelector>(L, 1);
			obj.OnAwake();
			return 0;
		}
		catch (Exception e)
	...
	static int OnChildStarted(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: BehaviorDesigner.Runtime.Tasks.ParallelSelector.OnChildStarted");
			}
		}
		catch (Exception e)
		{
	...
	static int OnChildExecuted(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: BehaviorDesigner.Runtime.Tasks.ParallelSelector.OnChildExecuted");
			}
		}
		catch (Exception e)
		{
	...
	static int OnConditionalAbort(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: BehaviorDesigner.Runtime.Tasks.ParallelSelector.OnConditionalAbort");
			}
		}
		catch (Exception e)
		{
	...
	static int OverrideStatus(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: BehaviorDesigner.Runtime.Tasks.ParallelSelector.OverrideStatus");
			}
		}
		catch (Exception e)
		{
