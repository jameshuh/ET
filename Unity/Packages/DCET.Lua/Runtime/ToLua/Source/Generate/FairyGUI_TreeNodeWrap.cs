...
public class FairyGUI_TreeNodeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("gettree", get_tree);
		L.RegVar("cell", get_cell, null);
		L.RegFunction("getcell", get_cell);
		L.RegVar("level", get_level, null);
		L.RegFunction("getlevel", get_level);
		L.RegVar("expanded", get_expanded, set_expanded);
		L.RegFunction("getexpanded", get_expanded);
		L.RegFunction("setexpanded", set_expanded);
		L.RegVar("isFolder", get_isFolder, null);
		L.RegFunction("getisFolder", get_isFolder);
