...
public class DCET_Runtime_GizmosDebugWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DCET.Runtime.GizmosDebug), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_Path(IntPtr L)
	{
		...
		try
		{
			...
			DCET.Runtime.GizmosDebug obj = (DCET.Runtime.GizmosDebug)o;
			System.Collections.Generic.List<UnityEngine.Vector3> ret = obj.Path;
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.Push(L, DCET.Runtime.GizmosDebug.Instance);
			return 1;
		}
		catch (Exception e)
		{
