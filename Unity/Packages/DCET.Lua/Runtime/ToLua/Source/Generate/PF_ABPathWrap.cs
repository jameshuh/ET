...
public class PF_ABPathWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(PF.ABPath), typeof(PF.Path));
		L.RegFunction("Construct", Construct);
		L.RegFunction("New", _CreatePF_ABPath);
	...
	static int _CreatePF_ABPath(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				PF.ABPath obj = new PF.ABPath();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: PF.ABPath.New");
			}
		}
		catch (Exception e)
		{
	...
	static int Construct(IntPtr L)
	{
		try
		{
			...
			if (count == 2)
			{
				...
				PF.ABPath o = PF.ABPath.Construct(arg0, arg1);
			...
			else if (count == 3)
			{
				...
				PF.ABPath o = PF.ABPath.Construct(arg0, arg1, arg2);
				ToLua.PushObject(L, o);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: PF.ABPath.Construct");
			}
		}
		catch (Exception e)
		{
