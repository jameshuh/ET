...
public class System_ExceptionWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getMessage", get_Message);
		L.RegVar("Data", get_Data, null);
		L.RegFunction("getData", get_Data);
		L.RegVar("InnerException", get_InnerException, null);
		L.RegFunction("getInnerException", get_InnerException);
		L.RegVar("TargetSite", get_TargetSite, null);
		L.RegFunction("getTargetSite", get_TargetSite);
		L.RegVar("StackTrace", get_StackTrace, null);
		L.RegFunction("getStackTrace", get_StackTrace);
		L.RegVar("HelpLink", get_HelpLink, set_HelpLink);
		L.RegFunction("getHelpLink", get_HelpLink);
		L.RegFunction("setHelpLink", set_HelpLink);
		L.RegVar("Source", get_Source, set_Source);
		L.RegFunction("getSource", get_Source);
		L.RegFunction("setSource", set_Source);
		L.RegVar("HResult", get_HResult, null);
		L.RegFunction("getHResult", get_HResult);
		L.EndClass();
	}
