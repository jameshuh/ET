...
namespace XLua.CSObjectWrap
{
    ...
    public class PFInt2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PF.Int2);
			Utils.BeginObjectRegister(type, L, translator, 3, 9, 3, 2);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsqrMagnitudeLong", _g_get_sqrMagnitudeLong);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "FromInt3XZ", _m_FromInt3XZ_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "ToInt3XZ", _m_ToInt3XZ_xlua_st_);
		...
		public static int __clone__(RealStatePtr L)
		{
			...
			{
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				PF.Int2 gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __AddMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<PF.Int2>(L, 1) && translator.Assignable<PF.Int2>(L, 2))
				{
					PF.Int2 leftside;translator.Get(L, 1, out leftside);
					PF.Int2 rightside;translator.Get(L, 2, out rightside);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to right hand of + operator, need PF.Int2!");
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    PF.Int2 _other;translator.Get(L, 2, out _other);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to PF.Int2.Equals!");
		    ...
		    try {
                ...
                
                {
                    PF.Int3 _o;translator.Get(L, 1, out _o);
                        ...
                        PF.Int2 gen_ret = PF.Int2.FromInt3XZ( 
                        _o );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToInt3XZ_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    PF.Int2 _o;translator.Get(L, 1, out _o);
                    
                        PF.Int3 gen_ret = PF.Int2.ToInt3XZ( 
                        _o );
                        translator.Push(L, gen_ret);
