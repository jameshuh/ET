...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIEllipseMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 16, 7, 7);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcenterColor", _g_get_centerColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillColor", _g_get_fillColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstartDegree", _g_get_startDegree);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getendDegreee", _g_get_endDegreee);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcenterColor", _s_set_centerColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillColor", _s_set_fillColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstartDegree", _s_set_startDegree);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setendDegreee", _s_set_endDegreee);
