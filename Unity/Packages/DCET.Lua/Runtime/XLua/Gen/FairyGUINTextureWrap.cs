...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUINTextureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoriginalSize", _g_get_originalSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getroot", _g_get_root);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdisposed", _g_get_disposed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnativeTexture", _g_get_nativeTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getalphaTexture", _g_get_alphaTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuvRect", _g_get_uvRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrotated", _g_get_rotated);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrefCount", _g_get_refCount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlastActive", _g_get_lastActive);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdestroyMethod", _g_get_destroyMethod);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuvRect", _s_set_uvRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrotated", _s_set_rotated);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrefCount", _s_set_refCount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlastActive", _s_set_lastActive);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdestroyMethod", _s_set_destroyMethod);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getEmpty", _g_get_Empty);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Rect _drawRect;translator.Get(L, 2, out _drawRect);
                        ...
                        UnityEngine.Rect gen_ret = gen_to_be_invoked.GetDrawRect( 
                        _drawRect );
                        translator.Push(L, gen_ret);
        ...
        static int _m_DestroyMaterialManager(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DestroyMaterialManager( 
                        _manager );
        ...
        static int _g_get_destroyMethod(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.NTexture gen_to_be_invoked = (FairyGUI.NTexture)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIDestroyMethod(L, gen_to_be_invoked.destroyMethod);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
