...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIBlendModeUtilsBlendFactorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpma", _g_get_pma);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsrcFactor", _s_set_srcFactor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdstFactor", _s_set_dstFactor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpma", _s_set_pma);
