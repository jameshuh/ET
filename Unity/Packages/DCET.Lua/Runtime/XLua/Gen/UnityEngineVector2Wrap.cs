...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 6, 17, 5, 2);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToUnityV2", _m_ToUnityV2);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToPFV2", _m_ToPFV2);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 44, 8, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getkEpsilon", UnityEngine.Vector2.kEpsilon);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getkEpsilonNormalSqrt", UnityEngine.Vector2.kEpsilonNormalSqrt);
		...
		public static int __clone__(RealStatePtr L)
		{
			try
			{
				...
				translator.PushUnityEngineVector2(L, gen_to_be_invoked);
				return 1;
			}
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.Lerp( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.LerpUnclamped( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _maxDistanceDelta = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.MoveTowards( 
                        _current, 
                        _target, 
                        _maxDistanceDelta );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _b;translator.Get(L, 2, out _b);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.Scale( 
                        _a, 
                        _b );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _inNormal;translator.Get(L, 2, out _inNormal);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.Reflect( 
                        _inDirection, 
                        _inNormal );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector2 _inDirection;translator.Get(L, 1, out _inDirection);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.Perpendicular( 
                        _inDirection );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _rhs;translator.Get(L, 2, out _rhs);
                        ...
                        float gen_ret = UnityEngine.Vector2.Dot( 
                        _lhs, 
                        _rhs );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _to;translator.Get(L, 2, out _to);
                        ...
                        float gen_ret = UnityEngine.Vector2.Angle( 
                        _from, 
                        _to );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _to;translator.Get(L, 2, out _to);
                        ...
                        float gen_ret = UnityEngine.Vector2.SignedAngle( 
                        _from, 
                        _to );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _b;translator.Get(L, 2, out _b);
                        ...
                        float gen_ret = UnityEngine.Vector2.Distance( 
                        _a, 
                        _b );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _maxLength = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.ClampMagnitude( 
                        _vector, 
                        _maxLength );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector2 _a;translator.Get(L, 1, out _a);
                        ...
                        float gen_ret = UnityEngine.Vector2.SqrMagnitude( 
                        _a );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _rhs;translator.Get(L, 2, out _rhs);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.Min( 
                        _lhs, 
                        _rhs );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector2 _rhs;translator.Get(L, 2, out _rhs);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.Max( 
                        _lhs, 
                        _rhs );
                        translator.PushUnityEngineVector2(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 1)&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& translator.Assignable<UnityEngine.Vector2>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _smoothTime = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Vector2 gen_ret = UnityEngine.Vector2.SmoothDamp( 
                        _current, 
                        _target, 
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToUnityV2(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.Vector2 _v2;translator.Get(L, 1, out _v2);
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.ToUnityV2(  );
                        translator.PushUnityEngineVector2(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToPFV2(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.Vector2 _v2;translator.Get(L, 1, out _v2);
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.ToPFV2(  );
                        translator.PushUnityEngineVector2(L, gen_ret);
