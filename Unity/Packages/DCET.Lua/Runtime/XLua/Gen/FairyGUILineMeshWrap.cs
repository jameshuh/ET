...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUILineMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlineWidthCurve", _g_get_lineWidthCurve);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgradient", _g_get_gradient);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getroundEdge", _g_get_roundEdge);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillStart", _g_get_fillStart);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillEnd", _g_get_fillEnd);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpointDensity", _g_get_pointDensity);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineWidth", _s_set_lineWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineWidthCurve", _s_set_lineWidthCurve);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setgradient", _s_set_gradient);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setroundEdge", _s_set_roundEdge);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillStart", _s_set_fillStart);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillEnd", _s_set_fillEnd);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpointDensity", _s_set_pointDensity);
