...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemIOPathWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getAltDirectorySeparatorChar", System.IO.Path.AltDirectorySeparatorChar);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getDirectorySeparatorChar", System.IO.Path.DirectorySeparatorChar);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getPathSeparator", System.IO.Path.PathSeparator);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getVolumeSeparatorChar", System.IO.Path.VolumeSeparatorChar);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _extension = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = System.IO.Path.ChangeExtension( 
                        _path, 
                        _extension );
		    ...
		    try {
                ...
                if(gen_param_count >= 0&& (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 1) || (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING))) 
                {
                    string[] _paths = translator.GetParams<string>(L, 1);
                        ...
                        string gen_ret = System.IO.Path.Combine( 
                        _paths );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = System.IO.Path.GetDirectoryName( 
                        _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = System.IO.Path.GetExtension( 
                        _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = System.IO.Path.GetFileName( 
                        _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = System.IO.Path.GetFileNameWithoutExtension( 
                        _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = System.IO.Path.GetFullPath( 
                        _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = System.IO.Path.GetPathRoot( 
                        _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = System.IO.Path.HasExtension( 
                        _path );
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = System.IO.Path.IsPathRooted( 
                        _path );
                        LuaAPI.lua_pushboolean(L, gen_ret);
