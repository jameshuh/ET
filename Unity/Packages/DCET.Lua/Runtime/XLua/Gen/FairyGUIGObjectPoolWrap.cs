...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGObjectPoolWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinitCallback", _g_get_initCallback);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinitCallback", _s_set_initCallback);
		    ...
		    try {
                ...
                
                {
                    string _url = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.GetObject( 
                        _url );
                        translator.Push(L, gen_ret);
