...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIPageOptionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.PageOption);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					FairyGUI.PageOption gen_ret = new FairyGUI.PageOption();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.PageOption constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.PageOption gen_to_be_invoked = (FairyGUI.PageOption)translator.FastGetCSObj(L, 1);
