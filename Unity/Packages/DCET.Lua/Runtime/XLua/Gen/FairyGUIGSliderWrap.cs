...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGSliderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonGripTouchEnd", _g_get_onGripTouchEnd);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettitleType", _g_get_titleType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmax", _g_get_max);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvalue", _g_get_value);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchangeOnClick", _g_get_changeOnClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcanDrag", _g_get_canDrag);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "settitleType", _s_set_titleType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmax", _s_set_max);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvalue", _s_set_value);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchangeOnClick", _s_set_changeOnClick);
        ...
        static int _g_get_titleType(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GSlider gen_to_be_invoked = (FairyGUI.GSlider)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIProgressTitleType(L, gen_to_be_invoked.titleType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
