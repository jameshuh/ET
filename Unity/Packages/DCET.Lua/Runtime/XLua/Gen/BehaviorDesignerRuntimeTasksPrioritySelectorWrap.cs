...
namespace XLua.CSObjectWrap
{
    ...
    public class BehaviorDesignerRuntimeTasksPrioritySelectorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BehaviorDesigner.Runtime.Tasks.PrioritySelector);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BehaviorDesigner.Runtime.Tasks.PrioritySelector gen_ret = new BehaviorDesigner.Runtime.Tasks.PrioritySelector();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BehaviorDesigner.Runtime.Tasks.PrioritySelector constructor!");
        ...
        static int _m_OnStart(RealStatePtr L)
        {
		    try {
                ...
                BehaviorDesigner.Runtime.Tasks.PrioritySelector gen_to_be_invoked = (BehaviorDesigner.Runtime.Tasks.PrioritySelector)translator.FastGetCSObj(L, 1);
