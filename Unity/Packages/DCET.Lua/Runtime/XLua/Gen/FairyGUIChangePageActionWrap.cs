...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIChangePageActionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getobjectId", _g_get_objectId);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontrollerName", _g_get_controllerName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettargetPage", _g_get_targetPage);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setobjectId", _s_set_objectId);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcontrollerName", _s_set_controllerName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settargetPage", _s_set_targetPage);
