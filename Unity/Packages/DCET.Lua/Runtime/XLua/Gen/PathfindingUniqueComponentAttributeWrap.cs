...
namespace XLua.CSObjectWrap
{
    ...
    public class PathfindingUniqueComponentAttributeWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Pathfinding.UniqueComponentAttribute gen_ret = new Pathfinding.UniqueComponentAttribute();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Pathfinding.UniqueComponentAttribute constructor!");
        ...
        static int _g_get_tag(RealStatePtr L)
        {
		    try {
                ...
                Pathfinding.UniqueComponentAttribute gen_to_be_invoked = (Pathfinding.UniqueComponentAttribute)translator.FastGetCSObj(L, 1);
