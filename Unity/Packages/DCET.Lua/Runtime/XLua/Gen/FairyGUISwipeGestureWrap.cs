...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUISwipeGestureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonMove", _g_get_onMove);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getactionDistance", _g_get_actionDistance);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsnapping", _g_get_snapping);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setactionDistance", _s_set_actionDistance);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsnapping", _s_set_snapping);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getACTION_DISTANCE", _g_get_ACTION_DISTANCE);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setACTION_DISTANCE", _s_set_ACTION_DISTANCE);
