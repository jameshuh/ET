...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGRootWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmodalLayer", _g_get_modalLayer);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethasModalWindow", _g_get_hasModalWindow);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethasAnyPopup", _g_get_hasAnyPopup);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getcontentScaleFactor", _g_get_contentScaleFactor);
        ...
        static int _m_HideWindowImmediately(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.Window>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.HideWindowImmediately( 
                        _win );
		    ...
		    try {
                ...
                
                {
                    FairyGUI.DisplayObject _obj = (FairyGUI.DisplayObject)translator.GetObject(L, 2, typeof(FairyGUI.DisplayObject));
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.DisplayObjectToGObject( 
                        _obj );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    object _downward = translator.GetObject(L, 4, typeof(object));
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.GetPoupPosition( 
                        _popup, 
                        _target, 
                        _downward );
        ...
        static int _m_ShowTooltips(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ShowTooltips( 
                        _msg );
        ...
        static int _m_ShowTooltipsWin(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ShowTooltipsWin( 
                        _tooltipWin );
