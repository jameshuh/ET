...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRendererWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowCastingMode", _g_get_shadowCastingMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreceiveShadows", _g_get_receiveShadows);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmotionVectorGenerationMode", _g_get_motionVectorGenerationMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlightProbeUsage", _g_get_lightProbeUsage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreflectionProbeUsage", _g_get_reflectionProbeUsage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrenderingLayerMask", _g_get_renderingLayerMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrendererPriority", _g_get_rendererPriority);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsortingLayerName", _g_get_sortingLayerName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsortingLayerID", _g_get_sortingLayerID);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsortingOrder", _g_get_sortingOrder);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getallowOcclusionWhenDynamic", _g_get_allowOcclusionWhenDynamic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisPartOfStaticBatch", _g_get_isPartOfStaticBatch);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getworldToLocalMatrix", _g_get_worldToLocalMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlocalToWorldMatrix", _g_get_localToWorldMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlightProbeProxyVolumeOverride", _g_get_lightProbeProxyVolumeOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getprobeAnchor", _g_get_probeAnchor);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlightmapScaleOffset", _g_get_lightmapScaleOffset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrealtimeLightmapScaleOffset", _g_get_realtimeLightmapScaleOffset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmaterials", _g_get_materials);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmaterial", _g_get_material);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsharedMaterial", _g_get_sharedMaterial);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsharedMaterials", _g_get_sharedMaterials);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setenabled", _s_set_enabled);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowCastingMode", _s_set_shadowCastingMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreceiveShadows", _s_set_receiveShadows);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmotionVectorGenerationMode", _s_set_motionVectorGenerationMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlightProbeUsage", _s_set_lightProbeUsage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreflectionProbeUsage", _s_set_reflectionProbeUsage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrenderingLayerMask", _s_set_renderingLayerMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrendererPriority", _s_set_rendererPriority);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsortingLayerName", _s_set_sortingLayerName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsortingLayerID", _s_set_sortingLayerID);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsortingOrder", _s_set_sortingOrder);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setallowOcclusionWhenDynamic", _s_set_allowOcclusionWhenDynamic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlightProbeProxyVolumeOverride", _s_set_lightProbeProxyVolumeOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setprobeAnchor", _s_set_probeAnchor);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlightmapScaleOffset", _s_set_lightmapScaleOffset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrealtimeLightmapScaleOffset", _s_set_realtimeLightmapScaleOffset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmaterials", _s_set_materials);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmaterial", _s_set_material);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsharedMaterial", _s_set_sharedMaterial);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsharedMaterials", _s_set_sharedMaterials);
        ...
        static int _m_SetPropertyBlock(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.MaterialPropertyBlock>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.SetPropertyBlock( 
                        _properties );
        ...
        static int _m_GetMaterials(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetMaterials( 
                        _m );
        ...
        static int _m_GetSharedMaterials(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetSharedMaterials( 
                        _m );
        ...
        static int _m_GetClosestReflectionProbes(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetClosestReflectionProbes( 
                        _result );
