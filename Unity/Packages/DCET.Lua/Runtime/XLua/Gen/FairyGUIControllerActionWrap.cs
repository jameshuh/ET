...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIControllerActionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfromPage", _g_get_fromPage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettoPage", _g_get_toPage);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfromPage", _s_set_fromPage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settoPage", _s_set_toPage);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.ControllerAction.ActionType _type;translator.Get(L, 1, out _type);
                        ...
                        FairyGUI.ControllerAction gen_ret = FairyGUI.ControllerAction.CreateAction( 
                        _type );
                        translator.Push(L, gen_ret);
