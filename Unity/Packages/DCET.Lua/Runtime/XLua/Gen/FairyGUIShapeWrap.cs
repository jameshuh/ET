    ...
    public class FairyGUIShapeWrap 
    {
        ...
        static int _m_DrawRoundRect(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DrawRoundRect( 
                        _lineSize, 
                        _lineColor, 
                        _fillColor, 
                        _topLeftRadius, 
        ...
        static int _m_DrawPolygon(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2[]>(L, 2)&& translator.Assignable<UnityEngine.Color>(L, 3)) 
                {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2[]>(L, 2)&& translator.Assignable<UnityEngine.Color32[]>(L, 3)) 
                {
                    UnityEngine.Vector2[] _points = (UnityEngine.Vector2[])translator.GetObject(L, 2, typeof(UnityEngine.Vector2[]));
                    UnityEngine.Color32[] _colors = (UnityEngine.Color32[])translator.GetObject(L, 3, typeof(UnityEngine.Color32[]));
        ...
        static int _m_DrawRegularPolygon(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.DrawRegularPolygon( 
                        _sides, 
                        _lineSize, 
                        _centerColor, 
                        _lineColor, 
