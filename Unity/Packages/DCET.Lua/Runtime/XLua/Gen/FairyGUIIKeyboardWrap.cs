...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIIKeyboardWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.IKeyboard);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdone", _g_get_done);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsupportsCaret", _g_get_supportsCaret);
        ...
        {
            return LuaAPI.luaL_error(L, "FairyGUI.IKeyboard does not have a constructor!");
        }
