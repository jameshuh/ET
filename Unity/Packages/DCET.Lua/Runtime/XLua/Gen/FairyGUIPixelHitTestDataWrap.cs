...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIPixelHitTestDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixels", _g_get_pixels);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelsLength", _g_get_pixelsLength);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelsOffset", _g_get_pixelsOffset);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpixelWidth", _s_set_pixelWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscale", _s_set_scale);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpixels", _s_set_pixels);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpixelsLength", _s_set_pixelsLength);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpixelsOffset", _s_set_pixelsOffset);
