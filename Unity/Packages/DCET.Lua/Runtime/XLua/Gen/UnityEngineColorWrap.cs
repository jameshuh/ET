...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineColorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 5, 16, 8, 4);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgrayscale", _g_get_grayscale);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlinear", _g_get_linear);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgamma", _g_get_gamma);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmaxColorComponent", _g_get_maxColorComponent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getr", _g_get_r);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getg", _g_get_g);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getb", _g_get_b);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geta", _g_get_a);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setr", _s_set_r);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setg", _s_set_g);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setb", _s_set_b);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "seta", _s_set_a);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 34, 11, 0);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getred", _g_get_red);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getgreen", _g_get_green);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getblue", _g_get_blue);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getwhite", _g_get_white);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getblack", _g_get_black);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getyellow", _g_get_yellow);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcyan", _g_get_cyan);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmagenta", _g_get_magenta);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getgray", _g_get_gray);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getgrey", _g_get_grey);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getclear", _g_get_clear);
		...
		public static int __clone__(RealStatePtr L)
		{
			try
			{
				...
				translator.PushUnityEngineColor(L, gen_to_be_invoked);
				return 1;
			}
        ...
        {					
			...
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
                UnityEngine.Color rightside;translator.Get(L, 1, out rightside);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Color gen_ret = UnityEngine.Color.Lerp( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineColor(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Color gen_ret = UnityEngine.Color.LerpUnclamped( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineColor(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _V = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Color gen_ret = UnityEngine.Color.HSVToRGB( 
                        _H, 
                        _S, 
                        _V );
                        translator.PushUnityEngineColor(L, gen_ret);
