		    ...
		    try {
                ...
                
                {
                    string _strType = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.hasEventListeners( 
                        _strType );
		    ...
		    try {
                ...
                
                {
                    string _strType = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.isDispatching( 
                        _strType );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    object _data = translator.GetObject(L, 3, typeof(object));
                        ...
                        bool gen_ret = gen_to_be_invoked.BubbleEvent( 
                        _strType, 
                        _data );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    object _data = translator.GetObject(L, 3, typeof(object));
                        ...
                        bool gen_ret = gen_to_be_invoked.BroadcastEvent( 
                        _strType, 
                        _data );
                        LuaAPI.lua_pushboolean(L, gen_ret);
