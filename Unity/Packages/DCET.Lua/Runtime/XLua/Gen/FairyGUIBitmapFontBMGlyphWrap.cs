...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIBitmapFontBMGlyphWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getadvance", _g_get_advance);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlineHeight", _g_get_lineHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuv", _g_get_uv);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchannel", _g_get_channel);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoffsetX", _s_set_offsetX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoffsetY", _s_set_offsetY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setwidth", _s_set_width);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setheight", _s_set_height);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setadvance", _s_set_advance);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineHeight", _s_set_lineHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuv", _s_set_uv);
