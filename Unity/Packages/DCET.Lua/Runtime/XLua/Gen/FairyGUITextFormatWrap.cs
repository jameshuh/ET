...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITextFormatWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 11, 11);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getletterSpacing", _g_get_letterSpacing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbold", _g_get_bold);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getunderline", _g_get_underline);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getitalic", _g_get_italic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgradientColor", _g_get_gradientColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getalign", _g_get_align);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getspecialStyle", _g_get_specialStyle);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setletterSpacing", _s_set_letterSpacing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbold", _s_set_bold);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setunderline", _s_set_underline);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setitalic", _s_set_italic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setgradientColor", _s_set_gradientColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setalign", _s_set_align);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setspecialStyle", _s_set_specialStyle);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.TextFormat _aFormat = (FairyGUI.TextFormat)translator.GetObject(L, 2, typeof(FairyGUI.TextFormat));
                        ...
                        bool gen_ret = gen_to_be_invoked.EqualStyle( 
                        _aFormat );
        ...
        static int _g_get_specialStyle(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.TextFormat gen_to_be_invoked = (FairyGUI.TextFormat)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUITextFormatSpecialStyle(L, gen_to_be_invoked.specialStyle);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
