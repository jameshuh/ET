...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimeAssetLoaderAsyncWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCETRuntime.AssetLoaderAsync);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.AssetBundle>(L, 2))
				{
					...
					DCETRuntime.AssetLoaderAsync gen_ret = new DCETRuntime.AssetLoaderAsync(_ab);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCETRuntime.AssetLoaderAsync constructor!");
        ...
        static int _m_Update(RealStatePtr L)
        {
		    try {
                ...
                DCETRuntime.AssetLoaderAsync gen_to_be_invoked = (DCETRuntime.AssetLoaderAsync)translator.FastGetCSObj(L, 1);
