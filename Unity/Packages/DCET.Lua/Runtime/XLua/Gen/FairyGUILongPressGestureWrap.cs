...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUILongPressGestureWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 15, 8, 4);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonce", _g_get_once);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getholdRangeRadius", _g_get_holdRangeRadius);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "settrigger", _s_set_trigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinterval", _s_set_interval);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setonce", _s_set_once);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setholdRangeRadius", _s_set_holdRangeRadius);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getTRIGGER", _g_get_TRIGGER);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getINTERVAL", _g_get_INTERVAL);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setTRIGGER", _s_set_TRIGGER);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setINTERVAL", _s_set_INTERVAL);
