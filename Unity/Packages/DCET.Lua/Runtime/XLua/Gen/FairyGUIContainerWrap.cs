...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIContainerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 46, 13, 12);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getclipRect", _g_get_clipRect);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrenderCamera", _g_get_renderCamera);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethitArea", _g_get_hitArea);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettouchChildren", _g_get_touchChildren);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setclipRect", _s_set_clipRect);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrenderCamera", _s_set_renderCamera);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethitArea", _s_set_hitArea);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settouchChildren", _s_set_touchChildren);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.DisplayObject _child = (FairyGUI.DisplayObject)translator.GetObject(L, 2, typeof(FairyGUI.DisplayObject));
                        ...
                        FairyGUI.DisplayObject gen_ret = gen_to_be_invoked.AddChild( 
                        _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        FairyGUI.DisplayObject gen_ret = gen_to_be_invoked.AddChildAt( 
                        _child, 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.DisplayObject gen_ret = gen_to_be_invoked.GetChildAt( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.DisplayObject gen_ret = gen_to_be_invoked.GetChild( 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.DisplayObject>(L, 2)) 
                {
                    FairyGUI.DisplayObject _child = (FairyGUI.DisplayObject)translator.GetObject(L, 2, typeof(FairyGUI.DisplayObject));
                        ...
                        FairyGUI.DisplayObject gen_ret = gen_to_be_invoked.RemoveChild( 
                        _child );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ChangeChildrenOrder(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ChangeChildrenOrder( 
                        _indice, 
                        _objs );
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _forTouch = LuaAPI.lua_toboolean(L, 3);
                        ...
                        FairyGUI.DisplayObject gen_ret = gen_to_be_invoked.HitTest( 
                        _stagePoint, 
                        _forTouch );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetChildrenLayer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetChildrenLayer( 
                        _value );
