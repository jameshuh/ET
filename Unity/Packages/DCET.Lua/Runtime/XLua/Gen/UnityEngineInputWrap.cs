...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineInputWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 81, 26, 6);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getsimulateMouseWithTouches", _g_get_simulateMouseWithTouches);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getanyKey", _g_get_anyKey);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getanyKeyDown", _g_get_anyKeyDown);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getinputString", _g_get_inputString);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmousePosition", _g_get_mousePosition);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmouseScrollDelta", _g_get_mouseScrollDelta);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getimeCompositionMode", _g_get_imeCompositionMode);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcompositionString", _g_get_compositionString);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getimeIsSelected", _g_get_imeIsSelected);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcompositionCursorPos", _g_get_compositionCursorPos);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmousePresent", _g_get_mousePresent);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettouchCount", _g_get_touchCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettouchPressureSupported", _g_get_touchPressureSupported);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getstylusTouchSupported", _g_get_stylusTouchSupported);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettouchSupported", _g_get_touchSupported);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmultiTouchEnabled", _g_get_multiTouchEnabled);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdeviceOrientation", _g_get_deviceOrientation);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getacceleration", _g_get_acceleration);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcompensateSensors", _g_get_compensateSensors);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getaccelerationEventCount", _g_get_accelerationEventCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getbackButtonLeavesApp", _g_get_backButtonLeavesApp);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getlocation", _g_get_location);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcompass", _g_get_compass);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getgyro", _g_get_gyro);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettouches", _g_get_touches);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getaccelerationEvents", _g_get_accelerationEvents);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setsimulateMouseWithTouches", _s_set_simulateMouseWithTouches);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setimeCompositionMode", _s_set_imeCompositionMode);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setcompositionCursorPos", _s_set_compositionCursorPos);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setmultiTouchEnabled", _s_set_multiTouchEnabled);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setcompensateSensors", _s_set_compensateSensors);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setbackButtonLeavesApp", _s_set_backButtonLeavesApp);
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        float gen_ret = UnityEngine.Input.GetAxis( 
                        _axisName );
		    ...
		    try {
                ...
                
                {
                    string _axisName = LuaAPI.lua_tostring(L, 1);
                        ...
                        float gen_ret = UnityEngine.Input.GetAxisRaw( 
                        _axisName );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _buttonName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Input.GetButton( 
                        _buttonName );
		    ...
		    try {
                ...
                
                {
                    string _buttonName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Input.GetButtonDown( 
                        _buttonName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _buttonName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Input.GetButtonUp( 
                        _buttonName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _button = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Input.GetMouseButton( 
                        _button );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _button = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Input.GetMouseButtonDown( 
                        _button );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _button = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Input.GetMouseButtonUp( 
                        _button );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _joystickName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = UnityEngine.Input.IsJoystickPreconfigured( 
                        _joystickName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.Touch gen_ret = UnityEngine.Input.GetTouch( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.AccelerationEvent gen_ret = UnityEngine.Input.GetAccelerationEvent( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.KeyCode>(L, 1)) 
                {
                    UnityEngine.KeyCode _key;translator.Get(L, 1, out _key);
                        ...
                        bool gen_ret = UnityEngine.Input.GetKey( 
                        _key );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.KeyCode>(L, 1)) 
                {
                    UnityEngine.KeyCode _key;translator.Get(L, 1, out _key);
                        ...
                        bool gen_ret = UnityEngine.Input.GetKeyUp( 
                        _key );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.KeyCode>(L, 1)) 
                {
                    UnityEngine.KeyCode _key;translator.Get(L, 1, out _key);
                        ...
                        bool gen_ret = UnityEngine.Input.GetKeyDown( 
                        _key );
                        LuaAPI.lua_pushboolean(L, gen_ret);
