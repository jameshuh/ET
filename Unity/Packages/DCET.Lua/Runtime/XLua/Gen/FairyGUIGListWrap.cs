...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGListWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonClickItem", _g_get_onClickItem);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonRightClickItem", _g_get_onRightClickItem);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlayout", _g_get_layout);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlineCount", _g_get_lineCount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcolumnCount", _g_get_columnCount);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getalign", _g_get_align);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getverticalAlign", _g_get_verticalAlign);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getautoResizeItem", _g_get_autoResizeItem);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getitemPool", _g_get_itemPool);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettouchItem", _g_get_touchItem);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisVirtual", _g_get_isVirtual);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnumItems", _g_get_numItems);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdefaultItem", _g_get_defaultItem);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfoldInvisibleItems", _g_get_foldInvisibleItems);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectionMode", _g_get_selectionMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getitemRenderer", _g_get_itemRenderer);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getitemProvider", _g_get_itemProvider);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscrollItemToViewOnClick", _g_get_scrollItemToViewOnClick);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlayout", _s_set_layout);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineCount", _s_set_lineCount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcolumnCount", _s_set_columnCount);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setalign", _s_set_align);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setverticalAlign", _s_set_verticalAlign);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setautoResizeItem", _s_set_autoResizeItem);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnumItems", _s_set_numItems);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdefaultItem", _s_set_defaultItem);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfoldInvisibleItems", _s_set_foldInvisibleItems);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectionMode", _s_set_selectionMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setitemRenderer", _s_set_itemRenderer);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setitemProvider", _s_set_itemProvider);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscrollItemToViewOnClick", _s_set_scrollItemToViewOnClick);
		    ...
		    try {
                ...
                
                {
                    string _url = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.GetFromPool( 
                        _url );
                        translator.Push(L, gen_ret);
        ...
        static int _m_RemoveChildToPoolAt(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveChildToPoolAt( 
                        _index );
        ...
        static int _m_RemoveChildToPool(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveChildToPool( 
                        _child );
        ...
        static int _m_HandleArrowKey(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.HandleArrowKey( 
                        _dir );
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.ChildIndexToItemIndex( 
                        _index );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.ItemIndexToChildIndex( 
                        _index );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _g_get_layout(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GList gen_to_be_invoked = (FairyGUI.GList)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIListLayoutType(L, gen_to_be_invoked.layout);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_align(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GList gen_to_be_invoked = (FairyGUI.GList)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIAlignType(L, gen_to_be_invoked.align);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_verticalAlign(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GList gen_to_be_invoked = (FairyGUI.GList)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIVertAlignType(L, gen_to_be_invoked.verticalAlign);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_selectionMode(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GList gen_to_be_invoked = (FairyGUI.GList)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIListSelectionMode(L, gen_to_be_invoked.selectionMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
