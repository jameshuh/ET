...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUICaptureCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getName", FairyGUI.CaptureCamera.Name);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getLayerName", FairyGUI.CaptureCamera.LayerName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getHiddenLayerName", FairyGUI.CaptureCamera.HiddenLayerName);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getlayer", _g_get_layer);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gethiddenLayer", _g_get_hiddenLayer);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _stencilSupport = LuaAPI.lua_toboolean(L, 3);
                        ...
                        UnityEngine.RenderTexture gen_ret = FairyGUI.CaptureCamera.CreateRenderTexture( 
                        _width, 
                        _height, 
                        _stencilSupport );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Capture_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.CaptureCamera.Capture( 
                        _target, 
                        _texture, 
                        _offset );
