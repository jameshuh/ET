...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITextFieldLineInfoWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcharCount", _g_get_charCount);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settextHeight", _s_set_textHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcharIndex", _s_set_charIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcharCount", _s_set_charCount);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "textHeight", _s_set_textHeight);
        ...
        static int _m_Return_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<FairyGUI.TextField.LineInfo>(L, 1)) 
                {
                    ...
                    FairyGUI.TextField.LineInfo.Return( 
                        _value );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_textHeight(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.TextField.LineInfo gen_to_be_invoked = (FairyGUI.TextField.LineInfo)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.textHeight = (float)LuaAPI.lua_tonumber(L, 2);
