...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGPathPointWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontrol2", _g_get_control2);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcurveType", _g_get_curveType);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpos", _s_set_pos);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcontrol1", _s_set_control1);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcontrol2", _s_set_control2);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcurveType", _s_set_curveType);
        ...
        static int _g_get_curveType(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GPathPoint gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushFairyGUIGPathPointCurveType(L, gen_to_be_invoked.curveType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
