...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIIColorGearWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.IColorGear);
        ...
        {
            return LuaAPI.luaL_error(L, "FairyGUI.IColorGear does not have a constructor!");
        }
