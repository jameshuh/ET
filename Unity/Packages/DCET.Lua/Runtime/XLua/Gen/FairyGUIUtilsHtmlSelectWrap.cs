...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsHtmlSelectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcomboBox", _g_get_comboBox);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getCHANGED_EVENT", FairyGUI.Utils.HtmlSelect.CHANGED_EVENT);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getresource", _g_get_resource);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setresource", _s_set_resource);
