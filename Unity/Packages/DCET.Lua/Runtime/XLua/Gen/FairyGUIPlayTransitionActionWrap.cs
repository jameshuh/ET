...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIPlayTransitionActionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettransitionName", _g_get_transitionName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getplayTimes", _g_get_playTimes);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdelay", _g_get_delay);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstopOnExit", _g_get_stopOnExit);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "settransitionName", _s_set_transitionName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setplayTimes", _s_set_playTimes);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdelay", _s_set_delay);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstopOnExit", _s_set_stopOnExit);
