...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIContentScalerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscaleMode", _g_get_scaleMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscreenMatchMode", _g_get_screenMatchMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdesignResolutionX", _g_get_designResolutionX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdesignResolutionY", _g_get_designResolutionY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfallbackScreenDPI", _g_get_fallbackScreenDPI);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdefaultSpriteDPI", _g_get_defaultSpriteDPI);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getconstantScaleFactor", _g_get_constantScaleFactor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getignoreOrientation", _g_get_ignoreOrientation);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscaleMode", _s_set_scaleMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscreenMatchMode", _s_set_screenMatchMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdesignResolutionX", _s_set_designResolutionX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdesignResolutionY", _s_set_designResolutionY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfallbackScreenDPI", _s_set_fallbackScreenDPI);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdefaultSpriteDPI", _s_set_defaultSpriteDPI);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setconstantScaleFactor", _s_set_constantScaleFactor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setignoreOrientation", _s_set_ignoreOrientation);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getscaleFactor", _g_get_scaleFactor);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setscaleFactor", _s_set_scaleFactor);
        ...
        static int _g_get_scaleMode(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.UIContentScaler gen_to_be_invoked = (FairyGUI.UIContentScaler)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIUIContentScalerScaleMode(L, gen_to_be_invoked.scaleMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_screenMatchMode(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.UIContentScaler gen_to_be_invoked = (FairyGUI.UIContentScaler)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIUIContentScalerScreenMatchMode(L, gen_to_be_invoked.screenMatchMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
