...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITweenValueWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvec3", _g_get_vec3);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvec4", _g_get_vec4);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvec2", _s_set_vec2);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvec3", _s_set_vec3);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvec4", _s_set_vec4);
