...
namespace XLua.CSObjectWrap
{
    ...
    public class PathfindingRVOSampledAgentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 37, 17, 13);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getPreCalculationCallback", _g_get_PreCalculationCallback);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getNeighbourObstacles", _g_get_NeighbourObstacles);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "PreCalculationCallback", _g_get_PreCalculationCallback);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_PreCalculationCallback(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Pathfinding.RVO.Sampled.Agent gen_to_be_invoked = (Pathfinding.RVO.Sampled.Agent)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.PreCalculationCallback);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
