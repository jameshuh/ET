...
namespace XLua.CSObjectWrap
{
    ...
    public class BehaviorDesignerRuntimeTasksParallelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BehaviorDesigner.Runtime.Tasks.Parallel);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BehaviorDesigner.Runtime.Tasks.Parallel gen_ret = new BehaviorDesigner.Runtime.Tasks.Parallel();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BehaviorDesigner.Runtime.Tasks.Parallel constructor!");
        ...
        static int _m_OnAwake(RealStatePtr L)
        {
		    try {
                ...
                BehaviorDesigner.Runtime.Tasks.Parallel gen_to_be_invoked = (BehaviorDesigner.Runtime.Tasks.Parallel)translator.FastGetCSObj(L, 1);
