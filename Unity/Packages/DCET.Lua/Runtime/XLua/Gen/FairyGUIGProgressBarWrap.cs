...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGProgressBarWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getreverse", _g_get_reverse);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setreverse", _s_set_reverse);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.TweenValue( 
                        _value, 
                        _duration );
                        translator.Push(L, gen_ret);
