...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIHitTestContextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getscreenPoint", _g_get_screenPoint);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getworldPoint", _g_get_worldPoint);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdirection", _g_get_direction);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getforTouch", _g_get_forTouch);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcamera", _g_get_camera);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getlayerMask", _g_get_layerMask);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmaxDistance", _g_get_maxDistance);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcachedMainCamera", _g_get_cachedMainCamera);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setscreenPoint", _s_set_screenPoint);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setworldPoint", _s_set_worldPoint);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setdirection", _s_set_direction);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setforTouch", _s_set_forTouch);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setcamera", _s_set_camera);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setlayerMask", _s_set_layerMask);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setmaxDistance", _s_set_maxDistance);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setcachedMainCamera", _s_set_cachedMainCamera);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.RaycastHit _hit;
                        ...
                        bool gen_ret = FairyGUI.HitTestContext.GetRaycastHitFromCache( 
                        _camera, 
                        out _hit );
        ...
        static int _m_CacheRaycastHit_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.HitTestContext.CacheRaycastHit( 
                        _camera, 
                        ref _hit );
                    translator.Push(L, _hit);
        ...
        static int _g_get_screenPoint(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushUnityEngineVector2(L, FairyGUI.HitTestContext.screenPoint);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
