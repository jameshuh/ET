		    ...
		    try {
                ...
                
                {
                    System.Predicate<int> _match = translator.GetDelegate<System.Predicate<int>>(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.Find( 
                        _match );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Predicate<int> _match = translator.GetDelegate<System.Predicate<int>>(L, 2);
                        ...
                        System.Collections.Generic.List<int> gen_ret = gen_to_be_invoked.FindAll( 
                        _match );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Predicate<int> _match = translator.GetDelegate<System.Predicate<int>>(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.FindLast( 
                        _match );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _count = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        System.Collections.Generic.List<int> gen_ret = gen_to_be_invoked.GetRange( 
                        _index, 
                        _count );
                        translator.Push(L, gen_ret);
