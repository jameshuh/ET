...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIEventContextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsender", _g_get_sender);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinitiator", _g_get_initiator);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinputEvent", _g_get_inputEvent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisDefaultPrevented", _g_get_isDefaultPrevented);
