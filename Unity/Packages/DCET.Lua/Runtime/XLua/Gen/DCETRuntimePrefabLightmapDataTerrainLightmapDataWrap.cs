...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimePrefabLightmapDataTerrainLightmapDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCETRuntime.PrefabLightmapData.TerrainLightmapData);
			Utils.BeginObjectRegister(type, L, translator, 0, 10, 5, 5);
			
						
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getterrain", _g_get_terrain);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setterrain", _s_set_terrain);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "terrain", _g_get_terrain);
			...
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "terrain", _s_set_terrain);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(DCETRuntime.PrefabLightmapData.TerrainLightmapData));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCETRuntime.PrefabLightmapData.TerrainLightmapData constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_terrain(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DCETRuntime.PrefabLightmapData.TerrainLightmapData gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.Push(L, gen_to_be_invoked.terrain);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_terrain(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                DCETRuntime.PrefabLightmapData.TerrainLightmapData gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                gen_to_be_invoked.terrain = (UnityEngine.Terrain)translator.GetObject(L, 2, typeof(UnityEngine.Terrain));
