...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimeComponentViewWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCETRuntime.ComponentView);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCETRuntime.ComponentView gen_ret = new DCETRuntime.ComponentView();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCETRuntime.ComponentView constructor!");
        ...
        static int _g_get_Component(RealStatePtr L)
        {
		    try {
                ...
                DCETRuntime.ComponentView gen_to_be_invoked = (DCETRuntime.ComponentView)translator.FastGetCSObj(L, 1);
