...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIPackageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getassetPath", _g_get_assetPath);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcustomId", _g_get_customId);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getresBundle", _g_get_resBundle);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdependencies", _g_get_dependencies);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcustomId", _s_set_customId);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getURL_PREFIX", FairyGUI.UIPackage.URL_PREFIX);
		    ...
		    try {
                ...
                
                {
                    string _id = LuaAPI.lua_tostring(L, 1);
                        ...
                        FairyGUI.UIPackage gen_ret = FairyGUI.UIPackage.GetById( 
                        _id );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 1);
                        ...
                        FairyGUI.UIPackage gen_ret = FairyGUI.UIPackage.GetByName( 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.AssetBundle>(L, 1)) 
                {
                    UnityEngine.AssetBundle _bundle = (UnityEngine.AssetBundle)translator.GetObject(L, 1, typeof(UnityEngine.AssetBundle));
                        ...
                        FairyGUI.UIPackage gen_ret = FairyGUI.UIPackage.AddPackage( 
                        _bundle );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _resName = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = FairyGUI.UIPackage.CreateObject( 
                        _pkgName, 
                        _resName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _url = LuaAPI.lua_tostring(L, 1);
                        ...
                        FairyGUI.GObject gen_ret = FairyGUI.UIPackage.CreateObjectFromURL( 
                        _url );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& translator.Assignable<FairyGUI.UIPackage.CreateObjectCallback>(L, 2)) 
                {
                    ...
                    FairyGUI.UIPackage.CreateObjectFromURL( 
                        _url, 
                        _callback );
        ...
        static int _m_CreateObjectAsync_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.UIPackage.CreateObjectAsync( 
                        _pkgName, 
                        _resName, 
                        _callback );
		    ...
		    try {
                ...
                
                {
                    ...
                    string _resName = LuaAPI.lua_tostring(L, 2);
                        ...
                        object gen_ret = FairyGUI.UIPackage.GetItemAsset( 
                        _pkgName, 
                        _resName );
		    ...
		    try {
                ...
                
                {
                    string _url = LuaAPI.lua_tostring(L, 1);
                        ...
                        object gen_ret = FairyGUI.UIPackage.GetItemAssetByURL( 
                        _url );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _resName = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = FairyGUI.UIPackage.GetItemURL( 
                        _pkgName, 
                        _resName );
		    ...
		    try {
                ...
                
                {
                    string _url = LuaAPI.lua_tostring(L, 1);
                        ...
                        FairyGUI.PackageItem gen_ret = FairyGUI.UIPackage.GetItemByURL( 
                        _url );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _url = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.UIPackage.NormalizeURL( 
                        _url );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_SetStringsSource_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.UIPackage.SetStringsSource( 
                        _source );
		    ...
		    try {
                ...
                
                {
                    string _itemId = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.PackageItem gen_ret = gen_to_be_invoked.GetItem( 
                        _itemId );
                        translator.Push(L, gen_ret);
