...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIPanelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 21, 7, 4);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getui", _g_get_ui);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getEM_sortingOrder", _g_get_EM_sortingOrder);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpackageName", _g_get_packageName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcomponentName", _g_get_componentName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfitScreen", _g_get_fitScreen);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsortingOrder", _g_get_sortingOrder);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpackageName", _s_set_packageName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcomponentName", _s_set_componentName);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfitScreen", _s_set_fitScreen);
        ...
        static int _m_SetHitTestMode(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetHitTestMode( 
                        _value );
        ...
        static int _g_get_fitScreen(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.UIPanel gen_to_be_invoked = (FairyGUI.UIPanel)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIFitScreen(L, gen_to_be_invoked.fitScreen);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
