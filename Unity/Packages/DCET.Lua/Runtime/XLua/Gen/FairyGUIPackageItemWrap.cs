...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIPackageItemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 47, 23, 23);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getobjectType", _g_get_objectType);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getexported", _g_get_exported);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettexture", _g_get_texture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrawData", _g_get_rawData);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscale9Grid", _g_get_scale9Grid);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscaleByTile", _g_get_scaleByTile);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettileGridIndice", _g_get_tileGridIndice);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelHitTestData", _g_get_pixelHitTestData);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinterval", _g_get_interval);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrepeatDelay", _g_get_repeatDelay);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getswing", _g_get_swing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getframes", _g_get_frames);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettranslated", _g_get_translated);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getextensionCreator", _g_get_extensionCreator);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbitmapFont", _g_get_bitmapFont);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getaudioClip", _g_get_audioClip);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setowner", _s_set_owner);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settype", _s_set_type);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setobjectType", _s_set_objectType);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setexported", _s_set_exported);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settexture", _s_set_texture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrawData", _s_set_rawData);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscale9Grid", _s_set_scale9Grid);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscaleByTile", _s_set_scaleByTile);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settileGridIndice", _s_set_tileGridIndice);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpixelHitTestData", _s_set_pixelHitTestData);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinterval", _s_set_interval);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrepeatDelay", _s_set_repeatDelay);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setswing", _s_set_swing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setframes", _s_set_frames);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settranslated", _s_set_translated);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setextensionCreator", _s_set_extensionCreator);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbitmapFont", _s_set_bitmapFont);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setaudioClip", _s_set_audioClip);
        ...
        static int _g_get_type(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.PackageItem gen_to_be_invoked = (FairyGUI.PackageItem)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIPackageItemType(L, gen_to_be_invoked.type);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_objectType(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.PackageItem gen_to_be_invoked = (FairyGUI.PackageItem)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIObjectType(L, gen_to_be_invoked.objectType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
