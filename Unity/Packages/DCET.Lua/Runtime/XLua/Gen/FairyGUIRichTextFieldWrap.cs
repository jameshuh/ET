...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIRichTextFieldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethtmlPageContext", _g_get_htmlPageContext);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethtmlParseOptions", _g_get_htmlParseOptions);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getemojies", _g_get_emojies);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettextField", _g_get_textField);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethtmlElementCount", _g_get_htmlElementCount);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethtmlPageContext", _s_set_htmlPageContext);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.Utils.HtmlElement gen_ret = gen_to_be_invoked.GetHtmlElementAt( 
                        _index );
                        translator.Push(L, gen_ret);
