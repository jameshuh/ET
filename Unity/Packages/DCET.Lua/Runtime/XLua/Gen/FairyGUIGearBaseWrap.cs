...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGearBaseWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontroller", _g_get_controller);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettweenConfig", _g_get_tweenConfig);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcontroller", _s_set_controller);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getdisableAllTweenEffect", _g_get_disableAllTweenEffect);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setdisableAllTweenEffect", _s_set_disableAllTweenEffect);
