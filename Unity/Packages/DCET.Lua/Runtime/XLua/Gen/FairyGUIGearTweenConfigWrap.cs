...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGearTweenConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "settween", _s_set_tween);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "seteaseType", _s_set_easeType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setduration", _s_set_duration);
        ...
        static int _g_get_easeType(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GearTweenConfig gen_to_be_invoked = (FairyGUI.GearTweenConfig)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIEaseType(L, gen_to_be_invoked.easeType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
