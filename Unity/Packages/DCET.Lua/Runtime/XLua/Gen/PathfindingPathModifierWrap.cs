...
namespace XLua.CSObjectWrap
{
    ...
    public class PathfindingPathModifierWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Pathfinding.PathModifier);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getseeker", _g_get_seeker);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setseeker", _s_set_seeker);
        ...
        {
            return LuaAPI.luaL_error(L, "Pathfinding.PathModifier does not have a constructor!");
        }
