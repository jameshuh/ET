...
namespace XLua.CSObjectWrap
{
    ...
    public class PFPathProcessorGraphUpdateLockWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(PF.PathProcessor.GraphUpdateLock);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getHeld", _g_get_Held);
            
			
						
			
			
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "Held", _g_get_Held);
		...
		public static int __clone__(RealStatePtr L)
		{
			...
			{
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				PF.PathProcessor.GraphUpdateLock gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Held(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                PF.PathProcessor.GraphUpdateLock gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.Held);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
