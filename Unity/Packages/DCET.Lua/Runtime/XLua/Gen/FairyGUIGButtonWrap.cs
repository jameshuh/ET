...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGButtonWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 36, 17, 15);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpageOption", _g_get_pageOption);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectedIcon", _g_get_selectedIcon);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectedTitle", _g_get_selectedTitle);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselected", _g_get_selected);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmode", _g_get_mode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrelatedController", _g_get_relatedController);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchangeStateOnClick", _g_get_changeStateOnClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlinkedPopup", _g_get_linkedPopup);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectedIcon", _s_set_selectedIcon);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectedTitle", _s_set_selectedTitle);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselected", _s_set_selected);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmode", _s_set_mode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrelatedController", _s_set_relatedController);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchangeStateOnClick", _s_set_changeStateOnClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlinkedPopup", _s_set_linkedPopup);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getUP", FairyGUI.GButton.UP);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getDOWN", FairyGUI.GButton.DOWN);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getOVER", FairyGUI.GButton.OVER);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getSELECTED_OVER", FairyGUI.GButton.SELECTED_OVER);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getDISABLED", FairyGUI.GButton.DISABLED);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getSELECTED_DISABLED", FairyGUI.GButton.SELECTED_DISABLED);
        ...
        static int _g_get_mode(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GButton gen_to_be_invoked = (FairyGUI.GButton)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIButtonMode(L, gen_to_be_invoked.mode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
