...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsHtmlElementWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 27, 10, 9);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisEntity", _g_get_isEntity);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getformat", _g_get_format);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcharIndex", _g_get_charIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethtmlObject", _g_get_htmlObject);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstatus", _g_get_status);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getspace", _g_get_space);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setformat", _s_set_format);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcharIndex", _s_set_charIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethtmlObject", _s_set_htmlObject);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstatus", _s_set_status);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setspace", _s_set_space);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.Utils.HtmlElementType _type;translator.Get(L, 1, out _type);
                        ...
                        FairyGUI.Utils.HtmlElement gen_ret = FairyGUI.Utils.HtmlElement.GetElement( 
                        _type );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ReturnElement_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.Utils.HtmlElement.ReturnElement( 
                        _element );
        ...
        static int _m_ReturnElements_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.Utils.HtmlElement.ReturnElements( 
                        _elements );
        ...
        static int _g_get_type(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.Utils.HtmlElement gen_to_be_invoked = (FairyGUI.Utils.HtmlElement)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIUtilsHtmlElementType(L, gen_to_be_invoked.type);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
