...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIRoundedRectMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdrawRect", _g_get_drawRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlineWidth", _g_get_lineWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlineColor", _g_get_lineColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillColor", _g_get_fillColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettopLeftRadius", _g_get_topLeftRadius);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettopRightRadius", _g_get_topRightRadius);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbottomLeftRadius", _g_get_bottomLeftRadius);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbottomRightRadius", _g_get_bottomRightRadius);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdrawRect", _s_set_drawRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineWidth", _s_set_lineWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineColor", _s_set_lineColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillColor", _s_set_fillColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settopLeftRadius", _s_set_topLeftRadius);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settopRightRadius", _s_set_topRightRadius);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbottomLeftRadius", _s_set_bottomLeftRadius);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbottomRightRadius", _s_set_bottomRightRadius);
