...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGoWrapperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getwrapTarget", _g_get_wrapTarget);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsupportStencil", _g_get_supportStencil);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setwrapTarget", _s_set_wrapTarget);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsupportStencil", _s_set_supportStencil);
        ...
        static int _m_SetWrapTarget(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetWrapTarget( 
                        _target, 
                        _cloneMaterial );
