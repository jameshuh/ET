...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsUBBParserWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdefaultImgHeight", _g_get_defaultImgHeight);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdefaultImgWidth", _s_set_defaultImgWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdefaultImgHeight", _s_set_defaultImgHeight);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setinst", _s_set_inst);
		    ...
		    try {
                ...
                
                {
                    string _text = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.Parse( 
                        _text );
