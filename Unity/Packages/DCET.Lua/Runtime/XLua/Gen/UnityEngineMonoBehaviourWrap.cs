...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMonoBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseGUILayout", _g_get_useGUILayout);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseGUILayout", _s_set_useGUILayout);
        ...
        static int _m_InvokeRepeating(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.InvokeRepeating( 
                        _methodName, 
                        _time, 
                        _repeatRate );
        ...
        static int _m_StopCoroutine(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Collections.IEnumerator>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.StopCoroutine( 
                        _routine );
