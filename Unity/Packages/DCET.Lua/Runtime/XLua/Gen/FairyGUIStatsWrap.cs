...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIStatsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getObjectCount", _g_get_ObjectCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getGraphicsCount", _g_get_GraphicsCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getLatestObjectCreation", _g_get_LatestObjectCreation);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getLatestGraphicsCreation", _g_get_LatestGraphicsCreation);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setObjectCount", _s_set_ObjectCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setGraphicsCount", _s_set_GraphicsCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setLatestObjectCreation", _s_set_LatestObjectCreation);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setLatestGraphicsCreation", _s_set_LatestGraphicsCreation);
