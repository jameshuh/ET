		    ...
		    try {
                ...
                
                {
                    string _str = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Color gen_ret = FairyGUI.Utils.ToolSet.ConvertFromHtmlColor( 
                        _str );
		    ...
		    try {
                ...
                
                {
                    int _value = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.Color gen_ret = FairyGUI.Utils.ToolSet.ColorFromRGB( 
                        _value );
                        translator.PushUnityEngineColor(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _value = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.Color gen_ret = FairyGUI.Utils.ToolSet.ColorFromRGBA( 
                        _value );
                        translator.PushUnityEngineColor(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    char _c = (char)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        int gen_ret = FairyGUI.Utils.ToolSet.CharToHex( 
                        _c );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Rect _rect2;translator.Get(L, 2, out _rect2);
                        ...
                        UnityEngine.Rect gen_ret = FairyGUI.Utils.ToolSet.Intersection( 
                        ref _rect1, 
                        ref _rect2 );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Rect _rect2;translator.Get(L, 2, out _rect2);
                        ...
                        UnityEngine.Rect gen_ret = FairyGUI.Utils.ToolSet.Union( 
                        ref _rect1, 
                        ref _rect2 );
                        translator.Push(L, gen_ret);
                    translator.Push(L, _rect1);
        ...
        static int _m_SetParent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.Utils.ToolSet.SetParent( 
                        _t, 
                        _parent );
        ...
        static int _m_SkewMatrix_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.Utils.ToolSet.SkewMatrix( 
                        ref _matrix, 
                        _skewX, 
                        _skewY );
        ...
        static int _m_RotateUV_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.Utils.ToolSet.RotateUV( 
                        _uv, 
                        ref _baseUVRect );
