...
namespace XLua.CSObjectWrap
{
    ...
    public class BehaviorDesignerRuntimeTasksParallelSelectorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BehaviorDesigner.Runtime.Tasks.ParallelSelector);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BehaviorDesigner.Runtime.Tasks.ParallelSelector gen_ret = new BehaviorDesigner.Runtime.Tasks.ParallelSelector();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BehaviorDesigner.Runtime.Tasks.ParallelSelector constructor!");
        ...
        static int _m_OnAwake(RealStatePtr L)
        {
		    try {
                ...
                BehaviorDesigner.Runtime.Tasks.ParallelSelector gen_to_be_invoked = (BehaviorDesigner.Runtime.Tasks.ParallelSelector)translator.FastGetCSObj(L, 1);
