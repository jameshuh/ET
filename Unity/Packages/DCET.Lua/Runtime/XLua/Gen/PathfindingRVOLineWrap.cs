...
namespace XLua.CSObjectWrap
{
    ...
    public class PathfindingRVOLineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Pathfinding.RVO.Line);
		...
		public static int __clone__(RealStatePtr L)
		{
			...
			{
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				Pathfinding.RVO.Line gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(Pathfinding.RVO.Line));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Pathfinding.RVO.Line constructor!");
