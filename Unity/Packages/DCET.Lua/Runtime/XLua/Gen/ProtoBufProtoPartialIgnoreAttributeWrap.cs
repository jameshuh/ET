...
namespace XLua.CSObjectWrap
{
    ...
    public class ProtoBufProtoPartialIgnoreAttributeWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					ProtoBuf.ProtoPartialIgnoreAttribute gen_ret = new ProtoBuf.ProtoPartialIgnoreAttribute(_memberName);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to ProtoBuf.ProtoPartialIgnoreAttribute constructor!");
        ...
        static int _g_get_MemberName(RealStatePtr L)
        {
		    try {
                ...
                ProtoBuf.ProtoPartialIgnoreAttribute gen_to_be_invoked = (ProtoBuf.ProtoPartialIgnoreAttribute)translator.FastGetCSObj(L, 1);
