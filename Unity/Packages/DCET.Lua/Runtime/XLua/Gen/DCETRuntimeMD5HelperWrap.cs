...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimeMD5HelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCETRuntime.MD5Helper);
        ...
        {
            return LuaAPI.luaL_error(L, "DCETRuntime.MD5Helper does not have a constructor!");
        }
