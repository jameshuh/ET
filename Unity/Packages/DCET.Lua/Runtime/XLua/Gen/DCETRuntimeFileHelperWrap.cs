...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimeFileHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCETRuntime.FileHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "DCETRuntime.FileHelper does not have a constructor!");
        }
        ...
        static int _m_GetAllFiles_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.FileHelper.GetAllFiles( 
                        _files, 
                        _dir );
        ...
        static int _m_CleanDirectory_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    DCETRuntime.FileHelper.CleanDirectory( 
                        _dir );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCETRuntime.FileHelper.CleanDirectory!");
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _overwrite = LuaAPI.lua_toboolean(L, 3);
                        ...
                        bool gen_ret = DCETRuntime.FileHelper.CopyFile( 
                        _sourcePath, 
                        _targetPath, 
                        _overwrite );
        ...
        static int _m_CopyDirectory_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.FileHelper.CopyDirectory( 
                        _srcDir, 
                        _tgtDir );
        ...
        static int _m_ReplaceExtensionName_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.FileHelper.ReplaceExtensionName( 
                        _srcDir, 
                        _extensionName, 
                        _newExtensionName );
