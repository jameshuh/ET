...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRaycastHitWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 16, 11, 4);
			
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "__clone__", __clone__);
            			
						
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcollider", _g_get_collider);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpoint", _g_get_point);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnormal", _g_get_normal);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbarycentricCoordinate", _g_get_barycentricCoordinate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdistance", _g_get_distance);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettriangleIndex", _g_get_triangleIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettextureCoord", _g_get_textureCoord);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettextureCoord2", _g_get_textureCoord2);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettransform", _g_get_transform);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrigidbody", _g_get_rigidbody);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlightmapCoord", _g_get_lightmapCoord);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpoint", _s_set_point);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnormal", _s_set_normal);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbarycentricCoordinate", _s_set_barycentricCoordinate);
