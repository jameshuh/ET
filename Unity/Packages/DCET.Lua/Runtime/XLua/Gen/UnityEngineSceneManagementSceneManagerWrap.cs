...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSceneManagementSceneManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getsceneCount", _g_get_sceneCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getsceneCountInBuildSettings", _g_get_sceneCountInBuildSettings);
            
			
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addsceneLoaded", _e_add_sceneLoaded);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addsceneUnloaded", _e_add_sceneUnloaded);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "addactiveSceneChanged", _e_add_activeSceneChanged);
			
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removesceneLoaded", _e_remove_sceneLoaded);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removesceneUnloaded", _e_remove_sceneUnloaded);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "removeactiveSceneChanged", _e_remove_activeSceneChanged);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.SceneManagement.Scene _scene;translator.Get(L, 1, out _scene);
                        ...
                        bool gen_ret = UnityEngine.SceneManagement.SceneManager.SetActiveScene( 
                        _scene );
		    ...
		    try {
                ...
                
                {
                    string _scenePath = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.SceneManagement.Scene gen_ret = UnityEngine.SceneManagement.SceneManager.GetSceneByPath( 
                        _scenePath );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.SceneManagement.Scene gen_ret = UnityEngine.SceneManagement.SceneManager.GetSceneByName( 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _buildIndex = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.SceneManagement.Scene gen_ret = UnityEngine.SceneManagement.SceneManager.GetSceneByBuildIndex( 
                        _buildIndex );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.SceneManagement.Scene gen_ret = UnityEngine.SceneManagement.SceneManager.GetSceneAt( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _sceneName = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.SceneManagement.Scene gen_ret = UnityEngine.SceneManagement.SceneManager.CreateScene( 
                        _sceneName );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)) 
                {
                    int _sceneBuildIndex = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.AsyncOperation gen_ret = UnityEngine.SceneManagement.SceneManager.LoadSceneAsync( 
                        _sceneBuildIndex );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)) 
                {
                    int _sceneBuildIndex = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        UnityEngine.AsyncOperation gen_ret = UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync( 
                        _sceneBuildIndex );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_sceneLoaded(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene, UnityEngine.SceneManagement.LoadSceneMode> gen_delegate = translator.GetDelegate<UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene, UnityEngine.SceneManagement.LoadSceneMode>>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene, UnityEngine.SceneManagement.LoadSceneMode>!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_sceneUnloaded(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
                UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene> gen_delegate = translator.GetDelegate<UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene>>(L, 1);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#1 need UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene>!");
                }
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_add_activeSceneChanged(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_sceneLoaded(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _e_remove_sceneUnloaded(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    int gen_param_count = LuaAPI.lua_gettop(L);
