...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIControllerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 23, 7, 3);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getselectedPage", _g_get_selectedPage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getprevisousIndex", _g_get_previsousIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpreviousPage", _g_get_previousPage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpageCount", _g_get_pageCount);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setselectedPage", _s_set_selectedPage);
        ...
        static int _m_SetSelectedIndex(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetSelectedIndex( 
                        _value );
        ...
        static int _m_SetSelectedPage(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetSelectedPage( 
                        _value );
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.GetPageName( 
                        _index );
		    ...
		    try {
                ...
                
                {
                    string _aName = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = gen_to_be_invoked.GetPageIdByName( 
                        _aName );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_RemovePageAt(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemovePageAt( 
                        _index );
		    ...
		    try {
                ...
                
                {
                    string _aName = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.HasPage( 
                        _aName );
