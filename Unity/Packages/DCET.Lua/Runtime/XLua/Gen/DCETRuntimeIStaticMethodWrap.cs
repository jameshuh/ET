...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimeIStaticMethodWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCETRuntime.IStaticMethod);
        ...
        {
            return LuaAPI.luaL_error(L, "DCETRuntime.IStaticMethod does not have a constructor!");
        }
        ...
        static int _m_Run(RealStatePtr L)
        {
		    try {
                ...
                DCETRuntime.IStaticMethod gen_to_be_invoked = (DCETRuntime.IStaticMethod)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCETRuntime.IStaticMethod.Run!");
