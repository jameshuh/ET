...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 1, 8, 2, 2);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethideFlags", _g_get_hideFlags);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setname", _s_set_name);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethideFlags", _s_set_hideFlags);
        ...
        {					
			...
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
                UnityEngine.Object rightside = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
				
                LuaAPI.lua_pushboolean(L,  rightside)
				;
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Object>(L, 1)) 
                {
                    UnityEngine.Object _original = (UnityEngine.Object)translator.GetObject(L, 1, typeof(UnityEngine.Object));
                        ...
                        UnityEngine.Object gen_ret = UnityEngine.Object.Instantiate( 
                        _original );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        UnityEngine.Object[] gen_ret = UnityEngine.Object.FindObjectsOfType( 
                        _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        UnityEngine.Object gen_ret = UnityEngine.Object.FindObjectOfType( 
                        _type );
                        translator.Push(L, gen_ret);
