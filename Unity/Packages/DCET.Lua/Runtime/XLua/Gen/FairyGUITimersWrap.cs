...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITimersWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 15, 4, 3);
			
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getinst", _g_get_inst);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getrepeat", _g_get_repeat);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettime", _g_get_time);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcatchCallbackExceptions", _g_get_catchCallbackExceptions);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setrepeat", _s_set_repeat);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "settime", _s_set_time);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setcatchCallbackExceptions", _s_set_catchCallbackExceptions);
        ...
        static int _m_StartCoroutine(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.StartCoroutine( 
                        _routine );
