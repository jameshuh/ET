...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITextFieldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethtmlText", _g_get_htmlText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getparsedText", _g_get_parsedText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getautoSize", _g_get_autoSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getwordWrap", _g_get_wordWrap);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsingleLine", _g_get_singleLine);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstroke", _g_get_stroke);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstrokeColor", _g_get_strokeColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowOffset", _g_get_shadowOffset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettextWidth", _g_get_textWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettextHeight", _g_get_textHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmaxWidth", _g_get_maxWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethtmlElements", _g_get_htmlElements);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlines", _g_get_lines);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcharPositions", _g_get_charPositions);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethtmlText", _s_set_htmlText);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setautoSize", _s_set_autoSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setwordWrap", _s_set_wordWrap);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsingleLine", _s_set_singleLine);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstroke", _s_set_stroke);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstrokeColor", _s_set_strokeColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowOffset", _s_set_shadowOffset);
        ...
        static int _m_GetLinesShape(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.GetLinesShape( 
                        _startLine, 
                        _startCharX, 
                        _endLine, 
                        _endCharX, 
        ...
        static int _g_get_autoSize(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.TextField gen_to_be_invoked = (FairyGUI.TextField)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIAutoSizeType(L, gen_to_be_invoked.autoSize);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
