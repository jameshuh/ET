...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIRelationsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethandling", _g_get_handling);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethandling", _s_set_handling);
        ...
        static int _m_OnOwnerSizeChanged(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.OnOwnerSizeChanged( 
                        _dWidth, 
                        _dHeight, 
                        _applyPivot );
