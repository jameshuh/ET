...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIRTLSupportWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getBaseDirection", _g_get_BaseDirection);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setBaseDirection", _s_set_BaseDirection);
		    ...
		    try {
                ...
                
                {
                    char _ch = (char)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        bool gen_ret = FairyGUI.RTLSupport.IsArabicLetter( 
                        _ch );
		    ...
		    try {
                ...
                
                {
                    string _text = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = FairyGUI.RTLSupport.ContainsArabicLetters( 
                        _text );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _text = LuaAPI.lua_tostring(L, 1);
                        ...
                        FairyGUI.RTLSupport.DirectionType gen_ret = FairyGUI.RTLSupport.DetectTextDirection( 
                        _text );
                        translator.PushFairyGUIRTLSupportDirectionType(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _input = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.RTLSupport.DoMapping( 
                        _input );
		    ...
		    try {
                ...
                
                {
                    string _source = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.RTLSupport.ConvertLineL( 
                        _source );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _source = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.RTLSupport.ConvertLineR( 
                        _source );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _g_get_BaseDirection(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushFairyGUIRTLSupportDirectionType(L, FairyGUI.RTLSupport.BaseDirection);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
