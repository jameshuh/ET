...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimeReferenceCollectorDataWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCETRuntime.ReferenceCollectorData gen_ret = new DCETRuntime.ReferenceCollectorData();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCETRuntime.ReferenceCollectorData constructor!");
        ...
        static int _g_get_key(RealStatePtr L)
        {
		    try {
                ...
                DCETRuntime.ReferenceCollectorData gen_to_be_invoked = (DCETRuntime.ReferenceCollectorData)translator.FastGetCSObj(L, 1);
