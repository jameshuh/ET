...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIConfigConfigValueWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvalid", _g_get_valid);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gets", _g_get_s);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geti", _g_get_i);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getf", _g_get_f);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getb", _g_get_b);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getc", _g_get_c);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvalid", _s_set_valid);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sets", _s_set_s);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "seti", _s_set_i);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setf", _s_set_f);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setb", _s_set_b);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setc", _s_set_c);
