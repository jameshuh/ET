...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGTweenerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 32, 12, 0);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getduration", _g_get_duration);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrepeat", _g_get_repeat);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettarget", _g_get_target);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuserData", _g_get_userData);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstartValue", _g_get_startValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getendValue", _g_get_endValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvalue", _g_get_value);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdeltaValue", _g_get_deltaValue);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnormalizedTime", _g_get_normalizedTime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcompleted", _g_get_completed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getallCompleted", _g_get_allCompleted);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetDelay( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetDuration( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetBreakpoint( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.EaseType _value;translator.Get(L, 2, out _value);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetEase( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetEasePeriod( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetEaseOvershootOrAmplitude( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _yoyo = LuaAPI.lua_toboolean(L, 3);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetRepeat( 
                        _repeat, 
                        _yoyo );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    float _value = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetTimeScale( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    bool _value = LuaAPI.lua_toboolean(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetIgnoreEngineTimeScale( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    bool _value = LuaAPI.lua_toboolean(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetSnapping( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 2)) 
                {
                    object _value = translator.GetObject(L, 2, typeof(object));
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetTarget( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    object _value = translator.GetObject(L, 2, typeof(object));
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetUserData( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.GTweenCallback>(L, 2)) 
                {
                    FairyGUI.GTweenCallback _callback = translator.GetDelegate<FairyGUI.GTweenCallback>(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.OnUpdate( 
                        _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.GTweenCallback>(L, 2)) 
                {
                    FairyGUI.GTweenCallback _callback = translator.GetDelegate<FairyGUI.GTweenCallback>(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.OnStart( 
                        _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.GTweenCallback>(L, 2)) 
                {
                    FairyGUI.GTweenCallback _callback = translator.GetDelegate<FairyGUI.GTweenCallback>(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.OnComplete( 
                        _callback );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.ITweenListener _value = (FairyGUI.ITweenListener)translator.GetObject(L, 2, typeof(FairyGUI.ITweenListener));
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetListener( 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    bool _paused = LuaAPI.lua_toboolean(L, 2);
                        ...
                        FairyGUI.GTweener gen_ret = gen_to_be_invoked.SetPaused( 
                        _paused );
                        translator.Push(L, gen_ret);
