...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 50, 25, 22);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfill", _g_get_fill);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshrinkOnly", _g_get_shrinkOnly);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getautoSize", _g_get_autoSize);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillMethod", _g_get_fillMethod);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillOrigin", _g_get_fillOrigin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillClockwise", _g_get_fillClockwise);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfillAmount", _g_get_fillAmount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getimage", _g_get_image);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmovieClip", _g_get_movieClip);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshowErrorSign", _g_get_showErrorSign);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfill", _s_set_fill);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshrinkOnly", _s_set_shrinkOnly);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setautoSize", _s_set_autoSize);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillMethod", _s_set_fillMethod);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillOrigin", _s_set_fillOrigin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillClockwise", _s_set_fillClockwise);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfillAmount", _s_set_fillAmount);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshowErrorSign", _s_set_showErrorSign);
        ...
        static int _g_get_fill(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GLoader gen_to_be_invoked = (FairyGUI.GLoader)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIFillType(L, gen_to_be_invoked.fill);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_fillMethod(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GLoader gen_to_be_invoked = (FairyGUI.GLoader)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIFillMethod(L, gen_to_be_invoked.fillMethod);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
