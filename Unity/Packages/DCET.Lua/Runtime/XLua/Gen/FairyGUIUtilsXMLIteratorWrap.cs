...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsXMLIteratorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 24, 3, 3);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "gettagName", _g_get_tagName);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettagType", _g_get_tagType);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getlastTagName", _g_get_lastTagName);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "settagName", _s_set_tagName);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "settagType", _s_set_tagType);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setlastTagName", _s_set_lastTagName);
        ...
        static int _m_Begin_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    FairyGUI.Utils.XMLIterator.Begin( 
                        _source, 
                        _lowerCaseName );
		    ...
		    try {
                ...
                
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = FairyGUI.Utils.XMLIterator.HasAttribute( 
                        _attrName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = FairyGUI.Utils.XMLIterator.GetAttribute( 
                        _attrName );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        int gen_ret = FairyGUI.Utils.XMLIterator.GetAttributeInt( 
                        _attrName );
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _attrName = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = FairyGUI.Utils.XMLIterator.GetAttributeBool( 
                        _attrName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<System.Collections.Generic.Dictionary<string, string>>(L, 1)) 
                {
                    System.Collections.Generic.Dictionary<string, string> _result = (System.Collections.Generic.Dictionary<string, string>)translator.GetObject(L, 1, typeof(System.Collections.Generic.Dictionary<string, string>));
                        ...
                        System.Collections.Generic.Dictionary<string, string> gen_ret = FairyGUI.Utils.XMLIterator.GetAttributes( 
                        _result );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<System.Collections.Hashtable>(L, 1)) 
                {
                    System.Collections.Hashtable _result = (System.Collections.Hashtable)translator.GetObject(L, 1, typeof(System.Collections.Hashtable));
                        ...
                        System.Collections.Hashtable gen_ret = FairyGUI.Utils.XMLIterator.GetAttributes( 
                        _result );
                        translator.Push(L, gen_ret);
        ...
        static int _g_get_tagType(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushFairyGUIUtilsXMLTagType(L, FairyGUI.Utils.XMLIterator.tagType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
