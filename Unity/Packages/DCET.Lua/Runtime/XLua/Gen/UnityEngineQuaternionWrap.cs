...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineQuaternionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 2, 20, 6, 5);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 21, 1, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getkEpsilon", UnityEngine.Quaternion.kEpsilon);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getidentity", _g_get_identity);
		...
		public static int __clone__(RealStatePtr L)
		{
			try
			{
				...
				translator.PushUnityEngineQuaternion(L, gen_to_be_invoked);
				return 1;
			}
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _toDirection;translator.Get(L, 2, out _toDirection);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.FromToRotation( 
                        _fromDirection, 
                        _toDirection );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Quaternion _rotation;translator.Get(L, 1, out _rotation);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.Inverse( 
                        _rotation );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.Slerp( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.SlerpUnclamped( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.Lerp( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.LerpUnclamped( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _axis;translator.Get(L, 2, out _axis);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.AngleAxis( 
                        _angle, 
                        _axis );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Vector3>(L, 1)) 
                {
                    UnityEngine.Vector3 _forward;translator.Get(L, 1, out _forward);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.LookRotation( 
                        _forward );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Quaternion _b;translator.Get(L, 2, out _b);
                        ...
                        float gen_ret = UnityEngine.Quaternion.Dot( 
                        _a, 
                        _b );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Quaternion _b;translator.Get(L, 2, out _b);
                        ...
                        float gen_ret = UnityEngine.Quaternion.Angle( 
                        _a, 
                        _b );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _z = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.Euler( 
                        _x, 
                        _y, 
                        _z );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
        ...
        static int _m_SetFromToRotation(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetFromToRotation( 
                        _fromDirection, 
                        _toDirection );
		    ...
		    try {
                ...
                
                {
                    ...
                    float _maxDegreesDelta = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Quaternion gen_ret = UnityEngine.Quaternion.RotateTowards( 
                        _from, 
                        _to, 
                        _maxDegreesDelta );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
