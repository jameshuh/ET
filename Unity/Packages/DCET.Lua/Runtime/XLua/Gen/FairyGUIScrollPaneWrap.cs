...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIScrollPaneWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 70, 33, 18);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonScroll", _g_get_onScroll);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonScrollEnd", _g_get_onScrollEnd);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonPullDownRelease", _g_get_onPullDownRelease);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonPullUpRelease", _g_get_onPullUpRelease);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getowner", _g_get_owner);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethzScrollBar", _g_get_hzScrollBar);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvtScrollBar", _g_get_vtScrollBar);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getheader", _g_get_header);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfooter", _g_get_footer);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbouncebackEffect", _g_get_bouncebackEffect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettouchEffect", _g_get_touchEffect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinertiaDisabled", _g_get_inertiaDisabled);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsoftnessOnTopOrLeftSide", _g_get_softnessOnTopOrLeftSide);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscrollStep", _g_get_scrollStep);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsnapToItem", _g_get_snapToItem);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpageMode", _g_get_pageMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpageController", _g_get_pageController);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmouseWheelEnabled", _g_get_mouseWheelEnabled);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdecelerationRate", _g_get_decelerationRate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpercX", _g_get_percX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpercY", _g_get_percY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getposX", _g_get_posX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getposY", _g_get_posY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisBottomMost", _g_get_isBottomMost);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisRightMost", _g_get_isRightMost);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcurrentPageX", _g_get_currentPageX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcurrentPageY", _g_get_currentPageY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscrollingPosX", _g_get_scrollingPosX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscrollingPosY", _g_get_scrollingPosY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontentWidth", _g_get_contentWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontentHeight", _g_get_contentHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getviewWidth", _g_get_viewWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getviewHeight", _g_get_viewHeight);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbouncebackEffect", _s_set_bouncebackEffect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settouchEffect", _s_set_touchEffect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinertiaDisabled", _s_set_inertiaDisabled);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsoftnessOnTopOrLeftSide", _s_set_softnessOnTopOrLeftSide);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscrollStep", _s_set_scrollStep);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsnapToItem", _s_set_snapToItem);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpageMode", _s_set_pageMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpageController", _s_set_pageController);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmouseWheelEnabled", _s_set_mouseWheelEnabled);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdecelerationRate", _s_set_decelerationRate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpercX", _s_set_percX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpercY", _s_set_percY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setposX", _s_set_posX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setposY", _s_set_posY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcurrentPageX", _s_set_currentPageX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcurrentPageY", _s_set_currentPageY);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setviewWidth", _s_set_viewWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setviewHeight", _s_set_viewHeight);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getdraggingPane", _g_get_draggingPane);
        ...
        static int _m_SetCurrentPageX(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetCurrentPageX( 
                        _value, 
                        _ani );
        ...
        static int _m_SetCurrentPageY(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetCurrentPageY( 
                        _value, 
                        _ani );
        ...
        static int _m_ScrollToView(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.GObject>(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.ScrollToView( 
                        _obj );
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GObject _obj = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                        ...
                        bool gen_ret = gen_to_be_invoked.IsChildInView( 
                        _obj );
