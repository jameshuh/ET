...
namespace XLua.CSObjectWrap
{
    ...
    public class PathfindingProgressWrap 
    {
		...
		public static int __clone__(RealStatePtr L)
		{
			...
			{
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				Pathfinding.Progress gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING))
				{
					...
					Pathfinding.Progress gen_ret = new Pathfinding.Progress(_progress, _description);
				...
				{
				    translator.Push(L, default(Pathfinding.Progress));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Pathfinding.Progress constructor!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_MapTo(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _prefix = LuaAPI.lua_tostring(L, 4);
                        ...
                        Pathfinding.Progress gen_ret = gen_to_be_invoked.MapTo( 
                        _min, 
                        _max, 
                        _prefix );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Pathfinding.Progress.MapTo!");
