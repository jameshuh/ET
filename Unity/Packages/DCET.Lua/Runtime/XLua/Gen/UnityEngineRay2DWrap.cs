...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRay2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdirection", _g_get_direction);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setorigin", _s_set_origin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdirection", _s_set_direction);
		...
		public static int __clone__(RealStatePtr L)
		{
			try
			{
				...
				translator.PushUnityEngineRay2D(L, gen_to_be_invoked);
				return 1;
			}
		    ...
		    try {
                ...
                
                {
                    float _distance = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.GetPoint( 
                        _distance );
