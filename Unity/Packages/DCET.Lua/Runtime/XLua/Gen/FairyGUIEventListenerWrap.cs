...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIEventListenerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Remove1", _m_Remove1);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Add", _m_Add);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Remove", _m_Remove);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Set1", _m_Set1);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisDispatching", _g_get_isDispatching);
        ...
        static int _m_RemoveCapture(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveCapture( 
                        _callback );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Add1(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Remove1(RealStatePtr L)
        {
		    try {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_Set1(RealStatePtr L)
        {
		    try {
