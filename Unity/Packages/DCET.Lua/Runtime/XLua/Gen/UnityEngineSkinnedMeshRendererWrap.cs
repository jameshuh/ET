...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineSkinnedMeshRendererWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 19, 8, 8);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getupdateWhenOffscreen", _g_get_updateWhenOffscreen);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getforceMatrixRecalculationPerRender", _g_get_forceMatrixRecalculationPerRender);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrootBone", _g_get_rootBone);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbones", _g_get_bones);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsharedMesh", _g_get_sharedMesh);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getskinnedMotionVectors", _g_get_skinnedMotionVectors);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setupdateWhenOffscreen", _s_set_updateWhenOffscreen);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setforceMatrixRecalculationPerRender", _s_set_forceMatrixRecalculationPerRender);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrootBone", _s_set_rootBone);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbones", _s_set_bones);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsharedMesh", _s_set_sharedMesh);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setskinnedMotionVectors", _s_set_skinnedMotionVectors);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        float gen_ret = gen_to_be_invoked.GetBlendShapeWeight( 
                        _index );
        ...
        static int _m_SetBlendShapeWeight(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetBlendShapeWeight( 
                        _index, 
                        _value );
