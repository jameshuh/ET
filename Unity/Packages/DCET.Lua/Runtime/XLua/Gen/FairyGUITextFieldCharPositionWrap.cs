...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITextFieldCharPositionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlineIndex", _g_get_lineIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoffsetX", _g_get_offsetX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvertCount", _g_get_vertCount);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcharIndex", _s_set_charIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlineIndex", _s_set_lineIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoffsetX", _s_set_offsetX);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvertCount", _s_set_vertCount);
