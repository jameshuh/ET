...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAsyncOperationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 9, 4, 2);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getallowSceneActivation", _g_get_allowSceneActivation);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpriority", _s_set_priority);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setallowSceneActivation", _s_set_allowSceneActivation);
		...
		static int _e_add_completed(RealStatePtr L)
		{
			try {
				...
				int gen_param_count = LuaAPI.lua_gettop(L);
			UnityEngine.AsyncOperation gen_to_be_invoked = (UnityEngine.AsyncOperation)translator.FastGetCSObj(L, 1);
				System.Action<UnityEngine.AsyncOperation> gen_delegate = translator.GetDelegate<System.Action<UnityEngine.AsyncOperation>>(L, 2);
				if (gen_delegate == null) {
					return LuaAPI.luaL_error(L, "#2 need System.Action<UnityEngine.AsyncOperation>!");
				}
