...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGTextFieldWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 31, 14, 12);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettemplateVars", _g_get_templateVars);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getUBBEnabled", _g_get_UBBEnabled);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settemplateVars", _s_set_templateVars);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setUBBEnabled", _s_set_UBBEnabled);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _value = LuaAPI.lua_tostring(L, 3);
                        ...
                        FairyGUI.GTextField gen_ret = gen_to_be_invoked.SetVar( 
                        _name, 
                        _value );
                        translator.Push(L, gen_ret);
