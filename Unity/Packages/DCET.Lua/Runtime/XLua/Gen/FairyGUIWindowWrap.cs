...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIWindowWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbringToFontOnClick", _g_get_bringToFontOnClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontentPane", _g_get_contentPane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getframe", _g_get_frame);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcloseButton", _g_get_closeButton);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdragArea", _g_get_dragArea);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontentArea", _g_get_contentArea);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmodalWaitingPane", _g_get_modalWaitingPane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisShowing", _g_get_isShowing);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisTop", _g_get_isTop);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmodal", _g_get_modal);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmodalWaiting", _g_get_modalWaiting);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbringToFontOnClick", _s_set_bringToFontOnClick);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcontentPane", _s_set_contentPane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcloseButton", _s_set_closeButton);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdragArea", _s_set_dragArea);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcontentArea", _s_set_contentArea);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmodal", _s_set_modal);
