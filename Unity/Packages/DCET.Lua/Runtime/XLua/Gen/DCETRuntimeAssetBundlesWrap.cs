...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimeAssetBundlesWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCETRuntime.AssetBundles);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DCETRuntime.AssetBundles gen_ret = new DCETRuntime.AssetBundles();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DCETRuntime.AssetBundles constructor!");
        ...
        static int _m_LoadAssetAsync(RealStatePtr L)
        {
		    try {
                ...
                DCETRuntime.AssetBundles gen_to_be_invoked = (DCETRuntime.AssetBundles)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_Default(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, DCETRuntime.AssetBundles.Default);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
