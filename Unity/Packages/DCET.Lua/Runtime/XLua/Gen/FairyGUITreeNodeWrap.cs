...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITreeNodeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.TreeNode);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettree", _g_get_tree);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcell", _g_get_cell);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlevel", _g_get_level);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getexpanded", _g_get_expanded);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisFolder", _g_get_isFolder);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setexpanded", _s_set_expanded);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2))
				{
					...
					FairyGUI.TreeNode gen_ret = new FairyGUI.TreeNode(_hasChild);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.TreeNode constructor!");
        ...
        static int _m_AddChild(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.TreeNode gen_to_be_invoked = (FairyGUI.TreeNode)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    FairyGUI.TreeNode _child = (FairyGUI.TreeNode)translator.GetObject(L, 2, typeof(FairyGUI.TreeNode));
                    
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.AddChild( 
                        _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.AddChildAt( 
                        _child, 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.TreeNode _child = (FairyGUI.TreeNode)translator.GetObject(L, 2, typeof(FairyGUI.TreeNode));
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.RemoveChild( 
                        _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.RemoveChildAt( 
                        _index );
                        translator.Push(L, gen_ret);
        ...
        static int _m_RemoveChildren(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.TreeNode.RemoveChildren!");
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.GetChildAt( 
                        _index );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetPrevSibling(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.GetPrevSibling(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_GetNextSibling(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        FairyGUI.TreeNode gen_ret = gen_to_be_invoked.GetNextSibling(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SwapChildren(RealStatePtr L)
        {
		    try {
                ...
                {
                    FairyGUI.TreeNode _child1 = (FairyGUI.TreeNode)translator.GetObject(L, 2, typeof(FairyGUI.TreeNode));
                    FairyGUI.TreeNode _child2 = (FairyGUI.TreeNode)translator.GetObject(L, 3, typeof(FairyGUI.TreeNode));
