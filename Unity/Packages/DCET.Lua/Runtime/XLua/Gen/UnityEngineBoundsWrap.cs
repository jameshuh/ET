...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineBoundsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 1, 22, 5, 5);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getextents", _g_get_extents);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmin", _g_get_min);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmax", _g_get_max);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcenter", _s_set_center);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsize", _s_set_size);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setextents", _s_set_extents);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmin", _s_set_min);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmax", _s_set_max);
		...
		public static int __clone__(RealStatePtr L)
		{
			try
			{
				...
				translator.PushUnityEngineBounds(L, gen_to_be_invoked);
				return 1;
			}
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Bounds _bounds;translator.Get(L, 2, out _bounds);
                        ...
                        bool gen_ret = gen_to_be_invoked.Intersects( 
                        _bounds );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Ray>(L, 2)) 
                {
                    UnityEngine.Ray _ray;translator.Get(L, 2, out _ray);
                        ...
                        bool gen_ret = gen_to_be_invoked.IntersectRay( 
                        _ray );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Ray>(L, 2)) 
                {
                    UnityEngine.Ray _ray;translator.Get(L, 2, out _ray);
                    float _distance;
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _point;translator.Get(L, 2, out _point);
                        ...
                        float gen_ret = gen_to_be_invoked.SqrDistance( 
                        _point );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _point;translator.Get(L, 2, out _point);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.ClosestPoint( 
                        _point );
