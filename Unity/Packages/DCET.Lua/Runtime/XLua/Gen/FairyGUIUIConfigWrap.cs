...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUIConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getPreloadPackages", _g_get_PreloadPackages);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setItems", _s_set_Items);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setPreloadPackages", _s_set_PreloadPackages);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 122, 30, 30);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "ClearResourceRefs", _m_ClearResourceRefs_xlua_st_);
            
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultFont", _g_get_defaultFont);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getrenderingTextBrighterOnDesktop", _g_get_renderingTextBrighterOnDesktop);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getwindowModalWaiting", _g_get_windowModalWaiting);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getglobalModalWaiting", _g_get_globalModalWaiting);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmodalLayerColor", _g_get_modalLayerColor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getbuttonSound", _g_get_buttonSound);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getbuttonSoundVolumeScale", _g_get_buttonSoundVolumeScale);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gethorizontalScrollBar", _g_get_horizontalScrollBar);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getverticalScrollBar", _g_get_verticalScrollBar);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultScrollStep", _g_get_defaultScrollStep);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultScrollDecelerationRate", _g_get_defaultScrollDecelerationRate);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultScrollBarDisplay", _g_get_defaultScrollBarDisplay);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultScrollTouchEffect", _g_get_defaultScrollTouchEffect);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultScrollBounceEffect", _g_get_defaultScrollBounceEffect);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getpopupMenu", _g_get_popupMenu);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getpopupMenu_seperator", _g_get_popupMenu_seperator);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getloaderErrorSign", _g_get_loaderErrorSign);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettooltipsWin", _g_get_tooltipsWin);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdefaultComboBoxVisibleItemCount", _g_get_defaultComboBoxVisibleItemCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettouchScrollSensitivity", _g_get_touchScrollSensitivity);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettouchDragSensitivity", _g_get_touchDragSensitivity);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getclickDragSensitivity", _g_get_clickDragSensitivity);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getallowSoftnessOnTopOrLeftSide", _g_get_allowSoftnessOnTopOrLeftSide);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getbringWindowToFrontOnClick", _g_get_bringWindowToFrontOnClick);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getinputCaretSize", _g_get_inputCaretSize);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getinputHighlightColor", _g_get_inputHighlightColor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getframeTimeForAsyncUIConstruction", _g_get_frameTimeForAsyncUIConstruction);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdepthSupportForPaintingMode", _g_get_depthSupportForPaintingMode);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getenhancedTextOutlineEffect", _g_get_enhancedTextOutlineEffect);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getsoundLoader", _g_get_soundLoader);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setdefaultFont", _s_set_defaultFont);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setrenderingTextBrighterOnDesktop", _s_set_renderingTextBrighterOnDesktop);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setwindowModalWaiting", _s_set_windowModalWaiting);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setglobalModalWaiting", _s_set_globalModalWaiting);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setmodalLayerColor", _s_set_modalLayerColor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setbuttonSound", _s_set_buttonSound);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setbuttonSoundVolumeScale", _s_set_buttonSoundVolumeScale);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "sethorizontalScrollBar", _s_set_horizontalScrollBar);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setverticalScrollBar", _s_set_verticalScrollBar);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setdefaultScrollStep", _s_set_defaultScrollStep);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setdefaultScrollDecelerationRate", _s_set_defaultScrollDecelerationRate);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setdefaultScrollBarDisplay", _s_set_defaultScrollBarDisplay);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setdefaultScrollTouchEffect", _s_set_defaultScrollTouchEffect);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setdefaultScrollBounceEffect", _s_set_defaultScrollBounceEffect);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setpopupMenu", _s_set_popupMenu);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setpopupMenu_seperator", _s_set_popupMenu_seperator);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setloaderErrorSign", _s_set_loaderErrorSign);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "settooltipsWin", _s_set_tooltipsWin);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setdefaultComboBoxVisibleItemCount", _s_set_defaultComboBoxVisibleItemCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "settouchScrollSensitivity", _s_set_touchScrollSensitivity);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "settouchDragSensitivity", _s_set_touchDragSensitivity);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setclickDragSensitivity", _s_set_clickDragSensitivity);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setallowSoftnessOnTopOrLeftSide", _s_set_allowSoftnessOnTopOrLeftSide);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setbringWindowToFrontOnClick", _s_set_bringWindowToFrontOnClick);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setinputCaretSize", _s_set_inputCaretSize);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setinputHighlightColor", _s_set_inputHighlightColor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setframeTimeForAsyncUIConstruction", _s_set_frameTimeForAsyncUIConstruction);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setdepthSupportForPaintingMode", _s_set_depthSupportForPaintingMode);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setenhancedTextOutlineEffect", _s_set_enhancedTextOutlineEffect);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setsoundLoader", _s_set_soundLoader);
        ...
        static int _g_get_defaultScrollBarDisplay(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushFairyGUIScrollBarDisplayType(L, FairyGUI.UIConfig.defaultScrollBarDisplay);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
