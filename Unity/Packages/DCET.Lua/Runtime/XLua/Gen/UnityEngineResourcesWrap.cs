		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        UnityEngine.Object[] gen_ret = UnityEngine.Resources.FindObjectsOfTypeAll( 
                        _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Object gen_ret = UnityEngine.Resources.Load( 
                        _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Object[] gen_ret = UnityEngine.Resources.LoadAll( 
                        _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Object gen_ret = UnityEngine.Resources.GetBuiltinResource( 
                        _type, 
                        _path );
                        translator.Push(L, gen_ret);
