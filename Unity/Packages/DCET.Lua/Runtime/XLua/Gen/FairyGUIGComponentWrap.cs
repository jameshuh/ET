...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 59, 17, 10);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrootContainer", _g_get_rootContainer);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcontainer", _g_get_container);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscrollPane", _g_get_scrollPane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getonDrop", _g_get_onDrop);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfairyBatching", _g_get_fairyBatching);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getopaque", _g_get_opaque);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmargin", _g_get_margin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildrenRenderOrder", _g_get_childrenRenderOrder);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getapexIndex", _g_get_apexIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnumChildren", _g_get_numChildren);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getControllers", _g_get_Controllers);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getclipSoftness", _g_get_clipSoftness);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbaseUserData", _g_get_baseUserData);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfairyBatching", _s_set_fairyBatching);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setopaque", _s_set_opaque);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmargin", _s_set_margin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setchildrenRenderOrder", _s_set_childrenRenderOrder);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setapexIndex", _s_set_apexIndex);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setclipSoftness", _s_set_clipSoftness);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GObject _child = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.AddChild( 
                        _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.AddChildAt( 
                        _child, 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<FairyGUI.GObject>(L, 2)) 
                {
                    FairyGUI.GObject _child = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.RemoveChild( 
                        _child );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.RemoveChildAt( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.GetChildAt( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.GetChild( 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.GetVisibleChild( 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _name = LuaAPI.lua_tostring(L, 3);
                        ...
                        FairyGUI.GObject gen_ret = gen_to_be_invoked.GetChildInGroup( 
                        _group, 
                        _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GObject _child = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                        ...
                        int gen_ret = gen_to_be_invoked.GetChildIndex( 
                        _child );
        ...
        static int _m_SetChildIndex(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetChildIndex( 
                        _child, 
                        _index );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _index = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        int gen_ret = gen_to_be_invoked.SetChildIndexBefore( 
                        _child, 
                        _index );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_SwapChildren(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SwapChildren( 
                        _child1, 
                        _child2 );
        ...
        static int _m_SwapChildrenAt(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SwapChildrenAt( 
                        _index1, 
                        _index2 );
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GObject _obj = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                        ...
                        bool gen_ret = gen_to_be_invoked.IsAncestorOf( 
                        _obj );
        ...
        static int _m_AddController(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddController( 
                        _controller );
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.Controller gen_ret = gen_to_be_invoked.GetControllerAt( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.Controller gen_ret = gen_to_be_invoked.GetController( 
                        _name );
                        translator.Push(L, gen_ret);
        ...
        static int _m_RemoveController(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveController( 
                        _c );
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        FairyGUI.Transition gen_ret = gen_to_be_invoked.GetTransitionAt( 
                        _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.Transition gen_ret = gen_to_be_invoked.GetTransition( 
                        _name );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ConstructFromXML(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ConstructFromXML( 
                        _xml );
        ...
        static int _g_get_childrenRenderOrder(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.GComponent gen_to_be_invoked = (FairyGUI.GComponent)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIChildrenRenderOrder(L, gen_to_be_invoked.childrenRenderOrder);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
