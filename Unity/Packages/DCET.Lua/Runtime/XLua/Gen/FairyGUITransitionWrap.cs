...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUITransitionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 25, 5, 3);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinvalidateBatchingEveryFrame", _g_get_invalidateBatchingEveryFrame);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinvalidateBatchingEveryFrame", _s_set_invalidateBatchingEveryFrame);
        ...
        static int _m_ChangePlayTimes(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ChangePlayTimes( 
                        _value );
		    ...
		    try {
                ...
                
                {
                    string _label = LuaAPI.lua_tostring(L, 2);
                        ...
                        float gen_ret = gen_to_be_invoked.GetLabelTime( 
                        _label );
