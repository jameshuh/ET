...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector3Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 6, 19, 6, 3);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToUnityV3", _m_ToUnityV3);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToPFV3", _m_ToPFV3);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ToV2", _m_ToV2);
						
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnormalized", _g_get_normalized);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmagnitude", _g_get_magnitude);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsqrMagnitude", _g_get_sqrMagnitude);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 55, 10, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getkEpsilon", UnityEngine.Vector3.kEpsilon);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getkEpsilonNormalSqrt", UnityEngine.Vector3.kEpsilonNormalSqrt);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getzero", _g_get_zero);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getone", _g_get_one);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getforward", _g_get_forward);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getback", _g_get_back);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getup", _g_get_up);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdown", _g_get_down);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getleft", _g_get_left);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getright", _g_get_right);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getpositiveInfinity", _g_get_positiveInfinity);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getnegativeInfinity", _g_get_negativeInfinity);
		...
		public static int __clone__(RealStatePtr L)
		{
			try
			{
				...
				translator.PushUnityEngineVector3(L, gen_to_be_invoked);
				return 1;
			}
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Slerp( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.SlerpUnclamped( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _maxMagnitudeDelta = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.RotateTowards( 
                        _current, 
                        _target, 
                        _maxRadiansDelta, 
                        _maxMagnitudeDelta );
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Lerp( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _t = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.LerpUnclamped( 
                        _a, 
                        _b, 
                        _t );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _maxDistanceDelta = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.MoveTowards( 
                        _current, 
                        _target, 
                        _maxDistanceDelta );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Vector3>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _smoothTime = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.SmoothDamp( 
                        _current, 
                        _target, 
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _b;translator.Get(L, 2, out _b);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Scale( 
                        _a, 
                        _b );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _rhs;translator.Get(L, 2, out _rhs);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Cross( 
                        _lhs, 
                        _rhs );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _inNormal;translator.Get(L, 2, out _inNormal);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Reflect( 
                        _inDirection, 
                        _inNormal );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _value;translator.Get(L, 1, out _value);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Normalize( 
                        _value );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _rhs;translator.Get(L, 2, out _rhs);
                        ...
                        float gen_ret = UnityEngine.Vector3.Dot( 
                        _lhs, 
                        _rhs );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _onNormal;translator.Get(L, 2, out _onNormal);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Project( 
                        _vector, 
                        _onNormal );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _planeNormal;translator.Get(L, 2, out _planeNormal);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.ProjectOnPlane( 
                        _vector, 
                        _planeNormal );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _to;translator.Get(L, 2, out _to);
                        ...
                        float gen_ret = UnityEngine.Vector3.Angle( 
                        _from, 
                        _to );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _axis;translator.Get(L, 3, out _axis);
                        ...
                        float gen_ret = UnityEngine.Vector3.SignedAngle( 
                        _from, 
                        _to, 
                        _axis );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _b;translator.Get(L, 2, out _b);
                        ...
                        float gen_ret = UnityEngine.Vector3.Distance( 
                        _a, 
                        _b );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _maxLength = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.ClampMagnitude( 
                        _vector, 
                        _maxLength );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _vector;translator.Get(L, 1, out _vector);
                        ...
                        float gen_ret = UnityEngine.Vector3.Magnitude( 
                        _vector );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _vector;translator.Get(L, 1, out _vector);
                        ...
                        float gen_ret = UnityEngine.Vector3.SqrMagnitude( 
                        _vector );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _rhs;translator.Get(L, 2, out _rhs);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Min( 
                        _lhs, 
                        _rhs );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3 _rhs;translator.Get(L, 2, out _rhs);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityEngine.Vector3.Max( 
                        _lhs, 
                        _rhs );
                        translator.PushUnityEngineVector3(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToUnityV3(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _v3;translator.Get(L, 1, out _v3);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.ToUnityV3(  );
                        translator.PushUnityEngineVector3(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ToPFV3(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _v3;translator.Get(L, 1, out _v3);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.ToPFV3(  );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _v3;translator.Get(L, 1, out _v3);
                        ...
                        UnityEngine.Vector2 gen_ret = gen_to_be_invoked.ToV2(  );
