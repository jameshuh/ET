...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsXMLListWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrawList", _g_get_rawList);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrawList", _s_set_rawList);
		    ...
		    try {
                ...
                
                {
                    string _selector = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.Utils.XMLList gen_ret = gen_to_be_invoked.Filter( 
                        _selector );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _selector = LuaAPI.lua_tostring(L, 2);
                        ...
                        FairyGUI.Utils.XML gen_ret = gen_to_be_invoked.Find( 
                        _selector );
                        translator.Push(L, gen_ret);
