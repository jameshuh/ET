...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsHtmlParseOptionsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlinkBgColor", _g_get_linkBgColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlinkHoverBgColor", _g_get_linkHoverBgColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getignoreWhiteSpace", _g_get_ignoreWhiteSpace);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlinkUnderline", _s_set_linkUnderline);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlinkColor", _s_set_linkColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlinkBgColor", _s_set_linkBgColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlinkHoverBgColor", _s_set_linkHoverBgColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setignoreWhiteSpace", _s_set_ignoreWhiteSpace);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getDefaultLinkUnderline", _g_get_DefaultLinkUnderline);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getDefaultLinkColor", _g_get_DefaultLinkColor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getDefaultLinkBgColor", _g_get_DefaultLinkBgColor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getDefaultLinkHoverBgColor", _g_get_DefaultLinkHoverBgColor);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setDefaultLinkUnderline", _s_set_DefaultLinkUnderline);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setDefaultLinkColor", _s_set_DefaultLinkColor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setDefaultLinkBgColor", _s_set_DefaultLinkBgColor);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setDefaultLinkHoverBgColor", _s_set_DefaultLinkHoverBgColor);
