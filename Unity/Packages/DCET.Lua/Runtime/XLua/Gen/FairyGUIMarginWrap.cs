...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIMarginWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FairyGUI.Margin);
		...
		public static int __clone__(RealStatePtr L)
		{
			...
			{
				ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				FairyGUI.Margin gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(FairyGUI.Margin));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FairyGUI.Margin constructor!");
