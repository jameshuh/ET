...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsByteBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 29, 7, 4);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbytesAvailable", _g_get_bytesAvailable);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbuffer", _g_get_buffer);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlittleEndian", _g_get_littleEndian);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstringTable", _g_get_stringTable);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlittleEndian", _s_set_littleEndian);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstringTable", _s_set_stringTable);
		    ...
		    try {
                ...
                
                {
                    int _count = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = gen_to_be_invoked.Skip( 
                        _count );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _blockIndex = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.Seek( 
                        _indexTablePos, 
                        _blockIndex );
                        LuaAPI.lua_pushboolean(L, gen_ret);
