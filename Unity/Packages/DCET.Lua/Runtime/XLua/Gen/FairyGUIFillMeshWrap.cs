...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIFillMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmethod", _g_get_method);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getorigin", _g_get_origin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getamount", _g_get_amount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getclockwise", _g_get_clockwise);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setmethod", _s_set_method);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setorigin", _s_set_origin);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setamount", _s_set_amount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setclockwise", _s_set_clockwise);
        ...
        static int _g_get_method(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.FillMesh gen_to_be_invoked = (FairyGUI.FillMesh)translator.FastGetCSObj(L, 1);
                translator.PushFairyGUIFillMethod(L, gen_to_be_invoked.method);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
