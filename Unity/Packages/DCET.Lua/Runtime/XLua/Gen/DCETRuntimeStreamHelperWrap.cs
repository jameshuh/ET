...
namespace XLua.CSObjectWrap
{
    ...
    public class DCETRuntimeStreamHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DCETRuntime.StreamHelper);
        ...
        {
            return LuaAPI.luaL_error(L, "DCETRuntime.StreamHelper does not have a constructor!");
        }
        ...
        static int _m_WriteToUint(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.StreamHelper.WriteToUint( 
                        _stream, 
                        _offset, 
                        _num );
        ...
        static int _m_WriteToInt(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.StreamHelper.WriteToInt( 
                        _stream, 
                        _offset, 
                        _num );
        ...
        static int _m_WriteToByte(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.StreamHelper.WriteToByte( 
                        _stream, 
                        _offset, 
                        _num );
        ...
        static int _m_WriteToShort(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.StreamHelper.WriteToShort( 
                        _stream, 
                        _offset, 
                        _num );
        ...
        static int _m_WriteToUshort(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.StreamHelper.WriteToUshort( 
                        _stream, 
                        _offset, 
                        _num );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _offset = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        int gen_ret = DCETRuntime.StreamHelper.ToInt32( 
                        _memoryStream, 
                        _offset );
		    ...
		    try {
                ...
                
                {
                    ...
                    int _offset = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        ushort gen_ret = DCETRuntime.StreamHelper.ToUInt16( 
                        _memoryStream, 
                        _offset );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _offset = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        byte[] gen_ret = DCETRuntime.StreamHelper.ReadBytes( 
                        _memoryStream, 
                        _offset );
        ...
        static int _m_WriteBytes_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DCETRuntime.StreamHelper.WriteBytes( 
                        _memoryStream, 
                        _bytes );
