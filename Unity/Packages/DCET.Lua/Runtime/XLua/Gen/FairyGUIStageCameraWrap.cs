...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIStageCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setconstantSize", _s_set_constantSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcachedTransform", _s_set_cachedTransform);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcachedCamera", _s_set_cachedCamera);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 24, 4, 4);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getName", FairyGUI.StageCamera.Name);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "getLayerName", FairyGUI.StageCamera.LayerName);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getmain", _g_get_main);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getscreenSizeVer", _g_get_screenSizeVer);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getDefaultCameraSize", _g_get_DefaultCameraSize);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getUnitsPerPixel", _g_get_UnitsPerPixel);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setmain", _s_set_main);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setscreenSizeVer", _s_set_screenSizeVer);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setDefaultCameraSize", _s_set_DefaultCameraSize);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setUnitsPerPixel", _s_set_UnitsPerPixel);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "UnitsPerPixel", _g_get_UnitsPerPixel);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "UnitsPerPixel", _s_set_UnitsPerPixel);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _cullingMask = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.Camera gen_ret = FairyGUI.StageCamera.CreateCamera( 
                        _name, 
                        _cullingMask );
                        translator.Push(L, gen_ret);
        ...
        static int _g_get_UnitsPerPixel(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushnumber(L, FairyGUI.StageCamera.UnitsPerPixel);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_UnitsPerPixel(RealStatePtr L)
        {
		    try {
			    ...
			    FairyGUI.StageCamera.UnitsPerPixel = (float)LuaAPI.lua_tonumber(L, 1);
