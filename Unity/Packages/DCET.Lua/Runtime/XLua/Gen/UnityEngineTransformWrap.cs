...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlocalPosition", _g_get_localPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geteulerAngles", _g_get_eulerAngles);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlocalEulerAngles", _g_get_localEulerAngles);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getright", _g_get_right);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getup", _g_get_up);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getforward", _g_get_forward);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrotation", _g_get_rotation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlocalRotation", _g_get_localRotation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlocalScale", _g_get_localScale);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getchildCount", _g_get_childCount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlossyScale", _g_get_lossyScale);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethasChanged", _g_get_hasChanged);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethierarchyCapacity", _g_get_hierarchyCapacity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethierarchyCount", _g_get_hierarchyCount);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setposition", _s_set_position);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlocalPosition", _s_set_localPosition);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "seteulerAngles", _s_set_eulerAngles);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlocalEulerAngles", _s_set_localEulerAngles);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setright", _s_set_right);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setup", _s_set_up);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setforward", _s_set_forward);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrotation", _s_set_rotation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlocalRotation", _s_set_localRotation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlocalScale", _s_set_localScale);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setparent", _s_set_parent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethasChanged", _s_set_hasChanged);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "sethierarchyCapacity", _s_set_hierarchyCapacity);
        ...
        static int _m_SetPositionAndRotation(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetPositionAndRotation( 
                        _position, 
                        _rotation );
        ...
        static int _m_RotateAround(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RotateAround( 
                        _point, 
                        _axis, 
                        _angle );
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.TransformDirection( 
                        _x, 
                        _y, 
                        _z );
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.InverseTransformDirection( 
                        _x, 
                        _y, 
                        _z );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.InverseTransformVector( 
                        _x, 
                        _y, 
                        _z );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.TransformPoint( 
                        _x, 
                        _y, 
                        _z );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _z = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.InverseTransformPoint( 
                        _x, 
                        _y, 
                        _z );
                        translator.PushUnityEngineVector3(L, gen_ret);
        ...
        static int _m_SetSiblingIndex(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetSiblingIndex( 
                        _index );
		    ...
		    try {
                ...
                
                {
                    string _n = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Transform gen_ret = gen_to_be_invoked.Find( 
                        _n );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Transform _parent = (UnityEngine.Transform)translator.GetObject(L, 2, typeof(UnityEngine.Transform));
                        ...
                        bool gen_ret = gen_to_be_invoked.IsChildOf( 
                        _parent );
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.Transform gen_ret = gen_to_be_invoked.GetChild( 
                        _index );
                        translator.Push(L, gen_ret);
