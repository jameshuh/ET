...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIUtilsZipReaderZipEntryWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcrc", _g_get_crc);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsize", _g_get_size);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsourceSize", _g_get_sourceSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoffset", _g_get_offset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisDirectory", _g_get_isDirectory);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setname", _s_set_name);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcompress", _s_set_compress);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcrc", _s_set_crc);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsize", _s_set_size);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsourceSize", _s_set_sourceSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoffset", _s_set_offset);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setisDirectory", _s_set_isDirectory);
