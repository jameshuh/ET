...
namespace XLua.CSObjectWrap
{
    ...
    public class BehaviorDesignerRuntimeTasksParallelCompleteWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BehaviorDesigner.Runtime.Tasks.ParallelComplete);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BehaviorDesigner.Runtime.Tasks.ParallelComplete gen_ret = new BehaviorDesigner.Runtime.Tasks.ParallelComplete();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BehaviorDesigner.Runtime.Tasks.ParallelComplete constructor!");
        ...
        static int _m_OnAwake(RealStatePtr L)
        {
		    try {
                ...
                BehaviorDesigner.Runtime.Tasks.ParallelComplete gen_to_be_invoked = (BehaviorDesigner.Runtime.Tasks.ParallelComplete)translator.FastGetCSObj(L, 1);
