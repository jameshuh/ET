...
namespace XLua.CSObjectWrap
{
    ...
    public class BehaviorDesignerRuntimeTasksSequenceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(BehaviorDesigner.Runtime.Tasks.Sequence);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					BehaviorDesigner.Runtime.Tasks.Sequence gen_ret = new BehaviorDesigner.Runtime.Tasks.Sequence();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to BehaviorDesigner.Runtime.Tasks.Sequence constructor!");
        ...
        static int _m_CurrentChildIndex(RealStatePtr L)
        {
		    try {
                ...
                BehaviorDesigner.Runtime.Tasks.Sequence gen_to_be_invoked = (BehaviorDesigner.Runtime.Tasks.Sequence)translator.FastGetCSObj(L, 1);
