...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIVertexBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcurrentVertCount", _g_get_currentVertCount);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvertexColor", _g_get_vertexColor);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuv0", _g_get_uv0);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvertexColor", _s_set_vertexColor);
        ...
        static int _g_get_uv0(RealStatePtr L)
        {
		    try {
                ...
                FairyGUI.VertexBuffer gen_to_be_invoked = (FairyGUI.VertexBuffer)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.uv0);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
