...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIStageWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstageHeight", _g_get_stageHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstageWidth", _g_get_stageWidth);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 14, 4, 2);
