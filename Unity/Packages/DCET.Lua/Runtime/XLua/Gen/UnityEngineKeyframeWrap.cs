...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineKeyframeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinTangent", _g_get_inTangent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoutTangent", _g_get_outTangent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinWeight", _g_get_inWeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoutWeight", _g_get_outWeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getweightedMode", _g_get_weightedMode);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "settime", _s_set_time);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setvalue", _s_set_value);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinTangent", _s_set_inTangent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoutTangent", _s_set_outTangent);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinWeight", _s_set_inWeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoutWeight", _s_set_outWeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setweightedMode", _s_set_weightedMode);
