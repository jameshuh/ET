...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationCurveWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 14, 4, 3);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpreWrapMode", _g_get_preWrapMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpostWrapMode", _g_get_postWrapMode);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setkeys", _s_set_keys);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpreWrapMode", _s_set_preWrapMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpostWrapMode", _s_set_postWrapMode);
		    ...
		    try {
                ...
                
                {
                    float _time = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        float gen_ret = gen_to_be_invoked.Evaluate( 
                        _time );
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Keyframe _key;translator.Get(L, 3, out _key);
                        ...
                        int gen_ret = gen_to_be_invoked.MoveKey( 
                        _index, 
                        _key );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _value = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        UnityEngine.AnimationCurve gen_ret = UnityEngine.AnimationCurve.Constant( 
                        _timeStart, 
                        _timeEnd, 
                        _value );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _valueEnd = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.AnimationCurve gen_ret = UnityEngine.AnimationCurve.Linear( 
                        _timeStart, 
                        _valueStart, 
                        _timeEnd, 
                        _valueEnd );
		    ...
		    try {
                ...
                
                {
                    ...
                    float _valueEnd = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        UnityEngine.AnimationCurve gen_ret = UnityEngine.AnimationCurve.EaseInOut( 
                        _timeStart, 
                        _valueStart, 
                        _timeEnd, 
                        _valueEnd );
