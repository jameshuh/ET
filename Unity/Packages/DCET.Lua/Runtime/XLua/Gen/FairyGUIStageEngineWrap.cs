...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIStageEngineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setObjectsOnStage", _s_set_ObjectsOnStage);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setGraphicsOnStage", _s_set_GraphicsOnStage);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getbeingQuit", _g_get_beingQuit);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setbeingQuit", _s_set_beingQuit);
