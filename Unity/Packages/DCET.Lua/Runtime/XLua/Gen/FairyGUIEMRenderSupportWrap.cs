...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIEMRenderSupportWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 13, 3, 1);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getpackageListReady", _g_get_packageListReady);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gethasTarget", _g_get_hasTarget);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getorderChanged", _g_get_orderChanged);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setorderChanged", _s_set_orderChanged);
        ...
        static int _m_Remove_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    FairyGUI.EMRenderSupport.Remove( 
                        _value );
