...
namespace DCET.Tool
{
    ...
    public static class Program
    {
        ...
        private const string serverMessagePath = "../Server/Model/Message/AutoGeneratedCode/";
        private const string actorMessagePath = "../Server/Message/Actor/AutoGeneratedCode/";
        ...
        public static void Main()
        {
            ...
            InnerProto2CS.Proto2CS("DCET", "ActorMessage.proto", actorMessagePath, "ActorOpcode", 10);
            InnerProto2CS.Proto2CS("DCET", "InnerMessage.proto", serverMessagePath, "InnerOpcode", 1000);

            HotfixProto2CS.Proto2CS("DCET", "OuterMessage.proto", hotfixMessagePath, "OuterOpcode", 100);
            HotfixProto2CS.Proto2CS("DCET", "HotfixMessage.proto", hotfixMessagePath, "HotfixOpcode", 10000);
            
            Console.WriteLine("proto2cs succeed!");
        }
    }

    public static class HotfixProto2CS
    {
    ...
    public static class InnerProto2CS
    {
        ...
        public static void Proto2CS(string nameSpace, string protoName, string outputPath, string opcodeClassName, int startOpcode)
        {
            msgOpcode.Clear();
            ...
            File.WriteAllText(csPath, sb.ToString());
            GenerateOpcode(nameSpace, opcodeClassName, outputPath);
        }
